<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2dh/WFB2DH0400_Qry_Leave2.aspx.cs" Inherits="WebContent_fb2dh_WFB2DH0400_Qry_Leave2" Culture="auto" UICulture="auto" %>
        ...
        <tbody>
            <tr>
                ...
                <td align="left" class="Body_label">
                    <asp:Label ID="txt_APPLY_LEAVE_SDT" runat="server"   ClientIDMode="Static"></asp:Label>
                </td>
            </tr>
            <tr>
                <th align="left" class="Body_TableHeader">
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getL2gvData"
                SelectCountMethod="getL2gvCount" TypeName="CFB2DH0400DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"    
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LEAVE_TIME_UNIT" HeaderText="<%$Resources:Resource,wfb2dh_lb_LEAVE_TIME_UNIT%>" SortExpression="LEAVE_TIME_UNIT"  />
                    <asp:BoundField DataField="calculate1" HeaderText="<%$Resources:Resource,wfb2dh_lb_calculate1%>" SortExpression="calculate1"  />
                    <asp:BoundField DataField="calculate2" HeaderText="<%$Resources:Resource,wfb2dh_lb_calculate2%>" SortExpression="calculate2"  />
                    <asp:BoundField DataField="calculate3" HeaderText="<%$Resources:Resource,wfb2dh_lb_calculate3%>" SortExpression="calculate3"  />
                    <asp:BoundField DataField="calculate4" HeaderText="<%$Resources:Resource,wfb2dh_lb_calculate4%>" SortExpression="calculate4"  />
                    <asp:BoundField DataField="calculate5" HeaderText="<%$Resources:Resource,wfb2dh_lb_calculate5%>" SortExpression="calculate5"  />
                    <asp:BoundField DataField="calculate6" HeaderText="<%$Resources:Resource,wfb2dh_lb_calculate6%>" SortExpression="calculate6"  />
                </Columns>

            </asp:GridView>

            <%--<table id="OnePage" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" 
                height="100%" runat="server" visible="false" style="padding-top: 5px; padding-left: 5px">
                <tr valign="top">

            <td class="GridviewScrollPager TD">
                        <asp:DropDownList ID="ddlPerPageRow" runat="server" onchange="javascript:ShowRecord('')" 
