<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2dh/WFB2DH0100_Dtl_Emp.aspx.cs" Inherits="WebContent_fb2dh_WFB2DH0100_Dtl_Emp" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="1020" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
                ...
                <tr>
                    <td align="right" class="Body_label">
                        <div id="init_grid">
                        <aces:Btn ID="WFB2DH0104Add" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0104Add%>" OnClick="WFB2DH0104Add_Click" />
                            <aces:Btn ID="WFB2DH0104Delete" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0104Delete%>" Visible="false" OnClientClick="return CheckDelAction();" OnClick="WFB2DH0104Delete_Click" />
                            <asp:Button ID="btn_back" runat="server" Text="<%$Resources:Resource,wfb2dh_btn_back%>" OnClick="btn_back_Click" />
                            <aces:Btn ID="WFB2DH0104Save" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0104Save%>" Visible="false" ValidationGroup="GroupA" OnClick="WFB2DH0104Save_Click" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData5"
                SelectCountMethod="getCount5" TypeName="CFB2DH0100DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2dh_lb_EMP_CD%>" SortExpression="EMP_CD" HeaderStyle-Width="100px">
                        <ItemTemplate>
                            <asp:Label ID="lb_EMP_CD" runat="server" Text='<%#Bind("EMP_CD")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_EMP_CD" runat="server" Text='<%#Bind("EMP_CD")%>'></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            ...
                            <asp:DropDownList ID="ddl_NEW_EMP_CD" runat="server" ClientIDMode="Static" CssClass="MandatoryField"></asp:DropDownList>
                                </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2dh_ERR_EMP_CD%>"
                                ControlToValidate="ddl_NEW_EMP_CD" ForeColor="Red" ValidationGroup="GroupA" Display="None" InitialValue="-1"></asp:RequiredFieldValidator>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <%--職務代碼 --%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2dh_lb_PJOB_CD%>" SortExpression="PJOB_CD" HeaderStyle-Width="100px">
                        <ItemTemplate>
                            <asp:Label ID="lb_PJOB_CD" runat="server" Text='<%#Bind("PJOB_CD")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txt_PJOB_CD_Add" runat="server" ClientIDMode="Static" MaxLength="4" Width="100" ></asp:TextBox>                                 
                        </EditItemTemplate>
                        <FooterTemplate>
                            <div style="text-align: center; width: 100%">
                                <asp:TextBox ID="txt_PJOB_CD_Add" runat="server" ClientIDMode="Static" MaxLength="4" Width="100" ></asp:TextBox> 
                ...
                <EmptyDataTemplate>
                    <table class="grid-view" width="1020px">
                        <tr class="header">
                            ...
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="<%$Resources:Resource,wfb2dh_lb_EMP_CD%>" Width="100px"></asp:Label>
                            </td>
                             <td>
                                <asp:Label ID="Label3" runat="server" Text="<%$Resources:Resource,wfb2dh_lb_PJOB_CD%>" Width="100px"></asp:Label>
                            </td>
                        </tr>
                        <tr class="normal">
                            <td>
