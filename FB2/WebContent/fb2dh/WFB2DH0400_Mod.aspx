<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2dh/WFB2DH0400_Mod.aspx.cs" Inherits="WebContent_fb2dh_WFB2DH0400_Mod" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function iniForm() {
            ...
            $('#txt_LEAVE_MIN_VALUE').attr("readonly", true);
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_HEAD_EMP_ID" runat="server" MaxLength="5" Width="64px" ClientIDMode="Static"></asp:Label>
                        </td>
                        <th align="left" class="Body_TableHeader">
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_MAIN_LEAVE_CD" runat="server" ClientIDMode="Static"></asp:Label>
                        ...
                        <td align="left" class="Body_label">
                            <asp:DropDownList ID="ddl_SUB_LEAVE_CD" runat="server" Enabled="false" ClientIDMode="Static"></asp:DropDownList>
                        </td>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_LEAVE_TIME_UNIT" runat="server" Text="<%$Resources:Resource,wfb2dh_lb_LEAVE_TIME_UNIT%>"></asp:Label>:
                        </th>
                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_LEAVE_MIN_VALUE" runat="server" BorderWidth="0" MaxLength="6" Width="42px" ClientIDMode="Static"></asp:TextBox>
                            <asp:TextBox ID="txt_LEAVE_TIME_UNIT" runat="server" BorderWidth="0" MaxLength="6" Width="42px" ClientIDMode="Static"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                          ...
                          <%-- 計算 --%>
                        <td align="left" class="Body_label">
                            <aces:Btn ID="WFB2DH0400Calculate" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0400Calculate%>" OnClick="WFB2DH0400Calculate_Click" ValidationGroup="GroupA" OnClientClick="CheckValid();"/>

                            <%--<asp:Button ID="WFB2DH0400Calculate" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0400Calculate%>" OnClick="WFB2DH0400Calculate_Click" ValidationGroup="GroupA" OnClientClick="CheckValid();"/>--%>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="left" class="Body_label">
                            <%--不要?--%>
                            <%--<asp:Button ID="wfb2dh_APPLY_LEAVE_Dtl" runat="server" Text="<%$Resources:Resource,wfb2dh_APPLY_LEAVE_Dtl%>" OnClick="wfb2dh_APPLY_LEAVE_Dtl_Click" />--%>
                            
                            <aces:Btn ID="WFB2DH0401LeaveCdSearch" runat="server" Text="<%$Resources:Resource,wfb2dh_btn_LEAVECOUNT%>" OnClick="wfb2dh_LEAVE_CD_Search_Click" />
                            
                            <%--<asp:Button ID="WFB2DH0401LeaveCdSearch" runat="server" Text="<%$Resources:Resource,wfb2dh_btn_LEAVECOUNT%>" OnClick="wfb2dh_LEAVE_CD_Search_Click" />--%>
                        </td>
                    ...
                    <tr>
                       <%--刷卡比對狀態 --%>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_CHECK_STATUS" Text="" runat="server" BorderWidth="0" MaxLength="6" Width="81px" ClientIDMode="Static"></asp:Label>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_SALARY_SETTLE_STATUS" runat="server" BorderWidth="0" MaxLength="6" Width="81px" ClientIDMode="Static"></asp:Label>
                        </td>
                         <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_FORM_STATUS" runat="server" Text="<%$Resources:Resource,wfb2dh_lb_FORM_STATUS%>"></asp:Label>:
                        </th>
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_FORM_STATUS" runat="server"  BorderWidth="0" MaxLength="6" Width="81px" ClientIDMode="Static"></asp:Label>
                               <asp:HiddenField ID="hid_FORM_STATUS" runat="server" ClientIDMode="Static" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="right" colspan="10">
                            <aces:Btn ID="WFB2DH0401Save" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0400Save%>" OnClick="WFB2DH0400Save_Click"  OnClientClick="return saveCheck();"  />

                            <%--<asp:Button ID="WFB2DH0401Save" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0400Save%>" OnClick="WFB2DH0400Save_Click"  OnClientClick="return saveCheck();"  />--%>
                            <asp:Button ID="WFB2DH0401Cancel" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0400Cancel%>" OnClick="WFB2DH0400Cancel_Click" OnClientClick="return confirm('是否確定取消?');" /></td>
                    </tr>
