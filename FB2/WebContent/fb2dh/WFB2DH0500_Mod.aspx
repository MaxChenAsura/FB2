<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2dh/WFB2DH0500_Mod.aspx.cs" Inherits="WebContent_fb2dh_WFB2DH0500_Mod" Culture="auto" UICulture="auto" %>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_EMP_ID" runat="server" Width="64px" ClientIDMode="Static"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_MAIN_LEAVE_CD" runat="server" Width="120px" ClientIDMode="Static"></asp:Label>
                            <%--<asp:TextBox ID="txt_MAIN_LEAVE_CD" runat="server" Width="64px" ClientIDMode="Static" BorderWidth="0"></asp:TextBox>--%>
                        </td>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_SUB_LEAVE_CD" runat="server" Text="<%$Resources:Resource,wfb2dh_lb_SUB_LEAVE_CD%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:DropDownList ID="ddl_SUB_LEAVE_CD" runat="server" ClientIDMode="Static" AutoPostBack="true" CssClass="MandatoryField" Enabled="false"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_APPLY_LEAVE_EDT" runat="server" MaxLength="8" Width="81px" ClientIDMode="Static" CssClass="MandatoryField  date"  Enabled="false"></asp:TextBox>
                        ...
                        <td>
                            <%-- 計算--%>
                            <aces:Btn ID="WFB2DH0500COUNT" runat="server" Text="<%$Resources:Resource,wfb2dh_WFB2DH0500COUNT%>" OnClick="WFB2DH0500COUNT_Click" ValidationGroup="GroupA" OnClientClick="CheckValid();" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:DropDownList ID="ddl_APPLY_LEAVE_STIME_H" runat="server" ClientIDMode="Static" OnSelectedIndexChanged="ddl_APPLY_LEAVE_STIME_H_SelectedIndexChanged"></asp:DropDownList>時
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="<%$Resources:Resource,wfb2dh_Required_APPLY_LEAVE_STIME_H%>"
                        ControlToValidate="ddl_APPLY_LEAVE_STIME_H" ForeColor="Red" ValidationGroup="GroupA" Display="None"></asp:RequiredFieldValidator>
                            <asp:DropDownList ID="ddl_APPLY_LEAVE_STIME_M" runat="server" ClientIDMode="Static" OnSelectedIndexChanged="ddl_APPLY_LEAVE_STIME_M_SelectedIndexChanged"></asp:DropDownList>分
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label" colspan="2">
                            <asp:TextBox ID="txt_APPLY_OVERTIME_DT" runat="server" MaxLength="8" Width="81px" ClientIDMode="Static" CssClass="date" Enabled="false"></asp:TextBox>
                    ...
                    <tr>
                        <td align="left" class="Body_label">
                            <aces:Btn ID="WFB2DH0500LEAVECOUNT" runat="server" Text="<%$Resources:Resource,wfb2dh_btn_LEAVECOUNT%>" OnClick="btn_LEAVECOUNT_Click" />

                            <%--<asp:Button ID="WFB2DH0500LEAVECOUNT" runat="server" Text="<%$Resources:Resource,wfb2dh_btn_LEAVECOUNT%>" OnClick="btn_LEAVECOUNT_Click" />--%>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_PAY_DT" runat="server" MaxLength="8" Width="81px" ClientIDMode="Static"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <aces:Btn ID="WFB2DH0501Save" runat="server" Text="<%$Resources:Resource,btn_Save%>" OnClick="WFB2DH0500Save_Click" OnClientClick="return saveCheck();" />

                            <%--<asp:Button ID="WFB2DH0501Save" runat="server" Text="<%$Resources:Resource,btn_Save%>" OnClick="WFB2DH0500Save_Click"  OnClientClick="return saveCheck();" />--%>
