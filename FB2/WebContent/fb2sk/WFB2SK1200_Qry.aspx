<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sk/WFB2SK1200_Qry.aspx.cs" Inherits="WebContent_fb2sk_WFB2SK1200_Qry" %>
                        ...
                        <table cellspacing="1" cellpadding="1" width="100%" border="0" class="Body_Label">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <%--工號--%>
                                    <th align="left" class="Body_TableHeader">
                                        <asp:Label runat="server" ID="lb_EMP_ID_search" Text="<%$Resources:Resource,wfb2sk_lb_EMP_ID%>" />:
                                    </th>
                                    <td>                                       
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="Body_label">
                                        <div id="init">
                                            <asp:Button ID="WFB2SK120Search" runat="server" Text="<%$Resources:Resource,wfb2sk_Search%>" OnClick="WFB2SK120Search_Click"/>
<%--                                            <aces:Btn ID="WFB2SK120Search" runat="server" Text="<%$Resources:Resource,wfb2sk_Search%>" Visible="true" ValidationGroup="GroupA" OnClick="WFB2SK120Search_Click"/>--%>
                                            <input id="btn_clear" runat="server" type="button" value="<%$Resources:Resource,wfb2sk_WFB2SKClear%>" onclick="return ClearAll();" />
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <tr>
                    <td>
                        <%-- PDF產出及寄送電子郵件 --%>
<%--                        <aces:Btn ID="WFB2SK120SendEmail" runat="server" Text="<%$Resources:Resource,wfb2sk_WFB2SK120SendEmail%>" Visible="false" OnClick="WFB2SK120SendEmail_Click" OnClientClick="BlockUI();" />
                            <asp:Button ID="WFB2SK120SendEmail" runat="server" Text="<%$Resources:Resource,wfb2sk_WFB2SKSendEmail%>" Visible="false" OnClientClick="BlockUI();" OnClick="WFB2SK120SendEmail_Click"/>
                            <asp:Button ID="WFB2SK120Down" runat="server" Text="<%$Resources:Resource,wfb2sk_WFB2SK120Down%>" OnClick="WFB2SK120Down_Click" Visible="false" />
    --%>
                        <%-- 下載 --%>
<%--                        <aces:Btn ID="WFB2SK120Down" runat="server" Text="<%$Resources:Resource,wfb2sk_WFB2SK120Down%>" Visible="false"  OnClick="WFB2SK120Down_Click"/>--%>
                        <aces:Btn ID="WFB2SK120SendEmail" runat="server" Text="<%$Resources:Resource,wfb2sk_WFB2SK120SendEmail%>" Visible="false" OnClick="WFB2SK120SendEmail_Click" OnClientClick="BlockUI();" />
                        <aces:Btn ID="WFB2SK120Down" runat="server" Text="<%$Resources:Resource,wfb2sk_WFB2SK120Down%>" Visible="false"  OnClick="WFB2SK120Down_Click"/>
                    </td>
                </tr>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SK1200DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <%--姓名--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sk_lb_EMP_NAME%>" SortExpression="EMP_NAME" HeaderStyle-Width="120px" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SK120Down" />          
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
