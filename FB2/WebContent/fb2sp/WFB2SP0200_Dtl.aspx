<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sp/WFB2SP0200_Dtl.aspx.cs" Inherits="WebContent_WFB2SP0200_Dtl" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="right" colspan="7">
                            <aces:Btn ID="WFB2SP0200Save" runat="server" Text="儲存" OnClick="WFB2SP0200Save_Click" OnClientClick="return CheckSearch();" />
                            <asp:Button ID="WFB2SP0200Back" runat="server" Text="返回" OnClick="WFB2SP0200Back_Click" />
                            <%--
                            <asp:Button ID="WFB2SP0200Save" runat="server" Text="儲存" OnClick="WFB2SP0200Save_Click" OnClientClick="return CheckSearch();" />
                            --%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDtlData"
                SelectCountMethod="getDtlCount" TypeName="CFB2SP0200DAO" EnablePaging="True"
