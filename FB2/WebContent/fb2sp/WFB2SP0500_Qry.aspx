<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sp/WFB2SP0500_Qry.aspx.cs" Inherits="WebContent_WFB2SP0500_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="right" colspan="6">
                            <aces:Btn ID="WFB2SP0500Search" runat="server" Text="查詢" OnClick="WFB2SP0500Search_Click" OnClientClick="return CheckSearch();" />
                             <%-- 
                             <asp:Button ID="WFB2SP0500Search" runat="server" Text="查詢" OnClick="WFB2SP0500Search_Click" OnClientClick="return CheckSearch();" />
                             --%>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="6">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SP0500Deatil" runat="server" Text="查詢明細" Visible="false" OnClick="WFB2SP0500Deatil_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SP0500ExcelDown" runat="server" Text="退休金匯出" Visible="false" OnClick="WFB2SP0500ExcelDown_Click" OnClientClick="return checkDowning(this.value);" />
                                <%-- 
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SP0500DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--工號--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sp_lb_emp_id%>" HeaderStyle-Width="170px" ItemStyle-HorizontalAlign="Left" SortExpression="EMP_ID">
                        <ItemTemplate>
                            <asp:Label ID="lb_EMP_ID" runat="server" Text='<%#Bind("EMP_ID")%>' Width="170px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--姓名--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sp_lb_emp_name%>" HeaderStyle-Width="170px" ItemStyle-HorizontalAlign="Left" SortExpression="EMP_NAME">
                        <ItemTemplate>
                            <asp:Label ID="lb_EMP_NAME" runat="server" Text='<%#Bind("EMP_NAME")%>' Width="170px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--退休日--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sp_lb_retire_dt%>" HeaderStyle-Width="170px" ItemStyle-HorizontalAlign="Left" SortExpression="RETIRE_DT">
                        <ItemTemplate>
                            <asp:Label ID="lb_RETIRE_DT" runat="server" Text='<%#Bind("RETIRE_DT", "{0:yyyy/MM/dd}")%>' Width="170px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--退休金--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sp_lb_retire_pay_tmp%>" HeaderStyle-Width="248px" ItemStyle-HorizontalAlign="right">
                        <ItemTemplate>
                            <asp:Label ID="lb_RETIRE_PAY" runat="server" Text='<%#Bind("RETIRE_PAY","{0:n0}")%>' Width="248px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--結案否--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sp_lb_close_yn%>" HeaderStyle-Width="170px" ItemStyle-HorizontalAlign="Center" SortExpression="CLOSE_YN">
                        <ItemTemplate>
                            <asp:Label ID="lb_CLOSE_YN" runat="server" Text='<%#Bind("CLOSE_YN_DESC")%>' Width="170px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
        ...
        <%--EXCEL下載用 --%>
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SP0500ExcelDown" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
