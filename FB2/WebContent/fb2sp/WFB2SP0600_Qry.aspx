<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sp/WFB2SP0600_Qry.aspx.cs" Inherits="WebContent_WFB2SP0600_Qry" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="right" colspan="6">
                            <aces:Btn ID="WFB2SP0600ExcelDown" runat="server" Text="列印" OnClick="WFB2SP0600ExcelDown_Click" OnClientClick="return checkDowning(this.value);"   />
                            <%-- 
                            <asp:Button ID="WFB2SP0600ExcelDown" runat="server" Text="列印" OnClick="WFB2SP0600ExcelDown_Click" OnClientClick="return checkDowning();"   />
                            --%>
                        </td>
                    </tr>
                    <tr>
        ...
        <%--EXCEL下載用 --%>
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SP0600ExcelDown" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
