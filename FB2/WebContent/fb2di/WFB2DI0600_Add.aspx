<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2di/action/WFB2DI0600_Add.aspx.cs" Inherits="WebContent_fb2di_WFB2DI0600_Add" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function saveCheck(flag) {
            ...
            if (flag == 'save')
            {
                if ($("#txt_OVERTIME_PAY_HOUR").val() == "") {
                    alert("計算總時數必須輸入，不可空白");
                    processed = false;
                }
            }
            ...
            //alert(TRIP_HOUR);
            var OVERTIME_CD = $("#ddl_OVERTIME_CD").val().split("-")[0];
        ...
        function openDI0700() {
            if (Page_ClientValidate("GroupA")) {
                ...
                window.open("WFB2DI0700_Qry.aspx?fn=FB2DI060&emp_id=" + emp_id + "&apply_overtime_ym=" + apply_overtime_ym + "&parentFuncId=" + parentFuncID);
            }
        }

        function backToQry() {
            window.location.href = "WFB2DI0600_Qry.aspx";
        }
            ...
            <table cellspacing="3" cellpadding="0" width="1020">
                                        ...
                                        <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="WFB2DI0600Cal" runat="server" Text="計算" ValidationGroup="GroupA" OnClientClick="return saveCheck('cal');" OnClick="WFB2DI0600Cal_Click" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" class="Body_label">
                                                        <asp:TextBox ID="txt_OVERTIME_PAY_HOUR" CssClass="MandatoryField" runat="server" MaxLength="15" Width="50px" ClientIDMode="Static"></asp:TextBox>
                                                        <asp:HiddenField ID="hid_OVERTIME_PAY_HOUR" runat="server" ClientIDMode="Static" />
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="<%$Resources:Resource,wfb2di_Required_OVERTIME_PAY_HOUR%>"
                                                            ControlToValidate="txt_OVERTIME_PAY_HOUR" ForeColor="Red" ValidationGroup="GroupB" Display="None">
                                                        </asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="left" class="Body_label">
                                                        <asp:TextBox ID="txt_FORM_STATUS" runat="server" BorderWidth="0" Width="100px" ClientIDMode="Static" Text=""></asp:TextBox>
                                                    </td>
                                                    <%-- 是否刷卡比對 --%>
                                                    <th align="left" class="Body_TableHeader">
                                                        <asp:Label ID="lb_IS_DUTY_CHECK" runat="server" Text="<%$Resources:Resource,wfb2di_lb_IS_DUTY_CHECK%>"></asp:Label>:</th>
                                                    <td align="left" class="Body_label">
                                                        <asp:DropDownList ID="ddl_IS_DUTY_CHECK" CssClass="MandatoryField" runat="server" DropDownHeight="100px" EnableVirtualScrolling="true" ClientIDMode="Static">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="<%$Resources:Resource,wfb2di_Required_IS_DUTY_CHECK%>"
                                                        ControlToValidate="ddl_IS_DUTY_CHECK" ForeColor="Red" ValidationGroup="GroupA" Display="None">
                                                    </asp:RequiredFieldValidator>
                                                </tr>
                                                <tr>
                                                    <%-- 刷卡比對狀態 --%>
                                                    ...
                                                    <td align="left" class="Body_label">
                                                        <asp:TextBox ID="txt_CLOCK_IN_TIME" runat="server" BorderWidth="0" Width="120px" ClientIDMode="Static"></asp:TextBox>
                                                    </td>
                                                    <%-- 刷卡下班時間 --%>
                                                    <th align="left" class="Body_TableHeader">
                                                        <asp:Label ID="lb_CLOCK_OUT_TIME" runat="server" Text="<%$Resources:Resource,wfb2di_lb_CLOCK_OUT_TIME%>"></asp:Label>:</th>
                                                    <td align="left" class="Body_label">
                                                        <asp:TextBox ID="txt_CLOCK_OUT_TIME" runat="server" BorderWidth="0" Width="120px" ClientIDMode="Static"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <%-- 申請單號 --%>
                                                    ...
                                                    <td align="left" class="Body_label">
                                                        <asp:TextBox ID="txt_SALARY_SETTLE_STATUS" runat="server" Text="" BorderWidth="0" Width="81px" ClientIDMode="Static"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <%-- 備註 --%>
                ...
                <tr>
                    <td class="Body_PageControl" style="text-align: right">
                        <aces:Btn ID="WFB2DI0600Save" runat="server" Text="<%$Resources:Resource,wfb2di_WFB2DI0600Save%>" ValidationGroup="GroupA" OnClientClick="return saveCheck('save');" OnClick="WFB2DI0600Save_Click" />

                        <%--<asp:Button ID="WFB2DI0600Save" runat="server" Text="<%$Resources:Resource,wfb2hb_WFB2DI0600Save%>" ValidationGroup="GroupA" OnClientClick="return saveCheck();" OnClick="WFB2DI0600Save_Click" />--%>

                        <asp:Button ID="btn_Cancel" runat="server" Text="<%$Resources:Resource,wfb2di_btn_Cancel%>" Visible="true" OnClick="WFB2DI0600Cancel_Click" OnClientClick="return confirm('是否確定取消?');" />
                    </td>
                </tr>
