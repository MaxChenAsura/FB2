<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2di/action/WFB2DI0600_Upload.aspx.cs" Inherits="WebContent_fb2hb_WFB2DI0600_Upload"  Culture="auto" UICulture="auto" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                    <asp:Button ID="WFB2DI0601Upload" runat="server" Text="匯入" OnClick="WFB2DI0601Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>
                ...
                <td align="left" class="Body_label" colspan="5">
                    ...
                    <fieldset style="padding:5px">
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                   <asp:Button ID="WFB2DI0601ExcelDown" runat="server" Text="EXCEL匯出" OnClick="btn_Excel_Down_Click" />
                                </td>
                            </tr>
                        </table>
