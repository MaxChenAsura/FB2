<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2he/WFB2HE0100_Dtl.aspx.cs" Inherits="WebContent_WFB2HE_WFB2HE0100_Dtl" Culture="auto" UICulture="auto" %>
                    ...
                    <table cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tbody>                            
                            ...
                            <tr>
                                ...
                                <td align="left" class="Body_TD3">
                                    <asp:TextBox ID="txt_EMP_CD" runat="server" MaxLength="20" Width="150px" ClientIDMode="Static" BorderWidth="0" CssClass="textWidth" ReadOnly="true"></asp:TextBox>                                     
                                </td>                               
                                <th class="Body_TH3">
                            ...
                            <tr>
                                ...
                                <td align="left" class="Body_TD3">                                    
                                    <asp:TextBox ID="txt_PLANT_CD" runat="server" MaxLength="20" Width="150px" ClientIDMode="Static" BorderWidth="0" CssClass="textWidth" ReadOnly="true"></asp:TextBox>
                                </td>
                                <th align="left" class="Body_TH3">
                                ...
                                <td align="left" class="Body_TD3" colspan ="5">
                                    <asp:TextBox ID="txt_DEPT_NO" runat="server" MaxLength="100" Width="500px" ClientIDMode="Static" CssClass="textWidth" BorderWidth="0" ReadOnly="true"></asp:TextBox>                                   
                                </td>                                  
                            </tr>   
                            <tr>
                                 <th align="left" class="Body_TH3">
                                     <asp:Label ID="lb_LEVEL" runat="server" Text="<%$Resources:Resource,wfb2he_lb_LEVEL_CD%>"></asp:Label>:
                                </th>                                    
                                <td align="left" class="Body_TD3">
                                     <asp:TextBox ID="txt_LEVEL_CD" runat="server" MaxLength="7" Width="120px" ClientIDMode="Static" CssClass="textWidth" BorderWidth="0" ReadOnly="true"></asp:TextBox>                                       
                                </td> 
                                <th align="left" class="Body_TH3">
                                     <asp:Label ID="lb_GRADE_CD" runat="server" Text="<%$Resources:Resource,wfb2he_lb_GRADE_CD%>"></asp:Label>:
                                </th>                                    
                                <td align="left" class="Body_TD3">
                                     <asp:TextBox ID="txt_GRADE_CD" runat="server" MaxLength="7" Width="120px" ClientIDMode="Static" CssClass="textWidth" BorderWidth="0" ReadOnly="true"></asp:TextBox>                                       
                                </td> 
                                <th align="left" class="Body_TH3">
                                     <asp:Label ID="lb_WORK_CD" runat="server" Text="<%$Resources:Resource,wfb2he_lb_WORK_CD%>"></asp:Label>:
                                </th>                                    
                                <td align="left" class="Body_TD3">
                                    <asp:TextBox ID="txt_WORK_CD" runat="server" MaxLength="7" Width="120px" ClientIDMode="Static" CssClass="textWidth" BorderWidth="0" ReadOnly="true"></asp:TextBox>                                                                                   
                                </td>                                    
                            </tr> 
                            <tr>
                                 <th align="left" class="Body_TH3">
                                 ...
                                 <td align="left" class="Body_TD3">                                    
                                    <asp:TextBox ID="txt_JOIN_DT" runat="server" MaxLength="7" Width="120px" ClientIDMode="Static" CssClass="textWidth" BorderWidth="0" ReadOnly="true"></asp:TextBox>                                                                                   
                                 </td> 
                                 <th align="left" class="Body_TH3">
                                    <asp:Label ID="lb_EXAM_EXPIRE_DT" runat="server" Text="<%$Resources:Resource,wfb2he_lb_EXAM_EXPIRE_DT%>"></asp:Label>：	
                                 </th>
                                 <td align="left" class="Body_TD3">
                                     <asp:TextBox ID="txt_EXAM_EXPIRE_DT" runat="server" MaxLength="7" Width="120px" ClientIDMode="Static" CssClass="textWidth" BorderWidth="0" ReadOnly="true"></asp:TextBox>                                                                                                                        
                                 </td>  
                                 <th align="left" class="Body_TH3">
                                      <asp:Label ID="lb_PLAN_DESPATCH_DT" runat="server" Text="<%$Resources:Resource,wfb2he_lb_PLAN_DESPATCH_DT%>"></asp:Label>：	
                                 </th>
                                 <td align="left" class="Body_TD3">
                                      <asp:TextBox ID="txt_PLAN_DESPATCH_DT" runat="server" MaxLength="10" Width="81px" ClientIDMode="Static" CssClass="textWidth" BorderWidth="0" ReadOnly="true"></asp:TextBox>                                                                                              
                                 </td> 
                             </tr>                                                                   
                        </tbody>
                    </table>
