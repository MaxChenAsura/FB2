<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2he/WFB2HE0100_Upload.aspx.cs" Inherits="WebContent_fb2hb_WFB2HE0100_Upload"  Culture="auto" UICulture="auto" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                    <aces:Btn ID="WFB2HE0100Upload" runat="server" Text="上傳" OnClick="WFB2HE0100Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>
                     <%-- 
                    <asp:Button ID="WFB2HE0100Upload" runat="server" Text="上傳" OnClick="WFB2HE0100Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>
                    --%>
