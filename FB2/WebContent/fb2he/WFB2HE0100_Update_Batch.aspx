<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2he/WFB2HE0100_Update_Batch.aspx.cs" Inherits="WebContent_fb2he_WFB2HE0100_Update_Batch" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function iniForm() {
            ...
            //工號取得姓名的ajax
            $('#txt_INTERVIEW_NAME1').attr("readonly", true);
            ...
            $("#txt_INTERVIEW_BY1").change(function () {
                if ($("#txt_INTERVIEW_BY1").val().length == 5) {
                    $.ajax({
                        url: "../commgeo/WFB2GetEmpData.ashx",
                        data: {
                            EMP_ID: $('#txt_INTERVIEW_BY1').val()
                        },
                        type: "GET",
                        dataType: 'json',
                        success: function (JData) {
                            if (JData.errMsg != "") {
                                $('#txt_INTERVIEW_NAME1').val("");
                                alert(JData.errMsg);
                            }
                            else {
                                $('#txt_INTERVIEW_NAME1').val($.trim(JData.EMP_NAME));
                            }
                        },
                            ...
                            <table width="100%">
                                ...
                                <tbody>
                                        <tr>
                                            ...
                                            <asp:Label ID="lb_INTERVIEW_BY_1" runat="server" Text="<%$Resources:Resource,wfb2he_lb_INTERVIEW_BY%>"></asp:Label>：	
                                        </th>
                                        <td align="left">                                            
                                            <asp:TextBox ID="txt_INTERVIEW_BY1" runat="server" MaxLength="20" Width="81px" ClientIDMode="Static" CssClass="MandatoryField"></asp:TextBox>   
                                            <input id="Button2" type="button" value="..." onclick="OpenEmpSearch('txt_INTERVIEW_BY1', 'txt_INTERVIEW_NAME1', 'N');" />   
                                            <asp:TextBox ID="txt_INTERVIEW_NAME1" runat="server" ClientIDMode="Static" BorderWidth="0" Width="81px"></asp:TextBox> 
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="<%$Resources:Resource,wfb2he_required_INTERVIEW_BY1%>"
                                                    ControlToValidate="txt_INTERVIEW_BY1" ForeColor="Red" ValidationGroup="GroupA" Display="None"></asp:RequiredFieldValidator>                      
                                        </td> 
                                        <%-- 面試結果 --%>
                                         <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="lb_INTERVIEW_RESULT_1" runat="server" Text="<%$Resources:Resource,wfb2he_lb_INTERVIEW_RESULT%>"></asp:Label>：	
                                        </th>
                                        <td align="left">                                            
                                             <asp:DropDownList ID="ddl_INTERVIEW_RESULT_1" runat="server" ClientIDMode="Static" CssClass="MandatoryField"></asp:DropDownList>  
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator113" runat="server" ErrorMessage="<%$Resources:Resource,wfb2he_required_INTERVIEW_RESULT%>"
                                            ControlToValidate="ddl_INTERVIEW_RESULT_1" ForeColor="Red" ValidationGroup="GroupA" Display="None" InitialValue="-1"></asp:RequiredFieldValidator>                            
                                        </td> 
                                        <th align="left" class="Body_TableHeader">
                                            <asp:Label ID="lb_INTERVIEW_DT_1" runat="server" Text="<%$Resources:Resource,wfb2he_lb_INTERVIEW_DT%>"></asp:Label>：	
                                        </th>
                                        <td align="left">                                            
                                            <asp:TextBox ID="txt_INTERVIEW_DT_1" runat="server" MaxLength="10" Width="81px" ClientIDMode="Static" CssClass="date MandatoryField"></asp:TextBox>
                                            <asp:CustomValidator ID="qrytest" runat="server" ValidateEmptyText="true"
								            ErrorMessage="<%$Resources:Resource,wfb2he_ERR_format_INTERVIEW_DT%>" ClientValidationFunction="CheckDate" ForeColor="Red"
								            ControlToValidate="txt_INTERVIEW_DT_1" ValidationGroup="GroupA" Display="None"></asp:CustomValidator>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2he_required_INTERVIEW_DT%>"
                                                ControlToValidate="txt_INTERVIEW_DT_1" ForeColor="Red" ValidationGroup="GroupA" Display="None"></asp:RequiredFieldValidator>
                                        </td>                                        
                                    </tr>                                                              
                                    <tr>
                                        <th></th>
                                        ...
                                        <td align="right" colspan="5">
                                            <aces:Btn ID="WFB2HE0101SAVE" runat="server" Text="<%$Resources:Resource,wfb2he_WFB2HE0101SAVE%>" OnClick="WFB2HE0101SAVE_Click" OnClientClick="return CheckSave();"    />
                                            <asp:Button ID="WFB2HE0100Back" runat="server" Text="<%$Resources:Resource,wfb2he_btn_back%>" OnClientClick="BlockUI();" OnClick="WFB2HE0100Back_Click" />

                                            <%-- 
                                           <asp:Button ID="WFB2HE0101SAVE" runat="server" Text="<%$Resources:Resource,wfb2he_WFB2HE0101SAVE%>" OnClick="WFB2HE0101SAVE_Click" OnClientClick="return CheckSave();"    />
                                            --%>
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_AGE" runat="server" MaxLength="4" Width="81px" ClientIDMode="Static"></asp:TextBox>                                        
                                    </td> 
                                    <%--面試處理狀態--%>
                                   <th align="left" class="Body_TableHeader">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th></th>                                        
                                        <td align="right" colspan="5">
                                            <aces:Btn ID="WFB2HE0101SEARCH" runat="server" Text="<%$Resources:Resource,wfb2he_btn_search%>" OnClick="WFB2HE0101SEARCH_Click" OnClientClick="return CheckSearch();" />                         
                                            <input id="btn_clear" runat="server" type="button" value="<%$Resources:Resource,wfb2sh_btn_clear%>" onclick="ClearAll();" />

                                            <%-- 
                                            <asp:Button ID="WFB2HE0101SEARCH" runat="server" Text="<%$Resources:Resource,wfb2he_btn_search%>" OnClick="WFB2HE0101SEARCH_Click" OnClientClick="return CheckSearch();" />
                                            --%>
