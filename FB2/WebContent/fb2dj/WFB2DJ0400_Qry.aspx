<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2dj/WFB2DJ0400_Qry.aspx.cs" Inherits="WebContent_WFB2DJ0400_Qry" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        //修改時檢核
        function doEdit() {
            //1.檢查是否有勾選1筆，及要做的其它檢查
            if (checkboxsSelected() == 1) {
                choietr = choietr - 2;//需減2才能抓到正確的checkbox
                // alert($("[id=hid_END_DT]")[choietr].value);
                return true;
            } else {
                alert("請選取一筆資料!");
                return false;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="left" class="Body_label" colspan="3">
                            <asp:TextBox ID="txt_APPLY_DT_S" runat="server" Width="100px" ClientIDMode="Static" CssClass="date"></asp:TextBox>
                            ~ 
                           <asp:TextBox ID="txt_APPLY_DT_E" runat="server" Width="100px" ClientIDMode="Static" CssClass="date"></asp:TextBox>
                        ...
                        <th align="left" class="Body_TableHeader">
                            <%--發薪日--%>
                            <asp:Label ID="Label2" runat="server" Text="<%$Resources:Resource,wfb2dj_lb_salary_dt%>"></asp:Label>:</th>

                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_SALARY_DT" runat="server" Width="100px" ClientIDMode="Static" CssClass="date"> </asp:TextBox>
                            <!--驗證日期格式-->
                            <asp:CustomValidator ID="Regular_txt_SALARY_DT" runat="server" ValidateEmptyText="true"
                                ErrorMessage="<%$Resources:Resource,wfb2sh_format_salary_dt%>" ClientValidationFunction="CheckDate" ForeColor="Red"
                                ControlToValidate="txt_SALARY_DT" ValidationGroup="GroupA" Display="None"></asp:CustomValidator>

                            <!--驗證不可空白 -->
                            <%--  <asp:RequiredFieldValidator ID="Regular_txt_SALARY_DT2" runat="server" ErrorMessage="發薪日不可空白"
                    ...
                    <tr>
                     ...
                     <tr>
                        <th align="left" class="Body_TableHeader">
                            <%--Layout NO--%>
                            <asp:Label ID="lb_LAYOUT_NO" runat="server" Text="Layout NO."></asp:Label>:</th>
                        <td align="left" class="Body_label">
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="5">
                            <aces:Btn ID="WFB2DJ0400Search" runat="server" Text="<%$Resources:Resource,wfb2dj_btn_search%>" OnClick="WFB2DJ0400Search_Click" OnClientClick="CheckSearch();" />
                            <aces:Btn ID="WFB2SC4105EnvSearch" runat="server" Text="<%$Resources:Resource,wfb2dj_btn_search%>" OnClick="WFB2DJ0400Search_Click" OnClientClick="CheckSearch();" />

                            <%--<asp:Button ID="WFB2DJ0400Search" runat="server" Text="<%$Resources:Resource,wfb2dj_btn_search%>" OnClick="WFB2DJ0400Search_Click" OnClientClick="CheckSearch();" />--%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2DJ0400DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="txt_APPLY_DT_E" DefaultValue=""
                        Name="appleDT_E" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                    ...
                    <asp:ControlParameter ControlID="txt_EMP_NAME" DefaultValue=""
                        Name="empName" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="txt_DEPT_NO"
                        Name="deptNO" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="ddl_ENV_CHECK_STATUS" DefaultValue=""
                        Name="checkStatus" PropertyName="SelectedValue" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="ddl_ENV_SALARY_STATUS"
                        Name="salaryStatus" PropertyName="SelectedValue" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="txt_IFLOW_NO" DefaultValue=""
                        Name="iflowNO" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="txt_SALARY_DT" DefaultValue=""
                        Name="salaryDT" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="txt_LAYOUT_NO" DefaultValue=""
                        Name="layout_no" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                </SelectParameters>
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    --%>
                    <%--序號--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2dj_lb_rownumber%>" HeaderStyle-Width="80px">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2dj_lb_salary_dt%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="center" SortExpression="SALARY_DT">
                     ...
                     <%--填表人--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2dj_lb_created_name%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="center" >
                        <ItemTemplate>
                            <asp:Label ID="lb_CREATED_NAME" runat="server" Text='<%#Bind("CREATED_NAME")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
