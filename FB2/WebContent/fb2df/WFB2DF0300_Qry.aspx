<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2df/action/WFB2DF0300_Qry.aspx.cs" Inherits="WebContent_fb2df_WFB2DF0300_Qry" Culture="auto" UICulture="auto" %>
                        ...
                        <td align="left" class="Body_label" colspan="5">
                            <fieldset style="padding:5px">
                                <legend class="Body_label">
                                    <asp:Label ID="lb_ACCOM_CALCULATE" runat="server" Text="<%$Resources:Resource,wfb2df_lb_ACCOM_CALCULATE%>"></asp:Label>
                                </legend>
                                <table align="left">
                                    <tr>
                                        <td align="left">
                                            <asp:Label ID="lb_MANAGER_YM" runat="server" Text="<%$Resources:Resource,wfb2df_lb_MANAGER_YM%>">:</asp:Label>	
                                            <asp:TextBox ID="txt_MANAGER_YM" CssClass="MandatoryField ym ym_dt" runat="server" MaxLength="6" Width="81px" ClientIDMode="Static"></asp:TextBox>	
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$Resources:Resource,wfb2df_required_MANAGER_YM%>"
                                            ...
                                            ErrorMessage="<%$Resources:Resource,wfb2df_error_MANAGER_YM%>" ControlToValidate="txt_MANAGER_YM" ForeColor="Red" ValidationGroup="GroupA"
                                ...
                                <table align="right">
                                    <tr>                                        
                                        <td>
                                      <aces:Btn ID="WFB2DF0300ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2df_WFB2DF0300ExcelDown%>" OnClick="WFB2DF0300ExcelDown_Click" ValidationGroup="GroupA"/>
                                          <aces:Btn ID="WFB2DF0300Execute" runat="server" Text="<%$Resources:Resource,wfb2df_WFB2DF0300Execute%>"  OnClick="WFB2DF0300Execute_Click" OnClientClick="BUI();"/>				

<%--                                          <asp:Button ID="WFB2DF0300ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2df_WFB2DF0300ExcelDown%>" OnClick="WFB2DF0300ExcelDown_Click" ValidationGroup="GroupA"/>
                                          <asp:Button ID="WFB2DF0300Execute" runat="server" Text="<%$Resources:Resource,wfb2df_WFB2DF0300Execute%>"  OnClick="WFB2DF0300Execute_Click" OnClientClick="BUI();"/>				--%>
                                        </td>
                                    </tr>                                   
                                </table>
                    ...
                    <tr>
						...
						<td class="Body_label"> 
							<asp:TextBox ID="txt_MANAGER_YM_S" runat="server" MaxLength="6" Width="81px" CssClass="MandatoryField ym ym_dt" ClientIDMode="Static" ></asp:TextBox>
                                    ~  
                            <asp:TextBox ID="txt_MANAGER_YM_E" runat="server" MaxLength="6" Width="81px" CssClass="MandatoryField ym ym_dt" ClientIDMode="Static" ></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="10">
                            <div id="init">
                                <aces:Btn ID="WFB2DF0300Search" runat="server" Text="<%$Resources:Resource,wfb2df_WFB2DF0300Search%>"  ValidationGroup="GroupB" OnClick="WFB2DF0300Search_Click"/>
                                
                                <%--<asp:Button ID="WFB2DF0300Search" runat="server" Text="<%$Resources:Resource,wfb2df_WFB2DF0300Search%>"  ValidationGroup="GroupB" OnClick="WFB2DF0300Search_Click"/>--%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2DF0300DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>                   
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2df_lb_FUNC%>" HeaderStyle-Width="250px">
                        <ItemTemplate>
                            <aces:Btn ID="WFB2DF0300SalaryOut" runat="server"
                                CommandName="SentToSalary"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="<%$Resources:Resource,wfb2df_btn_FUNC%>"/>                            

<%--                            <asp:Button ID="WFB2DF0300SalaryOut" runat="server"
                                CommandName="SentToSalary"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="<%$Resources:Resource,wfb2df_btn_FUNC%>"/>                            --%>
                        </ItemTemplate>                       
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2DF0300ExcelDown"></asp:PostBackTrigger>
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>