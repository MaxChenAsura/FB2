<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2ia/action/WFB2IA3210_Qry.aspx.cs" Inherits="WebContent_WFB2IA3210_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="Body_label">
                                     ...
                                     <!-- 確認狀態-->
                                    <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="lb_COMP_PORCESS_YN" runat="server" Text="<%$Resources:Resource,wfb2ia_STATUS%>"></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label">
                                        <asp:DropDownList ID="ddl_COMP_PORCESS_YN" runat="server" ClientIDMode="Static" CssClass="MandatoryField"></asp:DropDownList>                                                                        
                                    </td>                                    
                                </tr>
                                <tr>
                                    <th></th>
                                    ...
                                    <td align="right" class="Body_label">
                                        <div id="init">
                                            <aces:Btn ID="WFB2IA3210Search" runat="server" Text="<%$Resources:Resource,wfb2df_WFB2DF0200Search%>" ValidationGroup="GroupA" OnClick="WFB2IA3210Search_Click" OnClientClick="CheckValid();" />
                ...
                <tr>
                    ...
                    <tr>
                        <td align="right" colspan="10">
                            <%-- 
                                <aces:Btn ID="WFB2IA3210Delete" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210DEL%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210Delete_Click" OnClientClick="return doDelete();"/>
                                <aces:Btn ID="WFB2IA3210OK" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210OK%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210OK_Click"/>
                                <aces:Btn ID="WFB2IA3210NOTOK" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210NOTOK%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210NOTOK_Click"/>
                                  
                                <asp:Button ID="WFB2IA3210Delete" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210DEL%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210Delete_Click" OnClientClick="return doDelete();"/>
                                <asp:Button ID="WFB2IA3210OK" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210OK%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210OK_Click"/>
                                <asp:Button ID="WFB2IA3210NOTOK" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210NOTOK%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210NOTOK_Click"/>
                           --%>
                                <aces:Btn ID="WFB2IA3210Delete" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210DEL%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210Delete_Click" OnClientClick="return doDelete();"/>
                                <aces:Btn ID="WFB2IA3210OK" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210OK%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210OK_Click"/>
                                <aces:Btn ID="WFB2IA3210NOTOK" runat="server" Text="<%$Resources:Resource,wfb2ia_WFB2IA3210NOTOK%>" Visible="false" style="height: 21px" OnClick="WFB2IA3210NOTOK_Click"/>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2IA3210DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="ddl_COMP_PORCESS_YN"
                        Name="comp_porcess_yn" PropertyName="SelectedValue" Type="String" ConvertEmptyStringToNull="false" />
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--帳單本月雇主--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2ia_lb_FEES_CMP%>" SortExpression="FEES_CMP" HeaderStyle-Width="100px">
                        <ItemTemplate>
                            <asp:Label Style="text-align: right;" ID="lb_FEES_CMP" runat="server" Text='<%#Bind("FEES_CMP","{0:N0}")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--帳單追溯雇主--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2ia_lb_TRACED_FEES_CMP%>" SortExpression="TRACED_FEES_CMP" HeaderStyle-Width="80px">
                        <ItemTemplate>
                            <asp:Label Style="text-align: left;" ID="lb_TRACED_FEES_CMP" runat="server" Text='<%#Bind("TRACED_FEES_CMP")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <%--帳單雇主合計--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2ia_lb_BILLS_CMP_TOTAL%>" SortExpression="BILLS_CMP_TOTAL" HeaderStyle-Width="80px">
                        <ItemTemplate>
                            <asp:Label Style="text-align: left;" ID="lb_BILLS_CMP_TOTAL" runat="server" Text='<%#Bind("BILLS_CMP_TOTAL","{0:N0}")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <%--代扣雇主合計--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2ia_lb_INS_CMP%>" SortExpression="INS_CMP" HeaderStyle-Width="80px">
                        <ItemTemplate>
                            <asp:Label Style="text-align: left;" ID="lb_INS_CMP" runat="server" Text='<%#Bind("INS_CMP","{0:N0}")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--差異金額--%>
                    ...
                    <%--比對結果說明--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2ia_lb_PROCESS_MEMO%>" SortExpression="PROCESS_MEMO_CMP" HeaderStyle-Width="250px">
                        <ItemTemplate>
                            <asp:Label Style="text-align: left;" ID="lb_PROCESS_MEMO_CMP" runat="server" Text='<%#Bind("PROCESS_MEMO_CMP")%>' Width="250px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>                    
                </Columns>
