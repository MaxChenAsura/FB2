<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2hc/WFB2HC0401_Dtl2.aspx.cs" Inherits="WebContent_fb2hc_WFB2HC0401_Dtl2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function redirToDtl(url, pay_ym, salary_dt, company_cd, company_cd_desc, bonus_type, bonus_type_desc, member_cnt, amt_cnt, emp_id, emp_name, dept_desc, start_dt) {
            BlockUI();
            window.location.href = url + ".aspx?datakey=" + pay_ym + "," + salary_dt + "," + company_cd + "," + company_cd_desc + "," + bonus_type + "," + bonus_type_desc + "," + member_cnt + "," + amt_cnt + "," + emp_id + "," + emp_name + "," + dept_desc + "," + start_dt;
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>            
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData2_d2"
                SelectCountMethod="getCount2_d2" TypeName="CFB2HC0400DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true"
                ...
                <Columns>                    
                    ...
                    <asp:BoundField DataField="ORI_DEPT_DESC" HeaderText="<%$Resources:Resource,wfb2hc_hd_ORI_DEPT_DESC%>" HeaderStyle-Width="260px" ItemStyle-Width="260px" ItemStyle-HorizontalAlign="Left" SortExpression="ORI_DEPT_DESC" />
                    ...
                    <asp:BoundField DataField="PLAN_END_DT" HeaderText="<%$Resources:Resource,wfb2hc_hd_PLAN_END_DT%>"  HeaderStyle-Width="100px" ItemStyle-Width="100px" DataFormatString="{0:yyyy/MM/dd}" SortExpression="PLAN_END_DT" />
                    ...
                    <asp:TemplateField ItemStyle-Width="110px">
                        ...
                        <ItemTemplate>
                            <asp:Button ID="WFB2HC0401AMT_DETAIL" runat="server" Text="<%$Resources:Resource,wfb2hc_hd_AMT_DETAIL%>" />
                            <asp:HiddenField ID="hid_ORI_DEPT_DESC" Value='<%#Bind("ORI_DEPT_DESC")%>' ClientIDMode="Static" runat="server" />
                            <asp:HiddenField ID="hid_EMP_ID" Value='<%#Bind("EMP_ID")%>' ClientIDMode="Static" runat="server" />
                            <asp:HiddenField ID="hid_EMP_NAME" Value='<%#Bind("EMP_NAME")%>' ClientIDMode="Static" runat="server" />
                            <asp:HiddenField ID="hid_START_DT" Value='<%#Bind("START_DT")%>' ClientIDMode="Static" runat="server" />
                        </ItemTemplate>                                
                    </asp:TemplateField>
                </Columns>
