<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3400_Qry.aspx.cs" Inherits="WebContent_WFB2SJ3400_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ3400Search" runat="server" Text="查詢" OnClick="WFB2SJ3400Search_Click" OnClientClick="return CheckSearch();" />
                                ...
                                <asp:Button ID="btn_clear" runat="server" Text="<%$Resources:Resource,wfb2ia_btn_clear%>" OnClientClick="ClearAll();" />
                                 <aces:Btn ID="WFB2SJ3400ReGen" runat="server" Text="重配置" OnClick="WFB2SJ3400ReGen_Click" OnClientClick ="return exeCheckSearch();"/>
                                 <aces:Btn ID="WFB2SJ3400ReGenDepEmps" runat="server" Text="部門人數重配置" OnClick="WFB2SJ3400ReGenDepEmps_Click" OnClientClick="return exeCheckSearch();" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ3400Upd" runat="server" Text="修改" Visible="false" OnClick="WFB2SJ3400Upd_Click" OnClientClick="BlockUI();" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ3400DAO" EnablePaging="True"
