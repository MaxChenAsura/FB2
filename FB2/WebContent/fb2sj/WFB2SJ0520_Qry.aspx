<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0520_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0520_Qry" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                     ...
                     <tr>  
                        ...
                        <td align="left" class="Body_label">
                         ...
                         <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lbl_GRP_CD" runat="server" Text="考核群組"></asp:Label>:
                        </th>
                        <td align="left" class="Body_label">
                            <asp:DropDownList ID="ddl_GRP_CD" runat="server" Width="100px" ClientIDMode="Static" CssClass="" > </asp:DropDownList>
                        </td>                    
                         <th align="left" class="Body_TableHeader">
 			...
 			<th align="left" >
                         ...
                         <td align="center"><asp:TextBox ID="txt_Message" runat="server" Width="150px"  COLOR="RED" Visible="false" CssClass="txtDisabled"  Enabled="false" BorderWidth="0" >已完成</asp:TextBox></td>
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0520Search" runat="server" Text="查詢" OnClick="WFB2SJ0520Search_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SJ0520Situation" runat="server" Text="提出現況" OnClick="WFB2SJ0520Situation_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SJ0520Approved" runat="server" Text="核定作業" OnClick="WFB2SJ0520Approved_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SJ0520Statistics" runat="server" Text="考核統計表" OnClick="WFB2SJ0520Statistics_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SJ0520Sign" runat="server" Text="提出簽核" OnClick="WFB2SJ0520Sign_Click" OnClientClick="return CheckSearch();" />
                                <asp:Button ID="btn_clear" runat="server" Text="<%$Resources:Resource,wfb2ia_btn_clear%>" OnClientClick="ClearAll();" />
                                <aces:Btn ID="WFB2SJ0520Refer" runat="server" Text="參考資料" OnClick="WFB2SJ0520Refer_Click" OnClientClick="" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="hid_ASSESS_YEAR"
                     ...
                     <asp:ControlParameter ControlID="ddl_GRP_CD"
                        Name="grp_cd" PropertyName="SelectedValue" Type="String" ConvertEmptyStringToNull="False" />   
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--部門名稱--%>
                    <asp:TemplateField HeaderText="部門名稱" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="IS_OUT">
                        <ItemTemplate>
                            <asp:Label ID="lb_R_DEPT_NAME" runat="server" Text='<%#Bind("DEPT_NAME")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--外數區分--%>
                    ...
                    <%--考核修改次數--%>
                    <asp:TemplateField HeaderText="考核修改次數<BR>(*理由說明)" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" SortExpression="FIX_COUNT">
                        <ItemTemplate>
                    ...
                    <%--遲到/早退--%>
                    <asp:TemplateField HeaderText="遲到/早退" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lb_R_LEAVE_OP" runat="server" Text='<%#Bind("LEAVE_OP")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--曠職--%>
                    <asp:TemplateField HeaderText="曠職" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lb_R_LEAVE_Q" runat="server" Text='<%#Bind("LEAVE_Q")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--事病假--%>
                    <asp:TemplateField HeaderText="事病假" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ0520Statistics"></asp:PostBackTrigger>
        </Triggers>
         <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ0520Refer"></asp:PostBackTrigger>
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
