<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0530_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0530_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0530Search" runat="server" Text="查詢" OnClick="WFB2SJ0530Search_Click" OnClientClick="return CheckSearch();" />
                                <asp:Button ID="btn_clear" runat="server" Text="<%$Resources:Resource,wfb2ia_btn_clear%>" OnClientClick="ClearAll();" />
                                <aces:Btn ID="WFB2SJ0530Dtl" runat="server" Text="考核資料" OnClick="WFB2SJ0530Dtl_Click" OnClientClick="" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ0530DAO" EnablePaging="True"
