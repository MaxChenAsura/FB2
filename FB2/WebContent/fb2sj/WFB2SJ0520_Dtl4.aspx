<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0520_Dtl4.aspx.cs" Inherits="WebContent_WFB2SJ0520_Dtl4" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getWSApproveData"
                SelectCountMethod="getWSApproveCount" TypeName="CFB2SJ0520DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--職種--%>
                    <asp:TemplateField HeaderText="職種" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lb_R_WS_CD_DESC" runat="server" Text='<%#Bind("WS_CD_DESC")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--考核群組--%>
                    <asp:TemplateField HeaderText="考核群組" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lb_R_GRP_NAME" runat="server" Text='<%#Bind("GRP_NAME")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--應評人數--%>
