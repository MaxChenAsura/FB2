<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3600_Dtl.aspx.cs" Inherits="WebContent_WFB2SJ3600_Dtl" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" align="right" class="Body_label">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SJ3600EmpDtlSearch" runat="server" Text="查詢" OnClick="WFB2SJ3600EmpDtlSearch_Click"  />
                                        
                                            <asp:Button ID="btn_clear" runat="server" Text="<%$Resources:Resource,wfb2ia_btn_clear%>" OnClientClick="ClearAll();" />
                                             <aces:Btn ID="WFB2SJ3600EmpScore" runat="server" Text="評分表" OnClick="WFB2SJ3600EmpScore_Click" OnClientClick="" />
                                             <asp:Button runat="server" ID="btn_cancel" Text="返回" OnClick="btn_Cancel_Click" />
                                             <aces:Btn ID="WFB2SJ3600Reference" runat="server" Text="參考資料XLS" OnClick="WFB2SJ3600Reference_Click" OnClientClick="" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDataDtl"
                SelectCountMethod="getCountDtl" TypeName="CFB2SJ3600DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--職務年資--%>
                    <asp:TemplateField HeaderText="職務年資" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center"  SortExpression="RECENT_LEVEL_WORK_YEARS" >
                        <ItemTemplate>
                            <asp:Label ID="lb_R_PJOB_WORK_YEARS" runat="server" Text='<%#Bind("PJOB_WORK_YEARS")%>' Width="70px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--年齡--%>
                    ...
                    <%--入社年資--%>
                    <asp:TemplateField HeaderText="服務年資" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center"  SortExpression="SERVICE_YEARS" >
                        <ItemTemplate>
                            <asp:Label ID="lb_R_WORK_YEARS" runat="server" Text='<%#Bind("SERVICE_YEARS")%>' Width="70px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--備註內容--%>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ3600Reference"></asp:PostBackTrigger>
        </Triggers>
    </asp:UpdatePanel>
