<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3100_Qry.aspx.cs" Inherits="WebContent_WFB2SJ3100_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ3100Search" runat="server" Text="查詢" OnClick="WFB2SJ3100Search_Click" OnClientClick="return CheckSearch();" />
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ3100Add" runat="server" Text="新增" Visible="true" OnClick="WFB2SJ3100Add_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ3100Upd" runat="server" Text="修改" Visible="false" OnClick="WFB2SJ3100Upd_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ3100Del" runat="server" Text="刪除" Visible="false" OnClick="WFB2SJ3100Del_Click" OnClientClick="return doButtonConfirm(this.value);" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ3100DAO" EnablePaging="True"
