<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3900_Qry.aspx.cs" Inherits="WebContent_WFB2SJ3900_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="5">
                            <aces:Btn ID="WFB2SJ3900Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ3900Search_Click"   OnClientClick="CheckSearch();"/>
                            <%--<asp:Button ID="WFB2SJ3900Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ3900Search_Click"   OnClientClick="CheckSearch();"/>--%>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="6">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ3900Add" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_add%>" Visible="true" OnClick="WFB2SJ3900Add_Click" OnClientClick="return CheckSearch();" />
                                <aces:Btn ID="WFB2SJ3900Delete" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_delete%>" Visible="false" OnClick="WFB2SJ3900Delete_Click" OnClientClick="return doDelete();" />

                                 <aces:Btn ID="WFB2SJ3900Execute" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_target_gen%>" Visible="false" OnClick="WFB2SJ3900Execute_Click" OnClientClick="return executeCheck(); " />
                                 <aces:Btn ID="WFB2SJ3900Release" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_release%>" Visible="false" OnClick="WFB2SJ3900Release_Click" OnClientClick="return CheckRelease();" />
                                 <aces:Btn ID="WFB2SJ3900Announce" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_announce%>" Visible="false" OnClick="WFB2SJ3900Announce_Click" OnClientClick="return CheckAnnounce();" />


                                <aces:Btn ID="WFB2SJ3900OK" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_ok%>" Visible="false"  OnClick="WFB2SJ3900OK_Click" OnClientClick="return saveCheck()"/>
                                 <%--<asp:Button ID="WFB2SJ3900Add" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_add%>" Visible="true" OnClick="WFB2SJ3900Add_Click" OnClientClick="return CheckSearch();" />
                                <asp:Button ID="WFB2SJ3900Delete" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_delete%>" Visible="false" OnClick="WFB2SJ3900Delete_Click" OnClientClick="return doDelete();" />

                                 <asp:Button ID="WFB2SJ3900Execute" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_target_gen%>" Visible="false" OnClick="WFB2SJ3900Execute_Click" OnClientClick="return executeCheck(); " />
                                 <asp:Button ID="WFB2SJ3900Release" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_release%>" Visible="false" OnClick="WFB2SJ3900Release_Click" OnClientClick="return CheckRelease();" />
                                 <asp:Button ID="WFB2SJ3900Announce" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_announce%>" Visible="false" OnClick="WFB2SJ3900Announce_Click" OnClientClick="return CheckAnnounce();" />


                                <asp:Button ID="WFB2SJ3900OK" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_ok%>" Visible="false"  OnClick="WFB2SJ3900OK_Click" OnClientClick="return saveCheck()"/>--%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData" 
                SelectCountMethod="getCount" TypeName="CFB2SJ3900DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_function%>" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <aces:Btn ID="WFB2SJ3900Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="<%$Resources:Resource,wfb2sj_btn_detailandmaintain%>" />
                            <%--
                            <asp:Button ID="WFB2SJ3900Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="<%$Resources:Resource,wfb2sj_btn_detailandmaintain%>" />
                                --%>
