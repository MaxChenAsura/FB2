<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3700_Qry.aspx.cs" Inherits="WebContent_WFB2SJ3700_Qry" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ3700Search" runat="server" Text="查詢" OnClick="WFB2SJ3700Search_Click" OnClientClick="return CheckSearch();" />
                                <aces:Btn ID="WFB2SJ3700Situation" runat="server" Text="提出現況" OnClick="WFB2SJ3700Situation_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SJ3700Approved" runat="server" Text="核定作業" OnClick="WFB2SJ3700Approved_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SJ3700Statistics" runat="server" Text="考核統計表" OnClick="WFB2SJ3700Statistics_Click" OnClientClick="" />
                                <aces:Btn ID="WFB2SJ3700Sign" runat="server" Text="提出簽核" Visible="false" OnClick="WFB2SJ3700Sign_Click" OnClientClick="return SignConfirm('M');" />
                                <aces:Btn ID="WFB2SJ3700DeptSign" runat="server" Text="提出複核" Visible="false" OnClick="WFB2SJ3700Sign_Click" OnClientClick="return SignConfirm('R');" />
                                <asp:Button ID="btn_back" runat="server" Text="退回" Visible="false" OnClick="WFB2SJ3700Back_Click"  />
                                <asp:Button ID="btn_clear" runat="server" Text="<%$Resources:Resource,wfb2ia_btn_clear%>" OnClientClick="ClearAll();" />
                                <aces:Btn ID="WFB2SJ3700Refer" runat="server" Text="參考資料" OnClick="WFB2SJ3700Refer_Click" OnClientClick="" />
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ3700Statistics"></asp:PostBackTrigger>
        </Triggers>
         <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ3700Refer"></asp:PostBackTrigger>
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
