<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3700_Dtl3.aspx.cs" Inherits="WebContent_WFB2SJ3700_Dtl3" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" align="right" class="Body_label">
                                        <div id="init">
                                             <asp:Button runat="server" ID="btn_back" Text="確認退回" OnClick="WFB2SJ3700Back_Click" OnClientClick="return SignConfirm();" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getBackData"
                SelectCountMethod="getBackCount" TypeName="CFB2SJ3700DAO" EnablePaging="True"
             ...
             <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--單位代號--%>
                    <asp:TemplateField HeaderText="單位代號" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="DEPT_NO">
                        <ItemTemplate>
                            <asp:Label ID="lb_R_DEPT_NO" runat="server" Text='<%#Bind("DEPT_NO")%>' Width="120px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--單位名稱--%>
                    ...
                    <%--主管工號--%>
                    <asp:TemplateField HeaderText="主管工號" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="HEAD_EMP_ID">
                        <ItemTemplate>
                            <asp:Label ID="lb_R_HEAD_EMP_ID" runat="server" Text='<%#Bind("HEAD_EMP_ID")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--主管姓名--%>
                    <asp:TemplateField HeaderText="主管姓名" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="HEAD_EMP_NAME">
                        <ItemTemplate>
                            <asp:Label ID="lb_R_HEAD_EMP_NAME" runat="server" Text='<%#Bind("HEAD_EMP_NAME")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>                
