<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3200_Qry.aspx.cs" Inherits="WebContent_WFB2SJ3200_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ3200Search" runat="server" Text="查詢" OnClick="WFB2SJ3200Search_Click" OnClientClick="return CheckSearch();" />
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ3200Del" runat="server" Text="刪除" Visible="false" OnClick="WFB2SJ3200Del_Click" OnClientClick="return doButtonConfirm(this.value);" />                                
                                <aces:Btn ID="WFB2SJ3200Updload" runat="server" Text="人員上傳" Visible="true" OnClick="WFB2SJ3200Updload_Click" OnClientClick="BlockUI();" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ3200DAO" EnablePaging="True"
