<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ4000_Dtl.aspx.cs" Inherits="WebContent_WFB2SJ4000_Dtl" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <aces:Btn ID="WFB2SJ4000ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_result_down%>" OnClick="WFB2SJ4000ExcelDown_Click" OnClientClick="return checkDowning(this.value);" />
                            <%--<asp:Button ID="WFB2SJ4000ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_result_down%>" OnClick="WFB2SJ4000ExcelDown_Click" OnClientClick="return checkDowning(this.value);" />--%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" colspan="4">
                            <asp:Button ID="WFB2SJ4000Back" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_back%>" OnClientClick="BlockUI();" OnClick="WFB2SJ4000Back_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="5">
                            <aces:Btn ID="WFB2SJ4001Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ4001Search_Click" OnClientClick="BlockUI();" />
                            <%--<asp:Button ID="WFB2SJ4001Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ4001Search_Click" OnClientClick="BlockUI();" />--%>
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            <aces:Btn ID="WFB2SJ4000Mark" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_mark%>" OnClick="WFB2SJ4000Mark_Click" OnClientClick="return checkMark();" />
                            <%--<asp:Button ID="WFB2SJ4000Mark" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_mark%>" OnClick="WFB2SJ4000Mark_Click" OnClientClick="return checkMark();" />--%>
                        </td>
                        <td align="right" colspan="2">
                            <aces:Btn ID="WFB2SJ4000Approve" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_approve%>" OnClick="WFB2SJ4000Approve_Click" OnClientClick="return checkApprove();" />
                            <aces:Btn ID="WFB2SJ4000Reject" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_reject%>" OnClick="WFB2SJ4000Reject_Click" OnClientClick="return checkReject();" />
                           <%-- <asp:Button ID="WFB2SJ4000Approve" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_approve%>" OnClick="WFB2SJ4000Approve_Click" OnClientClick="return checkApprove();" />
                            <asp:Button ID="WFB2SJ4000Reject" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_reject%>" OnClick="WFB2SJ4000Reject_Click" OnClientClick="return checkReject();" />--%>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDataDtl"
                SelectCountMethod="getCountDtl" TypeName="CFB2SJ4000DAO" EnablePaging="True"
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="WFB2SJ4000ExcelDown" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
