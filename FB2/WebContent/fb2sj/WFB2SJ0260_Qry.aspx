<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0260_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0260_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                     ...
                     <tr>  
                        ...
                        <td align="left" class="Body_label">
                         ...
                         <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lbl_SURE_YN" runat="server" Text="是否確認"></asp:Label>:
                        </th>
                        <td align="left" class="Body_label">
                            <asp:DropDownList ID="ddl_SURE_YN" runat="server" Width="100px" ClientIDMode="Static" CssClass=""> </asp:DropDownList>
                        </td>    
                         <th></th>
                         <th></th>                        
                    </tr>             
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0260Search" runat="server" Text="查詢" OnClick="WFB2SJ0260Search_Click" OnClientClick="return CheckSearch();" />
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="6">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ0260Add" runat="server" Text="新增" Visible="true" OnClick="WFB2SJ0260Add_Click" OnClientClick="return CheckSearch();" />
                                <aces:Btn ID="WFB2SJ0260Upd" runat="server" Text="修改" Visible="false" OnClick="WFB2SJ0260Upd_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ0260Del" runat="server" Text="刪除" Visible="false" OnClick="WFB2SJ0260Del_Click" OnClientClick="return doButtonConfirm(this.value);" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ0260DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="txt_EMP_ID"
                     ...
                     <asp:ControlParameter ControlID="ddl_SURE_YN"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--工號--%>
                    <asp:TemplateField HeaderText="工號" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" SortExpression="EMP_ID">
                        <ItemTemplate>
                            <asp:Label ID="lb_EMP_ID" runat="server" Text='<%#Bind("EMP_ID")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--姓名--%>
                    <asp:TemplateField HeaderText="姓名" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" SortExpression="EMP_NAME">
                        <ItemTemplate>
                            <asp:Label ID="lb_EMP_NAME" runat="server" Text='<%#Bind("EMP_NAME")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--(新)直屬主管--%>
                    <asp:TemplateField HeaderText="(新)直屬主管" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lb_HEAD_EMP_NAME_NEW" runat="server" Text='<%#Bind("HEAD_EMP_NAME_NEW")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>    
                    <%--(新)部門全名稱--%>
                    <asp:TemplateField HeaderText="(新)部門全名稱" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                            <asp:Label ID="lb_DEPT_NAME_NEW" runat="server" Text='<%#Bind("DEPT_NAME_NEW")%>' Width="150px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>      
                    <%--(原)直屬主管--%>
                    <asp:TemplateField HeaderText="(原)直屬主管" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                            <asp:Label ID="lb_HEAD_EMP_NAME_OLD" runat="server" Text='<%#Bind("HEAD_EMP_NAME_OLD")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>  
                    <%--(原)部門全名稱--%>
                    <asp:TemplateField HeaderText="(原)部門全名稱" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                            <asp:Label ID="lb_DEPT_NAME_OLD" runat="server" Text='<%#Bind("DEPT_NAME_OLD")%>' Width="150px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>     
                    <%--是否確認--%>
                    <asp:TemplateField HeaderText="是否確認" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lb_SURE_YN_DESC" runat="server" Text='<%#Bind("SURE_YN_DESC")%>' Width="70px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>  
