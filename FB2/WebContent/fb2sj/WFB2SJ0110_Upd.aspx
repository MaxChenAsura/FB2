<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0110_Upd.aspx.cs" Inherits="WebContent_WFB2SJ0110_Upd" Culture="auto" UICulture="auto" %>
                        ...
                        <table cellspacing="1" cellpadding="1" width="100%" border="0" class="Body_Label">
                            ...
                            <tbody>
                                ...
                                <tr>
                                      <%-- 資格 --%>    
                                    <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="lb_LEVEL_CD" runat="server" Text="資格"></asp:Label>:</th>
                                    <td align="left" class="Body_label" >
                                    ...
                                    <%-- 職務類型 --%>    
                                    <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="lbl_PJOB_TYPE" runat="server" Text="職務類型"  ></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label">
                                         <asp:TextBox ID="txt_PJOB_TYPE_DESC" runat="server" CssClass="txtDisabled" Enabled="false" BorderWidth="0"></asp:TextBox>   
                                        <asp:HiddenField ID="hid_PJOB_TYPE" runat="server" ClientIDMode="Static" />                                                    
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label" colspan="3">
                                       <asp:TextBox ID="txt_ITEM_GROUP" runat="server" Width="100px"  ClientIDMode="Static" Enabled="false" BorderWidth="1" CssClass="MandatoryField"></asp:TextBox>   
                                        ...
                                        <asp:TextBox ID="txt_ITEM_GROUP_NAME" runat="server" Width="150px" ClientIDMode="Static" Enabled="false" BorderWidth="0" CssClass="MandatoryField"></asp:TextBox>
                               ...
                               <tr>
                                    ...
                                    <td align="right" class="Body_label" colspan="3">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SJ0110Save_U" runat="server" Text="儲存"  OnClientClick="return saveCheck();" OnClick="WFB2SJ0110Save_Click"  />
