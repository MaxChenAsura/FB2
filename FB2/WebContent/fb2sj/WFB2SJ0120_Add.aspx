<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0120_Add.aspx.cs" Inherits="WebContent_WFB2SJ0120_Add" Culture="auto" UICulture="auto" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="left" class="Body_label" >
                                        <asp:TextBox ID="txt_DISTING_CD" runat="server" MaxLength="10" Width="80px" CssClass="MandatoryField" ClientIDMode="Static"></asp:TextBox>
                                           <!--必輸入-->
                                        <asp:RequiredFieldValidator ID="Req_DISTING_CD" runat="server" 
                                            ErrorMessage="區分代碼必輸入"
                                            ControlToValidate="txt_DISTING_CD" ForeColor="Red" ValidationGroup="GroupA" Display="None"></asp:RequiredFieldValidator>
                                         <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                            ErrorMessage="區分代碼限輸英數字" ControlToValidate="txt_DISTING_CD" ForeColor="Red"
                                               ValidationExpression="^[0-9a-zA-Z_]+$" Display="None" ValidationGroup="GroupA">
                                              </asp:RegularExpressionValidator>
                                    </td>
                                    <%-- 區分說明 --%>    
                                    <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="Label1" runat="server" Text="區分說明"></asp:Label>:</th>
                                    <td align="left" class="Body_label" >
                                        <asp:TextBox ID="txt_DISTING_DESC" runat="server" MaxLength="60" Width="200px"  ClientIDMode="Static"></asp:TextBox>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label" >
                                        <asp:TextBox ID="txt_CONTENT" runat="server" MaxLength="20" Width="200px" ClientIDMode="Static"></asp:TextBox>
                               ...
                               <tr>
                                    ...
                                    <td align="right" class="Body_label" colspan="3">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SJ0120Save_A" runat="server" Text="儲存"  OnClientClick="return saveCheck();" OnClick="WFB2SJ0120Save_Click"  />
