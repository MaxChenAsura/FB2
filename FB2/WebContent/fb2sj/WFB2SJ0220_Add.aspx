<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0220_Add.aspx.cs" Inherits="WebContent_WFB2SJ0220_Add" Culture="auto" UICulture="auto" %>
                            ...
                            <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label">
                                        ...
                                        <asp:CustomValidator ID="cv_RATE_E" runat="server" ValidateEmptyText="true"
                                            ErrorMessage="E(%)僅能輸入數字" ClientValidationFunction="CheckIsNaN" ForeColor="Red"
                               ...
                               <tr>
                                    ...
                                    <td align="right" class="Body_label" colspan="3">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SJ0220Save_A" runat="server" Text="儲存"  OnClientClick="return saveCheck();" OnClick="WFB2SJ0220Save_Click"  />
