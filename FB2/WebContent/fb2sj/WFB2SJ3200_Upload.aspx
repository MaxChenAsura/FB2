<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3200_Upload.aspx.cs" Inherits="WebContent_fb2hb_WFB2SJ3200_Upload"  Culture="auto" UICulture="auto" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                   <aces:Btn ID="WFB2SJ3200Upload" runat="server" Text="匯入" OnClick="WFB2SJ3200Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>
                     <asp:Button ID="WFB2SJ3200ExcelDown" runat="server" Text="範例下載" OnClick="btn_Excel_Down_Click" />
