<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0170_Upload.aspx.cs" Inherits="WebContent_fb2hb_WFB2SJ0170_Upload"  Culture="auto" UICulture="auto" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                    <aces:Btn ID="WFB2SJ0170Upload" runat="server" Text="匯入" OnClick="WFB2SJ0170Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>
                     <asp:Button ID="WFB2SJ0170ExcelDown" runat="server" Text="範例下載" OnClick="btn_Excel_Down_Click" />
                    ...
                    <fieldset style="padding:5px">
                        ...
                        <table align="right">
                            <tr>
                                ...
                                <td>
                                    <%--<aces:Btn ID="WFB2SJ0170ExcelDown" runat="server" Text="EXCEL匯出" OnClick="btn_Excel_Down_Click" />--%>                                    
