<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0510_Dtl3.aspx.cs" Inherits="WebContent_WFB2SJ0510_Dtl3" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" align="right" class="Body_label">
                                        <div id="init">
                                             <asp:Button runat="server" ID="btn_back" Text="確認退回" OnClick="WFB2SJ0510Back_Click" OnClientClick="return SignConfirm();" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getBackData"
                SelectCountMethod="getBackCount" TypeName="CFB2SJ0510DAO" EnablePaging="True"
