<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0280_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0280_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr> 
                         ...
                         <th >
                           <asp:HiddenField ID="hid_GRP_CD" runat="server" ClientIDMode="Static" Value="" /> 
                             <asp:HiddenField ID="hid_MA_TYPE" runat="server" ClientIDMode="Static" Value="" />
                        </th>
                         <td >                             
                    ...
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0280Search" runat="server" Text="查詢" OnClick="WFB2SJ0280Search_Click" OnClientClick="return CheckSearch();" />
                                ...
                                <asp:Button ID="btn_clear" runat="server" Text="<%$Resources:Resource,wfb2ia_btn_clear%>" OnClientClick="ClearAll();" />
                                 <aces:Btn ID="WFB2SJ0280ReGen" runat="server" Text="協理重配置" OnClick="WFB2SJ0280ReGen_Click" OnClientClick="return exeCheckSearch();" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ0280Upd" runat="server" Text="修改" Visible="false" OnClick="WFB2SJ0280Upd_Click" OnClientClick="BlockUI();" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ0280DAO" EnablePaging="True"
