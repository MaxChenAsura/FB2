<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3900_Dtl.aspx.cs" Inherits="WebContent_WFB2SJ3900_Dtl" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <aces:Btn ID="WFB2SJ3901Update" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_score_all_update%>" OnClick="WFB2SJ3901Update_Click" OnClientClick="return updateAllScore();" />
                            <aces:Btn ID="WFB2SJ3901Print" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_print%>" OnClick="WFB2SJ3901Print_Click" OnClientClick="return checkDowning(this.value);" Visible="false" />
                            <aces:Btn ID="WFB2SJ3901PrintDown" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_printdown%>" OnClick="WFB2SJ3901PrintDown_Click" OnClientClick="return checkDowning(this.value);"  Visible="false"/>
                            <aces:Btn ID="WFB2SJ3901ExcelDown1" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_data_down%>" OnClick="WFB2SJ3901ExcelDown1_Click" OnClientClick="return checkDowning(this.value);" />
                            <aces:Btn ID="WFB2SJ3901ExcelDown2" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_result_down%>" OnClick="WFB2SJ3901ExcelDown2_Click" OnClientClick="return checkDowning(this.value);" />
                           <%-- <asp:Button ID="WFB2SJ3901Update" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_score_all_update%>" OnClick="WFB2SJ3901Update_Click" OnClientClick="return updateAllScore();" />
                            <asp:Button ID="WFB2SJ3901Print" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_print%>" OnClick="WFB2SJ3901Print_Click" OnClientClick="return checkDowning(this.value);" />
                            <asp:Button ID="WFB2SJ3901PrintDown" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_printdown%>" OnClick="WFB2SJ3901PrintDown_Click" OnClientClick="return checkDowning(this.value);" />
                            <asp:Button ID="WFB2SJ3901ExcelDown1" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_data_down%>" OnClick="WFB2SJ3901ExcelDown1_Click" OnClientClick="return checkDowning(this.value);" />
                            <asp:Button ID="WFB2SJ3901ExcelDown2" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_result_down%>" OnClick="WFB2SJ3901ExcelDown2_Click" OnClientClick="return checkDowning(this.value);" />--%>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
                        <td align="right" colspan="5">
                            <asp:Button ID="WFB2SJ3900Back" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_back%>" OnClientClick="BlockUI();" OnClick="WFB2SJ3900Back_Click" />
                        </td>
                    </tr>
                            ...
                            <table cellspacing="1" cellpadding="1" width="1020px" border="0" class="Body_Label">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th></th>
                                        <td align="right" colspan="5">
                                            <aces:Btn ID="WFB2SJ3901Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ3901Search_Click" OnClientClick="BlockUI();" />
                                            <%--<asp:Button ID="WFB2SJ3901Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ3901Search_Click" OnClientClick="BlockUI();" />--%>
                                    ...
                                    <tr>
                                        <td align="left" colspan="3">
                                            ...
                                            <div id="payTypeUpdate">
                                                ...
                                                <aces:Btn ID="WFB2SJ3901Update1" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_score_update%>" OnClick="WFB2SJ3901Update1_Click" OnClientClick="return CheckUpdateAction('all');" />
                                                <aces:Btn ID="WFB2SJ3901Update2" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_score_final_update%>" OnClick="WFB2SJ3901Update2_Click" OnClientClick="return CheckUpdateAction('final');" />
                                                <%--<asp:Button ID="WFB2SJ3901Update1" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_score_update%>" OnClick="WFB2SJ3901Update1_Click" OnClientClick="return CheckUpdateAction('all');" />
                                                <asp:Button ID="WFB2SJ3901Update2" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_score_final_update%>" OnClick="WFB2SJ3901Update2_Click" OnClientClick="return CheckUpdateAction('final');" />--%>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDataDtl"
                SelectCountMethod="getCountDtl" TypeName="CFB2SJ3900DAO" EnablePaging="True"
        ...
        <%--EXCEL下載用 --%>
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ3901PrintDown" />
            <asp:PostBackTrigger ControlID="WFB2SJ3901Print" />
            <asp:PostBackTrigger ControlID="WFB2SJ3901ExcelDown1" />
            <asp:PostBackTrigger ControlID="WFB2SJ3901ExcelDown2" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
