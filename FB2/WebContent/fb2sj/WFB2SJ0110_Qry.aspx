<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0110_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0110_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0110Search" runat="server" Text="查詢" OnClick="WFB2SJ0110Search_Click" OnClientClick="return CheckSearch();" />
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ0110Add" runat="server" Text="新增" Visible="true" OnClick="WFB2SJ0110Add_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ0110Upd" runat="server" Text="修改" Visible="false" OnClick="WFB2SJ0110Upd_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ0110Del" runat="server" Text="刪除" Visible="false" OnClick="WFB2SJ0110Del_Click" OnClientClick="return doButtonConfirm(this.value);" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ0110DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--職務類型--%>
                    <asp:TemplateField HeaderText="職務類型" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="PJOB_TYPE">
                        <ItemTemplate>
                            <asp:Label ID="lb_PJOB_TYPE_DESC" runat="server" Text='<%#Bind("PJOB_TYPE_DESC")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>  
                    <%--項目群組--%>
                    <asp:TemplateField HeaderText="項目群組" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" SortExpression="ITEM_GROUP">
                        <ItemTemplate>
                            <asp:Label ID="lb_ITEM_GROUP" runat="server" Text='<%#Bind("ITEM_GROUP")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>  
                    <%--項目群組--%>
                    <asp:TemplateField HeaderText="項目說明" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Left" SortExpression="ITEM_GROUP">
                        <ItemTemplate>
                            <asp:Label ID="lb_ITEM_GROUP_DESC" runat="server" Text='<%#Bind("ITEM_GROUP_DESC")%>' Width="120px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>  
                </Columns>
