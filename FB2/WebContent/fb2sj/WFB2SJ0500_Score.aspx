<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0500_Score.aspx.cs" Inherits="WebContent_WFB2SJ0500_Score" Culture="auto" UICulture="auto" %>
                            ...
                            <tbody>
                                ...
                                <tr>                                    
                                    <td  align="right" class="Body_label" colspan="2">
                                        <div id="init">
                                            <asp:Button ID="WFB2SJ0500EmpScorePre" runat="server" Text="上一筆" OnClick="WFB2SJ0500EmpScorePre_Click" />
                                            <asp:Button ID="WFB2SJ0500EmpScoreNext" runat="server" Text="下一筆" OnClick="WFB2SJ0500EmpScoreNext_Click"  />
                                            <asp:Button ID="WFB2SJ0500EmpScoreSave" runat="server" Text="儲存" OnClick="WFB2SJ0500EmpScoreSave_Click" />
