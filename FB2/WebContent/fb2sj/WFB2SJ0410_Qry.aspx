<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0410_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0410_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0410Search" runat="server" Text="查詢" OnClick="WFB2SJ0410Search_Click" OnClientClick="return CheckSearch();" />
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="6">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ0410Add" runat="server" Text="新增" Visible="true" OnClick="WFB2SJ0410Add_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ0410Upd" runat="server" Text="修改" Visible="false" OnClick="WFB2SJ0410Upd_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ0410Del" runat="server" Text="刪除" Visible="false" OnClick="WFB2SJ0410Del_Click" OnClientClick="return doButtonConfirm(this.value);" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ0410DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="hid_CREATED_BY"
                        Name="created_by" PropertyName="Value" Type="String" ConvertEmptyStringToNull="false" />  
                </SelectParameters>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sh_lb_rownumber%>" HeaderStyle-Width="40px">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hid_AUDRESULT1_YN" runat="server" Value='<%#Bind("AUDRESULT1_YN")%> ' ClientIDMode="Static" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--工號--%>
                    ...
                    <%--姓名--%>
                    <asp:TemplateField HeaderText="姓名" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="EMP_NAME">
                        <ItemTemplate>
                            <asp:Label ID="lb_EMP_NAME" runat="server" Text='<%#Bind("EMP_NAME")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--要望考核
                    <asp:TemplateField HeaderText="今回考核" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" SortExpression="SUGGEST_SCORE">
                        <ItemTemplate>
                            <asp:Label ID="lb_SCORE_FINAL" runat="server" Text='<%#Bind("SCORE_DEPT")%>' Width="30px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField> 
                        --%>
                    <%--要望考核--%>
                    <asp:TemplateField HeaderText="要望考核" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" SortExpression="SUGGEST_SCORE">
                        <ItemTemplate>
                            <asp:Label ID="lb_SUGGEST_SCORE" runat="server" Text='<%#Bind("SUGGEST_SCORE")%>' Width="30px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>    
                    <%--填表人--%>
                    <asp:TemplateField HeaderText="填表人" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="CREATED_NAME">
                        <ItemTemplate>
                            <asp:Label ID="lb_CREATED_NAME" runat="server" Text='<%#Bind("CREATED_NAME")%>' Width="100px"></asp:Label>
                             <asp:HiddenField ID="hid_CREATED_BY" runat="server" Value='<%#Bind("CREATED_BY")%> ' ClientIDMode="Static" />
                        </ItemTemplate>
                    </asp:TemplateField>  
                </Columns>
