<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3800_Dtl.aspx.cs" Inherits="WebContent_WFB2SJ3800_Dtl" Culture="auto" UICulture="auto" %>
        ...
        <ContentTemplate>
            ...
            <table width="480px" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
             ...
             <table width="1020px" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
                <tr valign="top">                  
                    <td  align="right"  >   
                        <aces:Btn ID="WFB2SJ3800Export" runat="server" Text="考核資料XLS" OnClick="WFB2SJ3800Export_Click" OnClientClick="" />                                    
         ...
         <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ3800Export"></asp:PostBackTrigger>
        </Triggers>
    </asp:UpdatePanel>
