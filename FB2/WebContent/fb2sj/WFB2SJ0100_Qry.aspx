<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0100_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0100_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="right" colspan="6">
                            <aces:Btn ID="WFB2SJ0100Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ0100Search_Click"   OnClientClick="return CheckSearch();"/>
                            <%--<asp:Button ID="WFB2SJ0100Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ0100Search_Click"   OnClientClick="return CheckSearch();"/>--%>
                    ...
                    <tr>
                        <td align="left" class="Body_label" colspan="3">
                             <asp:Label ID="lb_level_up" runat="server" Text="*:前回昇格" Visible="false"></asp:Label></th>
                        </td>
                        <td align="right" class="Body_label" colspan="3">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ0100ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_data_down%>" Visible="false" OnClick="WFB2SJ0100ExcelDown_Click" OnClientClick="return checkDowning(this.value);"  />
                                <%--<asp:Button ID="WFB2SJ0100ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_data_down%>" Visible="false" OnClick="WFB2SJ0100ExcelDown_Click" OnClientClick="return checkDowning(this.value);"  />--%>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData" 
                SelectCountMethod="getCount" TypeName="CFB2SJ0100DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    <%--序號--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_rownumber%>" HeaderStyle-Width="80px">
                        <ItemTemplate>
                            <asp:Label ID="lb_RowNumber" runat="server" Text='<%#Bind("RowNumber")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--年度--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_assess_year%>" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Left" SortExpression="ASSESS_YEAR">
                        <ItemTemplate>
                            <asp:Label ID="lb_ASSESS_YEAR" runat="server" Text='<%#Bind("ASSESS_YEAR")%>' Width="50px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <%--考核類別--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_assess_type%>" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Left" SortExpression="ASSESS_TYPE">
                        <ItemTemplate>
                    ...
                    <%--當年昇格--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_levelup_flag%>" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="LEVELUP_FLAG">
                        <ItemTemplate>
                            <asp:Label ID="lb_LEVELUP_FLAG" runat="server" Text='<%#Bind("LEVELUP_FLAG")%>' Width="70px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--跨部異動--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_dept_flag%>" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="DEPT_FLAG">
                        <ItemTemplate>
                            <asp:Label ID="lb_DEPT_FLAG" runat="server" Text='<%#Bind("DEPT_FLAG")%>' Width="70px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--工號--%>
                    ...
                    <%--姓名--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_emp_name%>" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Left" SortExpression="EMP_NAME">
                        <ItemTemplate>
                            <asp:Label ID="lb_EMP_NAME" runat="server" Text='<%#Bind("EMP_NAME")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--部門代號--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_dept_no%>" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Left" SortExpression="DEPT_NO">
                        <ItemTemplate>
                            <asp:Label ID="lb_DEPT_NO" runat="server" Text='<%#Bind("DEPT_NO")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--部課--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_dept_20_name%>" HeaderStyle-Width="240px" ItemStyle-HorizontalAlign="Left" >
                        <ItemTemplate>
                            <asp:Label ID="lb_DEPT_NAME_DESC" runat="server" Text='<%#Bind("DEPT_NAME_DESC")%>' Width="240px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--職種--%>
                    ...
                    <%--最終考績--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sj_lb_score_final%>" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="SCORE_FINAL">
                        <ItemTemplate>
                            <asp:Label ID="lb_SCORE_FINAL" runat="server" Text='<%#Bind("SCORE_FINAL_DESC")%>' Width="70px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
       ...
       <%--EXCEL下載用 --%>
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SJ0100ExcelDown" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
