<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0510_Dtl4.aspx.cs" Inherits="WebContent_WFB2SJ0510_Dtl4" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getWSApproveData"
                SelectCountMethod="getWSApproveCount" TypeName="CFB2SJ0510DAO" EnablePaging="True"
