<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3300_Add.aspx.cs" Inherits="WebContent_WFB2SJ3300_Add" Culture="auto" UICulture="auto" %>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td align="right" class="Body_label" colspan="3">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SJ3300Save_A" runat="server" Text="儲存"  OnClientClick="return saveCheck();" OnClick="WFB2SJ3300Save_Click"  />
