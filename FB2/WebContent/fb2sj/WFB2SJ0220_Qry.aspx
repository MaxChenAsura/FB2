<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0220_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0220_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0220Search" runat="server" Text="查詢" OnClick="WFB2SJ0220Search_Click" OnClientClick="return CheckSearch();" />
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2SJ0220Add" runat="server" Text="新增" Visible="true" OnClick="WFB2SJ0220Add_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ0220Upd" runat="server" Text="修改" Visible="false" OnClick="WFB2SJ0220Upd_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SJ0220Del" runat="server" Text="刪除" Visible="false" OnClick="WFB2SJ0220Del_Click" OnClientClick="return doButtonConfirm(this.value);" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ0220DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--職種--%>
                    <asp:TemplateField HeaderText="職種" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Left" SortExpression="WS_CD">
                        <ItemTemplate>
                            <asp:Label ID="lb_WS_CD" runat="server" Text='<%#Bind("WS_CD")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--資格--%>
                    <asp:TemplateField HeaderText="資格" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Left" SortExpression="LEVEL_CD">
                        <ItemTemplate>
