<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3700_Dtl2.aspx.cs" Inherits="WebContent_WFB2SJ3700_Dtl2" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="1020" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
                            ...
                            <tbody>
                                 <tr>  
                                    ...
                                    <td align="left" class="Body_label">
                                     ...
                                     <th align="left" class="Body_label">
                                        <asp:Label ID="lb_SCORE_LEVEL_GROUP" runat="server" Text="考核群組"></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label">
                                         <asp:TextBox ID="txt_SCORE_LEVEL_GROUP" runat="server"   CssClass="txtDisabled"  Enabled="false" BorderWidth="0" ></asp:TextBox> 
                ...
                <tr height="100%" valign="top">
                    <td>
                         <table  ID="TABLE_RATE_02" cellspacing="1" cellpadding="1" width="100%" border="0" class="Body_Label" runat="server">
                           
                            <tbody>
                                <tr>
                                      <th align="left" class="Body_label" Width="130px" >
                                        <asp:Label ID="Label6" runat="server" Text="核給點數(不含外數)"></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label" Width="40px">
                                       <asp:TextBox ID="txt_DEPT_POINT" runat="server" Width="30px"  style="text-align: left;" CssClass="txtDisabled"  Enabled="false" BorderWidth="0" ></asp:TextBox>  
                                    </td>   
                                      <th align="left" class="Body_label" Width="70px">
                                        <asp:Label ID="Label7" runat="server" Text="合計點數"  ></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label" Width="40px">
                                       <asp:TextBox ID="txt_EMP_TOTAL_POINT" runat="server" Width="30px"  style="text-align: left;" CssClass="txtDisabled"  Enabled="false" BorderWidth="0" ></asp:TextBox>  
                                    </td> 
                                    <td></td>  
                                </tr>
                                </tbody>
                                 ...
                                 <tr>  
                                    ...
                                    <td align="left" class="Body_label">
                                     ...
                                     <td  align="right" class="Body_label">                                        
                                         <asp:Button ID="WFB2SJ3700AproveSave" runat="server" Text="修改確定" OnClick="WFB2SJ3700AproveSave_Click" OnClientClick="return CheckSearch();"  />
                                        ...
                                        <asp:HiddenField ID="hid_IS_DEPT_20" runat="server" ClientIDMode="Static" />  
                                         <asp:HiddenField ID="hid_ASSESS_YEAR" runat="server" ClientIDMode="Static" />  
                                          ...
                                          <asp:HiddenField ID="hid_SCORE_LEVEL_GROUP" Value="-1" runat="server" ClientIDMode="Static" />                            
                                        <asp:HiddenField ID="hid_SIGN_YN" runat="server" ClientIDMode="Static" /> 
                                         ...
                                         <asp:HiddenField ID="hid_SUB_DIRC_SIGN_YN" runat="server" ClientIDMode="Static" />       
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ3700DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:Parameter Name="maximumRows" Type="Int32" />
                     ...
                     <asp:ControlParameter ControlID="hid_SCORE_LEVEL_GROUP"
                        Name="score_level_group" PropertyName="Value" Type="String" ConvertEmptyStringToNull="False" />   
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--初核總評--%>
                    <asp:TemplateField HeaderText="初核總評" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="WS_CD">
                        <ItemTemplate>
                    ...
                    <%--考核修改次數--%>
                    <asp:TemplateField HeaderText="考核修改次數<BR>(*理由說明)" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center" SortExpression="FIX_COUNT">
                        <ItemTemplate>
                             <asp:LinkButton ID="lk_FIX_COUNT" runat="server" Text='<%#Bind("FIX_COUNT")%>' OnClick="LB_FIX_COUNT_Click" CommandArgument='<%#Bind("EMP_ID") %>' Width="120px" ></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--前1年--%>
