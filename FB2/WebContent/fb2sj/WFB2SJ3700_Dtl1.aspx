<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ3700_Dtl1.aspx.cs" Inherits="WebContent_WFB2SJ3700_Dtl1" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getSituationData"
                SelectCountMethod="getSituationCount" TypeName="CFB2SJ3700DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="hid_IS_DEPT_20"
                        Name="is_dept_20" PropertyName="Value" Type="String" ConvertEmptyStringToNull="false" /> 
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="true" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--主管工號--%>
                    <asp:TemplateField HeaderText="主管工號" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="DIREC_EMP_ID">
                        <ItemTemplate>
                            <asp:Label ID="lb_R_EMP_ID" runat="server" Text='<%#Bind("DIREC_EMP_ID")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--部級單位--%>
                    ...
                    <%--覆核狀況--%>
                    <asp:TemplateField HeaderText="複核狀況" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="LEVEL_SIGN_YN">
                        <ItemTemplate>
                            <asp:Label ID="lb_LEVEL_SIGN_YN_DESC" runat="server" Text='<%#Bind("LEVEL_SIGN_YN_DESC")%>' Width="70px"></asp:Label>
                             <asp:HiddenField ID="hid_LEVEL_SIGN_YN" runat="server" ClientIDMode="Static" Value='<%#Bind("LEVEL_SIGN_YN")%>'/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--簽核狀況--%>
