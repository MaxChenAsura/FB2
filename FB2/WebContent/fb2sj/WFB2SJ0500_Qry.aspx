<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0500_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0500_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="right" class="Body_label">
                            <div id="init">
                                <aces:Btn ID="WFB2SJ0500Search" runat="server" Text="查詢" OnClick="WFB2SJ0500Search_Click" OnClientClick="return CheckSearch();" />
                                ...
                                <asp:Button ID="btn_clear" runat="server" Text="<%$Resources:Resource,wfb2ia_btn_clear%>" OnClientClick="ClearAll();" Visible="false" />
                                 <aces:Btn ID="WFB2SJ0500EmpDtl" runat="server" Text="員工明細" OnClick="WFB2SJ0500EmpDtl_Click" OnClientClick="" />
                                 <aces:Btn ID="WFB2SJ0500Approve" runat="server" Text="提出簽核" OnClick="WFB2SJ0500Approve_Click" OnClientClick="return SignConfirm();" />
                            </div>
                        </td>
                    </tr>
                    <tr>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SJ0500DAO" EnablePaging="True"
