<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0210_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0210_Qry" Culture="auto" UICulture="auto" %>
        ...
        <ContentTemplate>
            ...
            <table width="1020px" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="Body_label">
                                        <div id="init">
                                             <aces:Btn ID="WFB2SJ0210Search" runat="server" Text="查詢" OnClick="WFB2SJ0210Search_Click" OnClientClick="return CheckSearch();" />
                ...
                <tr>
                    <td>
                        ...
                        <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                            SelectCountMethod="getCount" TypeName="CFB2SJ0210DAO" EnablePaging="True"
                ...
                <Columns>                  
                    ...
                    <%--職種轉換--%>
                    <asp:TemplateField HeaderText="職種轉換<br>(W->S)" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center" SortExpression="CHG_WS_CD">
                        <ItemTemplate>
