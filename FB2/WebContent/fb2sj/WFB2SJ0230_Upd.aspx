<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0230_Upd.aspx.cs" Inherits="WebContent_WFB2SJ0230_Upd" Culture="auto" UICulture="auto" %>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="Body_label">
                                        ...
                                        <asp:HiddenField ID="hid_SCORE_LEVEL_GROUP" runat="server" ClientIDMode="Static" />                                                    
                                    </td>
                               ...
                               <tr>
                                    ...
                                    <td align="right" class="Body_label" colspan="3">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SJ0230Save_U" runat="server" Text="儲存"  OnClientClick="return saveCheck();" OnClick="WFB2SJ0230Save_Click"  />
