<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0270_Upload.aspx.cs" Inherits="WebContent_fb2hb_WFB2SJ0270_Upload"  Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        //function toRedirect() {
        //    window.location.href = "WFB2SJ0400_Qry.aspx";
        //}
        ...
        <tbody>
            <tr>
              ...
              <tr>                        
                        ...
                        <td align="left" class="Body_label">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"    ErrorMessage="考核年度必輸入" InitialValue=""
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                    <aces:Btn ID="WFB2SJ0270Upload" runat="server" Text="匯入" OnClick="WFB2SJ0270Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>
                     <asp:Button ID="WFB2SJ0270ExcelDown" runat="server" Text="範例下載" OnClick="btn_Excel_Down_Click" />
                    ...
                    <fieldset style="padding:5px">
                        ...
                        <table align="right">
                            <tr>
                                ...
                                <td>
                                    <%--<aces:Btn ID="WFB2SJ0270ExcelDown" runat="server" Text="EXCEL匯出" OnClick="btn_Excel_Down_Click" />--%>                                    
