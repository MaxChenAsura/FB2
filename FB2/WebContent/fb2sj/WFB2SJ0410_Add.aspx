<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0410_Add.aspx.cs" Inherits="WebContent_WFB2SJ0410_Add" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function iniForm() {
            ...
            $("#txt_EMP_ID").change(function () {
                if ($("#txt_EMP_ID").val().length == 5) {
                    getEmpTargetData($("#txt_EMP_ID").val())
                } else {
            ...
            //推薦人工號取得姓名的ajax
            //工號取得姓名的ajax
            $("#txt_SUGGEST_EMP_ID").change(function () {
                if ($("#txt_SUGGEST_EMP_ID").val().length == 5) {
                    $.ajax({
                        url: "../commgeo/WFB2GetEmpData.ashx",
                        data: {
                            EMP_ID: $('#txt_SUGGEST_EMP_ID').val()
                        },
                        type: "GET",
                        cache: false,
                        dataType: 'json',
                        success: function (JData) {
                            if (JData.errMsg != "") {
                                $('#txt_SUGGEST_EMP_NAME').val("");
                                alert(JData.errMsg);
                            }
                            else {
                                $('#txt_SUGGEST_EMP_NAME').val(JData.EMP_NAME);
                            }
                        },
        ...
        function popAssessEmpReturn(json) {
            ...
            if (!(typeof returnValue === 'undefined')) {
                ...
                if (popFunId == 'Emp') {
                    ...
                    getEmpTargetData(obj.EMP_ID);
                }
               
            }
        }
        function doSetPopParam(id) {
            popFunId = id;
        }
        function getEmpTargetData(EMP_ID) {
            $.ajax({
                url: "WFB2SJ0420GetEmpTargetData.ashx",
                data: {
                    ASSESS_YEAR: $('#hid_ASSESS_YEAR').val(),
                    ASSESS_TYPE: $('#hid_ASSESS_TYPE').val(),
                    EMP_ID: EMP_ID,
                    CREATED_BY: $('#txt_CREATED_BY').val()
                },
                type: "GET",
                cache: false,
                dataType: 'json',
                success: function (JData) {
                    if (JData.errMsg != "") {
                        ...
                        if (JData.LIMIT_RATE.length == "1") {
                            alert(" 該員工為絶對" + JData.LIMIT_RATE + "考課,不允許要望申請");
                            clearEMPTargetData();
                            return;
                        }
                        ...
                        $('#txt_SCORE_DEPT').val(JData.SCORE_DEPT);
                        $('#hid_SCORE_DEPT').val(JData.SCORE_DEPT);
                        $('#txt_WS_CD').val(JData.WS_CD);
                        $('#txt_DEPT_NAME').val(JData.DEPT_NAME);
                        $('#txt_PJOB_DESC').val(JData.PJOB_DESC);
                        $('#txt_AGE').val(JData.AGE);
                        $('#txt_WORK_YEARS').val(JData.WORK_YEARS);
                        $('#txt_RECENT_LEVEL_WORK_YEARS').val(JData.RECENT_LEVEL_WORK_YEARS);
                        $('#txt_DISTING_REMARK').val(JData.DISTING_REMARK);
                        $('#txt_SCORE_1H_1').val(JData.SCORE_1H_1);
                        $('#txt_SCORE_1H_2').val(JData.SCORE_1H_2);
                        $('#txt_SCORE_1H_3').val(JData.SCORE_1H_3);
                        $('#txt_SCORE_2H_1').val(JData.SCORE_2H_1);
                        $('#txt_SCORE_2H_2').val(JData.SCORE_2H_2);
                        $('#txt_SCORE_2H_3').val(JData.SCORE_2H_3);
                        $('#txt_LEAVE_OP').val(JData.LEAVE_OP);
                        $('#txt_LEAVE_AB').val(JData.LEAVE_AB);
                        $('#txt_LEAVE_Q').val(JData.LEAVE_Q);
                        $('#hid_DEPT20_EMP_ID').val(JData.DEPT20_EMP_ID);
                        $('#hid_MA_A_EMP_ID').val(JData.MA_A_EMP_ID);
                        $('#hid_MA_B_EMP_ID').val(JData.MA_B_EMP_ID);
                    }
                },
        ...
        function clearEMPTargetData() {
            ...
            $('#txt_AGE').val("");
            $('#txt_WORK_YEARS').val("");
            $('#txt_RECENT_LEVEL_WORK_YEARS').val("");
            $('#txt_DISTING_REMARK').val("");
            $('#txt_SCORE_1H_1').val("");
            $('#txt_SCORE_1H_2').val("");
            $('#txt_SCORE_1H_3').val("");
            $('#txt_SCORE_2H_1').val("");
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label" colspan="3">
                                           <asp:TextBox ID="txt_DEPT_NAME" runat="server" Width="120px"  ClientIDMode="Static" BorderWidth="0"></asp:TextBox>
                                    </td>
                                      <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="Label8" runat="server" Text="部門提出"  ></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label" >
                                           <asp:TextBox ID="txt_SCORE_DEPT" runat="server" Width="100px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox>
                                    </td>
                                     <th></th>
                                </tr>
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label">
                                         ...
                                         <input id="bt_EMP_SEARCH" type="button" value="..." onclick="doSetPopParam('Emp');OpenEmpSearch('txt_EMP_ID', 'txt_EMP_NAME', 'N');" />                                      
                                    ...
                                    <td align="left" class="Body_label">  
                                        <asp:TextBox ID="txt_EMP_NAME" runat="server" Width="100px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox> 
                                    </td>
                                     <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="lb_WS_CD" runat="server" Text="職種"></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label">  
                                        <asp:TextBox ID="txt_WS_CD" runat="server" Width="70px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox> 
                                    </td>
                                     <th></th>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label">  
                                        <asp:TextBox ID="txt_LEVEL_CD" runat="server" Width="100px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox> 
                                    </td>
                                    ...
                                    <td align="left" class="Body_label">  
                                        <asp:TextBox ID="txt_PJOB_DESC" runat="server" Width="70px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox> 
                                    </td>
                                     <th></th>
                                </tr>
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label">
                                           <asp:TextBox ID="txt_AGE" runat="server" Width="30px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox>
                                    </td>
                                     <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="lb_WORK_YEARS" runat="server" Text="入社年資"></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label">  
                                        <asp:TextBox ID="txt_WORK_YEARS" runat="server" Width="70px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox> 
                                    </td>
                                     <%-- 資格年資 --%>             
                                    <th align="left" class="Body_TableHeader">
                                    ...
                                    <td align="left" class="Body_label">  
                                        <asp:TextBox ID="txt_RECENT_LEVEL_WORK_YEARS" runat="server" Width="70px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox> 
                                    </td>
                                     <th></th>
                                </tr>
                                 <tr>
                                    ...
                                    <td align="left" class="Body_label" colspan="5">
                                           <asp:TextBox ID="txt_DISTING_REMARK" runat="server" Width="250px"  ClientIDMode="Static" BorderWidth="0" ></asp:TextBox>
                                    </td>
                                     <th></th>
                                </tr>
                                <tr>
