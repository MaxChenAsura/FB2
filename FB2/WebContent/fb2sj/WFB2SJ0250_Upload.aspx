<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0250_Upload.aspx.cs" Inherits="WebContent_fb2sj_WFB2SJ0250_Upload" %>
        ...
        <tbody>
            ...
            <tr>
             ...
             <tr>
                    ...
                    <td align="left" class="Body_label">
                        <asp:DropDownList ID="ddl_ASSESS_TYPE" runat="server" Width="100px" CssClass="MandatoryField" ClientIDMode="Static"> </asp:DropDownList>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="考核類別必選"
                        ControlToValidate="ddl_ASSESS_TYPE" ForeColor="Red" ValidationGroup="GroupA" Display="None">
                    </asp:RequiredFieldValidator>
                    </td>
              </tr>
            <tr>
                ...
                <td align="right" class="Body_label">
                    <!--    -->
                    <aces:Btn ID="WFB2SJ0250Result" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_assess_result_down%>" OnClick="WFB2SJ0250Result_Click" OnClientClick="return checkDowning(this.value);" />
                 
                    <aces:Btn ID="WFB2SJ0250Upload" runat="server" Text="<%$Resources:Resource,wfb2da_lb_Upload%>" OnClick="WFB2SJ0250Upload_Click" OnClientClick="return MyCheckValid(this.value);" />
                ...
                <td align="left" class="Body_label" colspan="5">
                    ...
                    <fieldset style="padding: 5px">
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                    <asp:Button ID="WFB2SJ0250DownLoadExcel" runat="server" Text="<%$Resources:Resource,lb_DownLoad%>" OnClick="btn_Excel_Down_Click" />
                                </td>
                            </tr>
                        </table>
