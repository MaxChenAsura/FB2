<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sj/WFB2SJ0300_Qry.aspx.cs" Inherits="WebContent_WFB2SJ0300_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="6">
                            <aces:Btn ID="WFB2SJ0300Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ0300Search_Click"   OnClientClick="return CheckSearch();"/>
                            <%--<asp:Button ID="WFB2SJ0300Search" runat="server" Text="<%$Resources:Resource,wfb2sj_btn_search%>" OnClick="WFB2SJ0300Search_Click"   OnClientClick="return CheckSearch();"/>--%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData" 
                SelectCountMethod="getCount" TypeName="CFB2SJ0300DAO" EnablePaging="True"
