<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2ss/WFB2SS0500_Dtl.aspx.cs" Inherits="WebContent_WFB2SS0500_Dtl" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                     <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_INCENTIVE_DESC" runat="server"  CssClass="txtDisabled" Enabled="false" BorderWidth="0"></asp:TextBox>                                
                            <asp:HiddenField ID="hid_INCENTIVE_TYPE" runat="server" ClientIDMode="Static" />
                        </td>
                    </tr>
                     <tr>
                         <%-- 轉薪資 --%>    
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDtlData"
                SelectCountMethod="getDtlCount" TypeName="CFB2SS0500DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="hid_INCENTIVE_TYPE"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--發放金額--%>
                    <asp:TemplateField HeaderText="發放金額" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right" SortExpression="INCENTIVE_AMT">
                        <ItemTemplate>
                            <asp:Label ID="lb_INCENTIVE_AMT" runat="server" Text='<%#Bind("INCENTIVE_AMT","{0:##,#}")%>' Width="80px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>     
                    <%--計算起日--%>
                    <asp:TemplateField HeaderText="計算起日" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="START_DT">
                        <ItemTemplate>
                            <asp:Label ID="lb_START_DT" runat="server" Text='<%#Bind("START_DT","{0:yyyy/MM/dd}")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--計算迄日--%>
                    <asp:TemplateField HeaderText="計算迄日" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="END_DT">
                        <ItemTemplate>
                            <asp:Label ID="lb_END_DT" runat="server" Text='<%#Bind("END_DT","{0:yyyy/MM/dd}")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--入社日--%>
                    <asp:TemplateField HeaderText="入社日" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="JOIN_DT">
                        <ItemTemplate>
                            <asp:Label ID="lb_JOIN_DT" runat="server" Text='<%#Bind("JOIN_DT","{0:yyyy/MM/dd}")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--轉正日--%>
                    <asp:TemplateField HeaderText="轉正日" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="BE_EMP_DT">
                        <ItemTemplate>
                            <asp:Label ID="lb_BE_EMP_DT" runat="server" Text='<%#Bind("BE_EMP_DT","{0:yyyy/MM/dd}")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--離社日--%>
                    <asp:TemplateField HeaderText="離社日" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="LEAVE_DT">
                        <ItemTemplate>
                            <asp:Label ID="lb_LEAVE_DT" runat="server" Text='<%#Bind("LEAVE_DT","{0:yyyy/MM/dd}")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
