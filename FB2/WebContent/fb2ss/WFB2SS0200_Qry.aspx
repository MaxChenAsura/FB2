<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2ss/WFB2SS0200_Qry.aspx.cs" Inherits="WebContent_WFB2SS0200_Qry" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="right" colspan="6">
                            ...
                            <%--
                            <asp:Button ID="WFB2SS0200Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2SS0200Search_Click" OnClientClick="return CheckSearch();" />
                            --%>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="6">
                            <div id="init_grid">                                
                                <aces:Btn ID="WFB2SS0200Deatil" runat="server" Text="查詢明細" Visible="false" OnClick="WFB2SS0200DTL_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SS0200APP" runat="server" Text="轉薪資" Visible="false" OnClick="WFB2SS0200APP_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SS0200CELAPP" runat="server" Text="取消轉薪資" Visible="false" OnClick="WFB2SS0200CELAPP_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SS0200Delete" runat="server" Text="刪除" OnClientClick="return doButtonConfirm(this.value);" OnClick="WFB2SS0200Delete_Click" Visible="False" />
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getQryData"
                SelectCountMethod="getQryCount" TypeName="CFB2SS0200DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--資遺類型--%>
                    <asp:TemplateField HeaderText="資遺類型" HeaderStyle-Width="160px" ItemStyle-HorizontalAlign="Left" SortExpression="FIRED_TYPE">
                        <ItemTemplate>
                            <asp:Label ID="lb_TYPE_DESC" runat="server" Text='<%#Bind("TYPE_DESC")%>' Width="160px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--人數--%>
                    <asp:TemplateField HeaderText="人數" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Right" SortExpression="FIRED_NUM">
                        <ItemTemplate>
                            <asp:Label ID="lb_FIRED_NUM" runat="server" Text='<%#Bind("FIRED_NUM")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>    
                     <%--金額總計--%>
                    <asp:TemplateField HeaderText="金額總計" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Right" SortExpression="FIRED_TOTAL">
                        <ItemTemplate>
                            <asp:Label ID="lb_FIRED_TOTAL" runat="server" Text='<%#Bind("FIRED_TOTAL","{0:##,#}")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <%--轉薪日期--%>
