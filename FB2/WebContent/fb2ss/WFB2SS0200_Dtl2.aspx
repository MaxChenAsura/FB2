<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2ss/WFB2SS0200_Dtl2.aspx.cs" Inherits="WebContent_WFB2SS0200_Dtl2" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                    <tr>                        
                        ...
                        <th align="left" class="Body_TableHeader">
                            <%--資遣日--%>
                            <asp:Label ID="Label15" runat="server" Text="<%$Resources:Resource,WFb2ss_FIRED_DT%>"></asp:Label>:
                        </th>
                        <td>
                            <asp:Label ID="txt_FIRED_DT" runat="server" CssClass="txtDisabled" Enabled="false" BorderWidth="0"></asp:Label>
                        </td>
                        <th align="left" class="Body_TableHeader">
                            <%--工資總額--%>
                    ...
                    <tr>                        
                        ...
                        <th align="left" class="Body_TableHeader">
                            <%--新制基數--%>
                            <asp:Label ID="Label1" runat="server" Text="<%$Resources:Resource,wfb2ss_lb_base_month%>"></asp:Label>:
                        </th>
                        <td>
                            <asp:Label ID="txt_BASE_MONTH" runat="server" CssClass="txtDisabled" Enabled="false" BorderWidth="0"></asp:Label>
                        </td>                    
                        <td></td>
                    </tr>                    
                    <tr>
                        <th align="left" class="Body_TableHeader">
                            <%--資遣費--%>
                            <asp:Label ID="Label9" runat="server" Text="<%$Resources:Resource,wfb2ss_lb_fired_pay%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_FIRED_PAY" runat="server" CssClass="txtDisabled" Enabled="false" BorderWidth="0"></asp:Label>
                        </td>
                        <th align="left" class="Body_TableHeader">
                            <%-- 預告工資--%>
                            <asp:Label ID="Label10" runat="server" Text=" <%$Resources:Resource,wfb2ss_lb_forecast_wages%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:Label ID="txt_FORECAST_WAGES" runat="server" CssClass="txtDisabled" Enabled="false" BorderWidth="0"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" colspan="7">
                             <%--
                            <aces:Btn ID="WFB2SS0200Save" runat="server" Text="儲存" OnClick="WFB2SS0200Save_Click" />
                                  --%>
                            <asp:Button ID="WFB2SS0200Back" runat="server" Text="返回" OnClick="WFB2SS0200Back_Click" />
                            <%--
                            <asp:Button ID="WFB2SS0200Save" runat="server" Text="儲存" OnClick="WFB2S0200Save_Click" />
                            --%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDtlData"
                SelectCountMethod="getDtlCount" TypeName="CFB2SS0200DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--年月--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2ss_lb_ym%>" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" SortExpression="YM">
                        <ItemTemplate>
                            <asp:Label ID="lb_YM" runat="server" Text='<%#Bind("YM")%>' Width="70px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--日曆天數--%>
