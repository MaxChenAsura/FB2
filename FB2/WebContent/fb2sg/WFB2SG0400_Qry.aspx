<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sg/WFB2SG0400_Qry.aspx.cs" Inherits="WebContent_WFB2SG0400_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="5">
                           <%-- <asp:Button ID="WFB2SG0400Search" runat="server" Text="<%$Resources:Resource,wfb2sg_btn_search%>" OnClick="WFB2SG0400Search_Click" OnClientClick="CheckSearch();" />--%>
                             <aces:Btn ID="WFB2SG0400Search" runat="server" Text="<%$Resources:Resource,wfb2sg_btn_search%>" OnClick="WFB2SG0400Search_Click" OnClientClick="CheckSearch();" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SG0400DAO" EnablePaging="True"
                SortParameterName="sortExpression" OnSelecting="obs1_Selecting"
                OnSelected="ods1_Selected">
                <SelectParameters>
                    <asp:Parameter Name="startRowIndex" Type="Int32" />
                    <asp:Parameter Name="maximumRows" Type="Int32" />
                    <asp:ControlParameter ControlID="ddl_FESTIVAL_TYPE"
                        Name="festival_type" PropertyName="SelectedValue" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="txt_FESTIVAL_DT_S"
                        Name="festival_dt_s" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="txt_FESTIVAL_DT_E"
                        Name="festival_dt_e" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False" />
                </SelectParameters>
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--節金類別--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sg_lb_festival_type%>" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Left" SortExpression="FESTIVAL_TYPE">
                        <ItemTemplate>
                            <asp:Label ID="lb_FESTIVAL_TYPE" runat="server" Text='<%#Bind("FESTIVAL_TYPE_DESC")%>' Width="80px"></asp:Label>
                            <asp:HiddenField ID="hid_FESTIVAL_TYPE" runat="server" Value='<%#Bind("FESTIVAL_TYPE")%> ' ClientIDMode="Static" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%-- 核可狀態--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sg_lb_approve_status%>" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left" SortExpression="APPROVE_STATUS">
                        <ItemTemplate>
                            <asp:Label ID="lb_APPROVE_STATUS" runat="server" Text='<%#Bind("APPROVE_STATUS_DESC")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <%-- 提出核可人員--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sg_lb_release_by%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="RELEASE_BY">
                        <ItemTemplate>
                    ...
                    <%-- 核可人員--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sg_lb_approve_by%>" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" SortExpression="APPROVE_BY">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sg_lb_approve_dt%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="center" SortExpression="APPROVE_DT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hid_APPROVE_DT" runat="server" Value='<%#Bind("APPROVE_DT","{0:yyyy/MM/dd}")%> ' ClientIDMode="Static" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--薪資轉出日--%>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sg_lb_function%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="center">
                        <ItemTemplate>
                            <aces:Btn ID="WFB2SG0400Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="查詢明細" />
                            <%--<asp:Button ID="WFB2SG0400Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="查詢明細" />--%>
                        </ItemTemplate>
