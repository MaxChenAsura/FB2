<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sa/action/WFB2SA1510_Qry.aspx.cs" Inherits="WebContent_fb2sa_WFB2SA1510_Qry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020px" border="0" class="Body_Label">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sa_Required_DATA_YEAR%>"
                                ControlToValidate="txt_DATA_YEAR" ForeColor="Red" ValidationGroup="GroupA" Display="None"></asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sa_Required_DATA_YEAR%>"
                                ControlToValidate="txt_DATA_YEAR" ForeColor="Red" ValidationGroup="GroupB" Display="None"></asp:RequiredFieldValidator>
                            
                        </td>

                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_SEND_DT" runat="server" Text="<%$Resources:Resource,wfb2sa_lb_SEND_DT%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                ErrorMessage="<%$Resources:Resource,wfb2sa_ERR_SEND_DT%>" ControlToValidate="txt_SEND_DT" ForeColor="Red"
                                ValidationExpression="(19|20)\d\d[/ /.](0[1-9]|1[012])[/ /.](0[1-9]|[12][0-9]|3[01])" Display="None" ValidationGroup="GroupA">
                            </asp:RegularExpressionValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sa_Required_SEND_DT%>"
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                         ...
                         <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_CC_EMAIL" runat="server" Text="<%$Resources:Resource,wfb2sa_lb_CC_EMAIL%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                    ...
                    <tr>
                        <!-- START: Create MODULE ID -->
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_MAIL_TITLE" runat="server" Text="<%$Resources:Resource,wfb2sa_lb_MAIL_TITLE%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sa_Required_MAIL_TITLE%>"
                                ControlToValidate="txt_MAIL_TITLE" ForeColor="Red" ValidationGroup="GroupA" Display="None"></asp:RequiredFieldValidator>
                        </td>

                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_MAIL_DESC" runat="server" Text="<%$Resources:Resource,wfb2sa_lb_MAIL_DESC%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sa_Required_MAIL_DESC%>"
                    ...
                    <tr>
                        <!-- START: Create MODULE ID -->
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_CONTACT_TO" runat="server" Text="<%$Resources:Resource,wfb2sa_lb_CONTACT_TO%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sa_Required_CONTACT_TO%>"
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="10">
                            <div id="init">
                                <%--                                     
                                    <aces:Btn ID="WFB2SA1510Execute" runat="server" Text="<%$Resources:Resource,wfb2sa_WFB2SA1510Execute%>" OnClientClick="return saveCheck();" OnClick="WFB2SA1510Execute_Click" ValidationGroup="GroupA"/>
                                    <aces:Btn ID="WFB2SA1510Search" runat="server" Text="<%$Resources:Resource,wfb2sa_WFB2SA1510Search%>" OnClick="WFB2SA1510Search_Click" ValidationGroup="GroupB"/>
                                    <asp:Button ID="WFB2SA1510Execute" runat="server" Text="<%$Resources:Resource,wfb2sa_WFB2SA1510Execute%>" OnClientClick="return saveCheck();" OnClick="WFB2SA1510Execute_Click" ValidationGroup="GroupA" />
                                    <asp:Button ID="WFB2SA1510Search" runat="server" Text="<%$Resources:Resource,wfb2sa_WFB2SA1510Search%>" OnClick="WFB2SA1510Search_Click" ValidationGroup="GroupB" />
                    ...
                    <tr>
                        <td align="right" colspan="10">
                            <%-- 
                                  <aces:Btn ID="WFB2SA1510Print" runat="server" Text="<%$Resources:Resource,wfb2sa_WFB2SA1510Print%>" Visible="false" OnClick="WFB2SA1510Print_Click"/>
                                  <asp:Button ID="WFB2SA1510Print" runat="server" Text="<%$Resources:Resource,wfb2sa_WFB2SA1510Print%>" Visible="false" OnClick="WFB2SA1510Print_Click"/>
                            --%>
                            <aces:Btn ID="WFB2SA1510Print" runat="server" Text="<%$Resources:Resource,wfb2sa_WFB2SA1510Print%>" Visible="false" OnClick="WFB2SA1510Print_Click"/>
                        </td>
                    </tr>
             ...
             <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SA1510DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="EMP_ID" HeaderText="<%$Resources:Resource,wfb2sa_lb_EMP_ID%>" SortExpression="EMP_ID"
                         HeaderStyle-Width="320px" ItemStyle-HorizontalAlign="Left"/>
                    <asp:BoundField DataField="EMP_NAME" HeaderText="<%$Resources:Resource,wfb2sa_lb_EMP_NAME%>" SortExpression="EMP_NAME" HeaderStyle-Width="320px" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField DataField="SEND_DT" HeaderText="<%$Resources:Resource,wfb2sn_lb_SEND_DT%>" SortExpression="SEND_DT" HeaderStyle-Width="320px" ItemStyle-HorizontalAlign="Left"/>          
                </Columns>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SA1510Print" />          
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
