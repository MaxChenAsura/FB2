<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sa/action/WFB2SA1600_Add.aspx.cs" Inherits="WebContent_WFB2SA1600_Add" Culture="auto" UICulture="auto" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="left" class="Body_label" >
                                        <asp:TextBox ID="txt_PJOB_CD" runat="server" MaxLength="4" Width="60px" ClientIDMode="Static" CssClass="MandatoryField"></asp:TextBox>
                                         <asp:TextBox ID="txt_PJOB_DESC" runat="server" MaxLength="30" Enabled="false" BorderWidth="0"  ClientIDMode="Static" Width="100px" ></asp:TextBox>
                                           <!--必輸入-->
                                        <asp:RequiredFieldValidator ID="Req_PJOB_CD" runat="server" 
                                            ErrorMessage="職務代號必輸入"
                                    ...
                                    <td align="left" class="Body_label">
                                        ...
                                        <asp:RequiredFieldValidator ID="Req_SALARY_ID" runat="server" 
                                            ErrorMessage="薪資項目必輸入"
                                            ControlToValidate="ddl_SALARY_ID" ForeColor="Red" ValidationGroup="GroupA" Display="None"></asp:RequiredFieldValidator>
                                    </td>
                                     <%-- 類別 --%>             
                                    <th align="left" class="Body_TableHeader">
                                    ...
                                    <td align="left" class="Body_label">  
                                        <asp:DropDownList ID="ddl_HIRE_TYPE" runat="server" ClientIDMode="Static" CssClass=""></asp:DropDownList>   
                                    </td>
                                </tr>
                                 <tr>
                                     <th align="left" class="Body_TableHeader">
                                    ...
                                    <td align="left"   class="Body_label">
                                        <asp:TextBox ID="txt_START_DT" runat="server" ClientIDMode="Static" Width="80px"  CssClass="MandatoryField date"></asp:TextBox>
                                          <!--必輸入-->
                                        <asp:RequiredFieldValidator ID="req_START_DT" runat="server" 
                                            ErrorMessage="生效起日必輸入"
                                        ...
                                        ErrorMessage="生效起日格式錯誤" ClientValidationFunction="CheckDate" ForeColor="Red"
                               ...
                               <tr>
                                    ...
                                    <td align="right" class="Body_label" colspan="3">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SA1600Save_A" runat="server" Text="儲存"  OnClientClick="return saveCheck();" OnClick="WFB2SA1600Save_Click"  />
