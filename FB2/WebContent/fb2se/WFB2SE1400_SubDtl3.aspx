<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2se/WFB2SE1400_SubDtl3.aspx.cs" Inherits="WebContent_fb2se_WFB2SE1400_SubDtl3" Culture="auto" UICulture="auto"%>
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
            ...
            <Columns>
                ...
                <asp:CheckBoxField DataField="IS_APPROVE_MARK" HeaderText="<%$Resources:Resource,wfb2se_APPROVE_MARK%>" SortExpression="" HeaderStyle-Width="30px"/>
                <asp:BoundField DataField="RowNumber" HeaderText="<%$Resources:Resource,wfb2_RowNumber%>" HeaderStyle-Width="10px"/>
                <asp:BoundField DataField="LEVEL_CD" HeaderText="<%$Resources:Resource,wfb2se_LEVEL_CD%>" SortExpression="LEVEL_CD" HeaderStyle-Width="10px"/>
