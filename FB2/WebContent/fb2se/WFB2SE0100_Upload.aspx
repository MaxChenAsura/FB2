<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2se/WFB2SE0100_Upload.aspx.cs" Inherits="WebContent_fb2se_WFB2SE0100_Upload" %>
           ...
           <tr>
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                    <aces:Btn ID="WFB2SE0100LoadAdd" runat="server" Text="<%$Resources:Resource,wfb2se_WFB2SE0100LoadAdd%>" OnClick="WFB2SE0100LoadAdd_Click" OnClientClick="return checkDowning(this.value);" />
                    <aces:Btn ID="WFB2SE0100Upload" runat="server" Text="<%$Resources:Resource,wfb2da_lb_Upload%>" OnClick="WFB2SE0100Upload_Click" OnClientClick="return MyCheckValid(this.value);" />
                    <asp:Button ID="WFB2SE0100Previous" runat="server" Text="<%$Resources:Resource,btn_back%>" OnClick="btn_back_Click" />
                ...
                <td align="left" class="Body_label" colspan="5">
                    ...
                    <fieldset style="padding: 5px">
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                    <asp:Button ID="WFB2SE0100DownLoadExcel" runat="server" Text="<%$Resources:Resource,lb_DownLoad%>" OnClick="btn_Excel_Down_Click" />
                                </td>
                            </tr>
                        </table>
