<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2se/WFB2SE2200_Qry.aspx.cs" Inherits="WebContent_fb2se_WFB2SE2200_Qry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function iniForm() {
            ...
            $("#txt_EFFECT_YM").datepicker({ dateFormat: 'yy/mm' });
            $(".date").mask('9999/99');
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="left" class="Body_label">
                                        <asp:TextBox ID="txt_EFFECT_YM" runat="server" MaxLength="6" Columns="10" ClientIDMode="Static" CssClass="MandatoryField date" OnTextChanged="txt_EFFECT_YM_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2se_lb_EFFECT_YM_Required%>"
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                            ErrorMessage="生效年月,日期格式錯誤" ControlToValidate="txt_EFFECT_YM" ForeColor="Red"
                                ...
                                <tr>
                                    ...
                                    <th align="left" class="Body_TableHeader">
                                        <asp:Label ID="lbl_warn" runat="server" Text="<%$Resources:Resource,wfb2se_lbl_warn%>"></asp:Label>:
                                    </th>
                                    <td align="left" class="Body_label">
                                        <asp:Label ID="txt_warn" runat="server" MaxLength="150" ClientIDMode="Static" Text="<%$Resources:Resource,wfb2se_txt_warn%>"></asp:Label>
                                    </td>
                                    <th></th>
                                    <th></th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="Body_label" colspan="10">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SE2200Execute" runat="server" Text="<%$Resources:Resource,btn_Execute%>" ValidationGroup="GroupA" OnClick="WFB2SE2200Execute_Click" />

                                            <%--<asp:Button ID="WFB2SE2200Execute" runat="server" Text="<%$Resources:Resource,btn_Execute%>" ValidationGroup="GroupA" OnClick="WFB2SE2200Execute_Click" />--%>
