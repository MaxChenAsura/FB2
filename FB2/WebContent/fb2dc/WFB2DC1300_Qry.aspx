<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2dc/action/WFB2DC1300_Qry.aspx.cs" Inherits="WebContent_fb2dc_WFB2DC1300_Qry" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="left" class="Body_label">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="<%$Resources:Resource,wfb2dc_Required_CALENDAR_DT%>"
            ...
            <tr>
                <td align="right" class="Body_label" colspan="7">
                    <div id="init">
                        <aces:Btn ID="WFB2DC1300Export" runat="server" Text="<%$Resources:Resource,wfb2dc_WFB2DC1300Export%>" OnClick="WFB2DC1300Export_Click" OnClientClick="CheckValid();" ValidationGroup="GroupA" />

                        <%--<asp:Button ID="WFB2DC1300Export" runat="server" Text="<%$Resources:Resource,wfb2dc_WFB2DC1300Export%>" OnClick="WFB2DC1300Export_Click" OnClientClick="CheckValid();" ValidationGroup="GroupA" />--%>
