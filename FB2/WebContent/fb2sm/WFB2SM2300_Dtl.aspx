<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sm/WFB2SM2300_Dtl.aspx.cs" Inherits="WebContent_fb2sm_WFB2SM2300_Dtl" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDtlData"
                SelectCountMethod="getDtlCount" TypeName="CFB2SM2300DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="true" AllowSorting="true"
                ...
                OnRowDataBound="gv_result_RowDataBound" Width="1320px">
                <Columns>
                    <%--序號--%>
                    ...
                    <%--前一能力考核--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_1%>" SortExpression="ASSESS_SCORE_1" HeaderStyle-Width="100px">
                        <ItemTemplate>
                            <asp:Label ID="lbl_ASSESS_SCORE_1" runat="server" Text='<%#Bind("ASSESS_SCORE_1")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_2%>" SortExpression="ASSESS_SCORE_2" HeaderStyle-Width="100px">
                        <ItemTemplate>
