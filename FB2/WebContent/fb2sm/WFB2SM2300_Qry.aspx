<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sm/WFB2SM2300_Qry.aspx.cs" Inherits="WebContent_fb2sm_WFB2SM2300_Qry" %>
        ...
        <ContentTemplate>
            <table width="1020" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="Body_label">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SM2300Search" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Search%>" OnClick="WFB2SM2300Search_Click" OnClientClick="CheckValid();" ValidationGroup="GroupA" />
                                            <%--<asp:Button ID="WFB2SM2300Search" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Search%>" OnClick="WFB2SM2300Search_Click" OnClientClick="CheckValid();" ValidationGroup="GroupA" />--%>
                ...
                <tr>
                    ...
                    <td align="right" class="Body_label">
                        <div id="init_grid">
                            <aces:Btn ID="WFB2SM2300Release" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM130Release%>" OnClientClick="return CheckReleaseAction();" OnClick="WFB2SM2300Release_Click" Visible="false" />
                            <aces:Btn ID="WFB2SM2300Detail" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Detail%>" OnClientClick="return CheckDtlAction();" OnClick="WFB2SM2300Detail_Click" Visible="false" />
                            <%--<asp:Button ID="WFB2SM2300Release" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM130Release%>" OnClientClick="return CheckReleaseAction();" OnClick="WFB2SM2300Release_Click" Visible="false" />
                            <asp:Button ID="WFB2SM2300Detail" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Detail%>" OnClientClick="return CheckDtlAction();" OnClick="WFB2SM2300Detail_Click" Visible="false" />--%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SM2300DAO" EnablePaging="True"
