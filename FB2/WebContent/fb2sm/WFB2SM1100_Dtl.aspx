<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sm/WFB2SM1100_Dtl.aspx.cs" Inherits="WebContent_fb2sm_WFB2SM110_Dtl" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function getEmp(obj1, obj2) {
            var json = OpenEmpSearch(obj1, obj2, 'N');
            $("#HID_DEPT").val(json.DEPT_NO + '-' + json.DEPT_NAME);
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020px" border="0" class="Body_Label">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="lb_DATA_YEAR2" runat="server" MaxLength="4" Width="81px" ClientIDMode="Static"></asp:Label>
                        </td>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_DATA_SEQ" runat="server" Text="<%$Resources:Resource,wfb2sm_lb_DATA_SEQ%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:Label ID="lb_DATA_SEQ2" runat="server" MaxLength="1" Width="81px" ClientIDMode="Static"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_NOTICE_DT" runat="server" Text="<%$Resources:Resource,wfb2sm_lb_NOTICE_DT2%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:Label ID="lb_NOTICE_DT2" runat="server" Width="81px" ClientIDMode="Static"></asp:Label>
                        </td>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_EXECUTIVE_DT" runat="server" Text="<%$Resources:Resource,wfb2sm_lb_EXECUTIVE_DT%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:Label ID="lb_EXECUTIVE_DT2" runat="server" Width="81px" ClientIDMode="Static"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <th align="left" class="Body_TableHeader">
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:Label ID="lb_EXECUTIVE_DATE2" runat="server" Width="81px" ClientIDMode="Static"></asp:Label>
                        </td>
                        <th></th>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <td align="left" height="1" colspan="4">
                            <fieldset style="padding: 5px">
                                <legend class="Body_label">
                                    <asp:Label ID="lb_TemplateDownload" runat="server" Text="<%$Resources:Resource,wfb2sm_lb_TemplateDownload%>"></asp:Label>
                                </legend>
                                <table  width="100%">
                                    <tr>
                                        <th align="left" class="Body_TableHeader">
                                            <asp:Label ID="lb_UploadExcel" runat="server" Text="<%$Resources:Resource,wfb2sm_lb_UploadExcel%>"></asp:Label>:
                                        </th>
                                        <td align="left" class="Body_label">
                                            <asp:Label ID="lb_Tips" runat="server" Width="81px" ClientIDMode="Static" Text="整批上傳(Excel):"></asp:Label>
                                            <asp:FileUpload ID="FileUpload1" runat="server" class="MandatoryField" Width="400px" />
                                        ...
                                        <td align="right" >
                                            <aces:Btn ID="WFB2SM1100Upload" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Upload%>" OnClick="WFB2SM1100Upload_Click" OnClientClick="return MyCheckValid(this.value);" />
                                            <aces:Btn ID="WFB2SM1100_Upload" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110_Upload%>" OnClick="WFB2SM1100_Upload_Click" />
                                            <%-- <asp:Button ID="WFB2SM1100Upload" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Upload%>" OnClientClick="BlockUI();" OnClick="WFB2SM1100Upload_Click" ValidationGroup="GroupB" />
                                            <asp:Button ID="WFB2SM1100_Upload" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110_Upload%>" OnClick="WFB2SM1100_Upload_Click" />--%>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                ...
                <td align="left" height="1" colspan="4">
                    <fieldset style="padding: "5">
                        ...
                        <table>
                            <tr>
                                <th align="left" class="Body_TableHeader" width="120px">晉昇對象:</th>
                                <td align="left" class="Body_label" width="400px">整批上傳(Excel):
											<input align="right" type="file" name="fileUpload" class="MandatoryField">
                                </td>
                                <td align="left" class="Body_label" width="">
                                    <a href="#" tabindex="51" onclick="javascript:downloadExcel('result');" name="WFB2xnnn8Upload" id="WFB2xnnn8Upload">
                                        <img src="images/tw/upload.gif" style="border: 0" alt="null"></a>
                                </td>
                                <td align="left" colspan="8">
                                    <input type="button" value="範例下載" onclick="downloadExcel('upload');">
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                    ...
                    <tr>
                        ...
                        <td align="left" class="Body_label" colspan="3">
                            ...
                            <input id="Button14" type="button" value="..." onclick="OpenDeptSearch('txt_DEPT_NO', 'txt_DEPT_NAME', 'N', 'Y');" />
                ...
                <tbody>
                    <tr>
                        <td colspan="4" align="right" class="Body_label">
                            <div id="init">
                                <%--<asp:Button ID="WFB2SM1101Search" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Search%>" OnClick="WFB2SM1101Search_Click" />--%>
                                <aces:Btn ID="WFB2SM1101Search" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Search%>" OnClick="WFB2SM1101Search_Click" />
                    ...
                    <tr>
                        <td colspan="4" align="right" class="Body_label">
                            <div id="init_grid">
                                <%--<asp:Button ID="WFB2SM1101Add" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Add%>" Visible="false" OnClick="WFB2SM1101Add_Click" />
                                <asp:Button ID="WFB2SM1101Delete" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Delete%>" OnClientClick="return CheckDelAction();" Visible="false" OnClick="WFB2SM1101Delete_Click" />
                                <asp:Button ID="WFB2SM1101Edit" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Edit%>" Visible="false" OnClick="WFB2SM1101Edit_Click" />
                                <asp:Button ID="WFB2SM1101OK" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110OK%>" Visible="false" ValidationGroup="GroupA" OnClick="WFB2SM1101OK_Click" />--%>
                                <aces:Btn ID="WFB2SM1101Add" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Add%>" Visible="false" OnClick="WFB2SM1101Add_Click" />
                                <aces:Btn ID="WFB2SM1101Delete" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Delete%>" OnClientClick="return CheckDelAction();" Visible="false" OnClick="WFB2SM1101Delete_Click" />
                                <aces:Btn ID="WFB2SM1101Edit" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Edit%>" Visible="false" OnClick="WFB2SM1101Edit_Click" />
                                <aces:Btn ID="WFB2SM1101OK" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110OK%>" Visible="false" ValidationGroup="GroupA" OnClick="WFB2SM1101OK_Click" />
                                <asp:Button ID="WFB2SM1101Cancel" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM110Cancel%>" Visible="false" OnClientClick="return confirm('是否確定取消?');" OnClick="WFB2SM1101Cancel_Click" />
                            </div>
                        </td>
                    </tr>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDtlData"
                SelectCountMethod="getDtlCount" TypeName="CFB2SM1100DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="lb_DATA_YEAR2" DefaultValue="" ConvertEmptyStringToNull="false"
                        Name="DATA_YEAR" PropertyName="Text" Type="String" />
                    <asp:ControlParameter ControlID="lb_DATA_SEQ2" DefaultValue="" ConvertEmptyStringToNull="false"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--NO--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_NO%>" SortExpression="NO" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lb_NO" runat="server" Text='<%#Bind("NO")%>' Width="30px"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_EDIT_NO" runat="server" Text='<%#Bind("NO")%>' Width="30px"></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lb_NEW_NO" runat="server" Text='<%#Bind("NO")%>' Width="30px"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <%--異動狀態--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_CHG_STATUS%>" SortExpression="CHG_STATUS" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <%--工號 EMP_ID 5--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_EMP_ID%>" SortExpression="EMP_ID" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                    ...
                    <%--職種 WS_CD 1--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_WS_CD%>" SortExpression="WS_CD" HeaderStyle-Width="60px" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <%--年資 WORK_YEARS 5--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_WORK_YEARS%>" SortExpression="WORK_YEARS" HeaderStyle-Width="60px" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                    ...
                    <%--原資格 LEVEL_CD 3--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_LEVEL_CD%>" SortExpression="LEVEL_CD" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <%--原級數 GRADE_CD 1--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_GRADE_CD%>" SortExpression="GRADE_CD" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_PJOB_CD%>" SortExpression="PJOB_CD" HeaderStyle-Width="150px" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="lb_PJOB_CD" runat="server" Text='<%#Bind("PJOB_CD_DESC")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_NEW_PJOB_CD" runat="server" Width="100%" Style="text-align: left;" Text='<%#Bind("PJOB_CD_DESC")%>'></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_LEVEL_WORK_YEARS%>" SortExpression="LEVEL_WORK_YEARS" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_LEVEL_CD_NEW%>" SortExpression="LEVEL_CD_NEW" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lb_LEVEL_CD_NEW" runat="server" Text='<%#Bind("LEVEL_CD_NEW")%>' Width="60px"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:DropDownList ID="ddl_NEW_LEVEL_CD_NEW" runat="server" CssClass="MandatoryField" Width="60px"></asp:DropDownList>
                            <asp:HiddenField ID="hid_EDIT_LEVEL_CD_NEW" runat="server" Value='<%#Bind("LEVEL_CD_NEW")%>' />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sm_Required_LEVEL_CD_NEW%>"
                                ControlToValidate="ddl_NEW_LEVEL_CD_NEW" ForeColor="Red" ValidationGroup="GroupA" Display="None" InitialValue="-1"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:DropDownList ID="ddl_NEW_LEVEL_CD_NEW" runat="server" CssClass="MandatoryField" Width="60px"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sm_Required_LEVEL_CD_NEW%>"
                    ...
                    <%--晉昇級數 GRADE_CD_NEW--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_GRADE_CD_NEW%>" SortExpression="GRADE_CD_NEW" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lb_GRADE_CD_NEW" runat="server" Text='<%#Bind("GRADE_CD_NEW")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:DropDownList ID="ddl_NEW_GRADE_CD_NEW" runat="server">
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_PJOB_CD_NEW%>" SortExpression="PJOB_CD_NEW" HeaderStyle-Width="150px" ItemStyle-Width="150px">
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sm_Required_PJOB_CD_NEW%>"
                                        ControlToValidate="ddl_NEW_PJOB_CD_NEW" ForeColor="Red" ValidationGroup="GroupA" Display="None" InitialValue="-1"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:DropDownList ID="ddl_NEW_PJOB_CD_NEW" runat="server" CssClass="MandatoryField"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sm_Required_PJOB_CD_NEW%>"
                    ...
                    <%--在職區分 EMP_CHG_CD--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_EMP_CHG_CD%>" SortExpression="EMP_CHG_CD" HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_1%>" SortExpression="ASSESS_SCORE_1" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_2%>" SortExpression="ASSESS_SCORE_2" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                        <ItemTemplate>
                    ...
                    <%--前能力考核 ASSESS_SCORE_3--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_3%>" SortExpression="ASSESS_SCORE_3" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                        <ItemTemplate>
                            <asp:Label ID="lb_ASSESS_SCORE_3" runat="server" Text='<%#Bind("ASSESS_SCORE_3")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_NEW_ASSESS_SCORE_3" runat="server" Width="100%" Style="text-align: center;" Text='<%#Bind("ASSESS_SCORE_3")%>'></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lb_NEW_ASSESS_SCORE_3" runat="server" Width="100%" Style="text-align: center;"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <%--前能力考核 ASSESS_SCORE_4--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_4%>" SortExpression="ASSESS_SCORE_4" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                        <ItemTemplate>
                            <asp:Label ID="lb_ASSESS_SCORE_4" runat="server" Text='<%#Bind("ASSESS_SCORE_4")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_NEW_ASSESS_SCORE_4" runat="server" Width="100%" Style="text-align: center;" Text='<%#Bind("ASSESS_SCORE_4")%>'></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lb_NEW_ASSESS_SCORE_4" runat="server" Width="100%" Style="text-align: center;"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <%--前能力考核 ASSESS_SCORE_5--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_5%>" SortExpression="ASSESS_SCORE_5" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                        <ItemTemplate>
                            <asp:Label ID="lb_ASSESS_SCORE_5" runat="server" Text='<%#Bind("ASSESS_SCORE_5")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_NEW_ASSESS_SCORE_5" runat="server" Width="100%" Style="text-align: center;" Text='<%#Bind("ASSESS_SCORE_5")%>'></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lb_NEW_ASSESS_SCORE_5" runat="server" Width="100%" Style="text-align: center;"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_lb_EXECUTIVE_STATUS%>" SortExpression="EXECUTIVE_STATUS" HeaderStyle-Width="80px" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lb_EXECUTIVE_STATUS" runat="server" Text='<%#Bind("LEVEL_CD")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_EDIT_EXECUTIVE_STATUS" runat="server" Text='<%#Bind("LEVEL_CD")%>'></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lb_NEW_EXECUTIVE_STATUS" runat="server"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
                    <div style="width: 1020px; overflow: auto;">
                        <table class="grid-view" width="1640px" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
                            <tr class="header">
                                ...
                                <td width="120px">
                                    <asp:Label ID="Label16" runat="server" Width="100%" Text="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_1%>"></asp:Label>
                                </td>
                                <td width="120px">
                                    <asp:Label ID="Label17" runat="server" Width="100%" Text="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_2%>"></asp:Label>
                                </td>
                                <td width="120px">
                                    <asp:Label ID="Label19" runat="server" Width="100%" Text="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_3%>"></asp:Label>
                                </td>
                                <td width="120px">
                                    <asp:Label ID="Label20" runat="server" Width="100%" Text="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_4%>"></asp:Label>
                                </td>
                                <td width="120px">
                                    <asp:Label ID="Label21" runat="server" Width="100%" Text="<%$Resources:Resource,wfb2sm_ASSESS_SCORE_5%>"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddl_NEW_LEVEL_CD_NEW" runat="server" Width="60px" CssClass="MandatoryField"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sm_Required_LEVEL_CD_NEW%>"
                                        ControlToValidate="ddl_NEW_LEVEL_CD_NEW" ForeColor="Red" ValidationGroup="GroupA" Display="None" InitialValue="-1"></asp:RequiredFieldValidator>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="lb_NEW_ASSESS_SCORE_3" runat="server"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lb_NEW_ASSESS_SCORE_4" runat="server"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lb_NEW_ASSESS_SCORE_5" runat="server"></asp:Label>
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2SM1100Upload" />
            <asp:PostBackTrigger ControlID="WFB2SM1100_Upload" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
