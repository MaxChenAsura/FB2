<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sm/WFB2SM2200_Dtl.aspx.cs" Inherits="WebContent_fb2sm_WFB2SM2200_Dtl" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="1020" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="100%">
                ...
                <tr>
                    ...
                    <td align="right" class="Body_label">
                        <div id="init_grid">
                            <aces:Btn ID="WFB2SM2200Confirm" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Confirm%>" OnClientClick="return CheckConfirmAction();" OnClick="WFB2SM120Confirm_Click" />
                            <aces:Btn ID="WFB2SM2200Reject" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Reject%>" OnClientClick="return CheckRejectAction();" OnClick="WFB2SM120Reject_Click" />
                            <%--<asp:Button ID="WFB2SM2200Confirm" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Confirm%>" OnClientClick="return CheckConfirmAction();" OnClick="WFB2SM120Confirm_Click" />
                            <asp:Button ID="WFB2SM2200Reject" runat="server" Text="<%$Resources:Resource,wfb2sm_WFB2SM1200Reject%>" OnClientClick="return CheckRejectAction();" OnClick="WFB2SM120Reject_Click" />--%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getDtlData"
                SelectCountMethod="getDtlCount" TypeName="CFB2SM2200DAO" EnablePaging="True"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowSorting="true"
                ...
                OnRowDataBound="gv_result_RowDataBound" Width="1440px">
                <Columns>
                    <%--異常註記--%>
                    ...
                    <%--異動狀態--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_CHG_STATUS%>" SortExpression="CHG_STATUS" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_DEPT_NO%>" SortExpression="DEPT_NO" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="lbl_DEPT_NO" runat="server" Text='<%#Bind("DEP")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--工號--%>
                    ...
                    <%--姓名--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sm_EMP_NAME%>" SortExpression="EMP_NAME" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
