<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb299/WFB2990700_Qry.aspx.cs" Inherits="WebContent_WFB2990700_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="4">
                            ...
                            <aces:Btn ID="WFB2990700Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2990700Search_Click" OnClientClick="CheckSearch();" />
                            <%--
                            <asp:Button ID="WFB2990700Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2990700Search_Click" OnClientClick="CheckSearch();" />
                             --%>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                ...
                                <aces:Btn ID="WFB2990700Add" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_add%>" Visible="true" OnClick="WFB2990700Add_Click" />
                                <aces:Btn ID="WFB2990700Delete" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_delete%>" Visible="false" OnClick="WFB2990700Delete_Click" OnClientClick="return doDelete();" />
                                <%-- 
                                <aces:Btn ID="WFB2990700Edit" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_edit%>" Visible="false" OnClick="WFB2990700Edit_Click" OnClientClick="BlockUI();" />
                                --%>
                                <aces:Btn ID="WFB2990700OK" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_ok%>" Visible="false" OnClick="WFB2990700OK_Click" OnClientClick="return saveCheck()" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2990700DAO" EnablePaging="True"
