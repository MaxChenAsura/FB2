<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb299/WFB2990800_Qry.aspx.cs" Inherits="WebContent_WFB2990800_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="4">
                            ...
                            <aces:Btn ID="WFB2990800Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2990800Search_Click" OnClientClick="CheckSearch();" />
                            <%--
                            <asp:Button ID="WFB2990800Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2990800Search_Click" OnClientClick="CheckSearch();" />
                             --%>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="4">
                            <div id="init_grid">
                                ...
                                <aces:Btn ID="WFB2990800Add" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_add%>" Visible="true" OnClick="WFB2990800Add_Click" />
                                <aces:Btn ID="WFB2990800Delete" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_delete%>" Visible="false" OnClick="WFB2990800Delete_Click" OnClientClick="return doDelete();" />
                                <%-- 
                                <aces:Btn ID="WFB2990800Edit" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_edit%>" Visible="false" OnClick="WFB2990800Edit_Click" OnClientClick="BlockUI();" />
                                --%>
                                <aces:Btn ID="WFB2990800OK" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_ok%>" Visible="false" OnClick="WFB2990800OK_Click" OnClientClick="return saveCheck()" />
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2990800DAO" EnablePaging="True"
