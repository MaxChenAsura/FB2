<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/UNION_PJOB_Search.aspx.cs" Inherits="WebContent_comm_UNION_PJOB_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.UNION_PJOB_Search(id, name, json);//返回原始呼叫頁面
            }
        ...
        function ClearAll() {
            ...
            $("#txt_UNION_PJOB_CD").val("");
            $("#txt_UNION_PJOB_DESC").val("");
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:200px;">工會職務:</th>
                <td class="Body_TR1">
                    <asp:TextBox ID="txt_UNION_PJOB_CD" runat="server" MaxLength="1" Width="60px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1">職務說明:</th>
                <td class="Body_TR1">
                    <asp:TextBox ID="txt_UNION_PJOB_DESC" runat="server" MaxLength="30" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_UNION_PJOB_CD" runat="server" GroupName="rblg_UNION_PJOB_CD" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="UNION_PJOB_CD" HeaderText="工會職務" ItemStyle-Width="160px" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="UNION_PJOB_DESC" HeaderText="職務說明" ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Left" />
                            </Columns>
