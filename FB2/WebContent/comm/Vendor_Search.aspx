<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/Vendor_Search.aspx.cs" Inherits="WebContent_comm_Vendor_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.Vendor_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:200px;">廠商編號:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_VENDOR_NO" runat="server" MaxLength="2" Width="60px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1" >廠商名稱:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_VENDOR_NAME" runat="server" MaxLength="30" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_VENDOR_NO" runat="server" GroupName="rblg_VENDOR_NO" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="VENDOR_NO" HeaderText="廠商編號" ItemStyle-Width="160px" ItemStyle-HorizontalAlign="Left"  />
                                <asp:BoundField DataField="VENDOR_NAME" HeaderText="廠商名稱" ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Left"  />
                            </Columns>
