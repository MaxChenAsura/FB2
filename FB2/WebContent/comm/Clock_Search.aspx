<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/Clock_Search.aspx.cs" Inherits="WebContent_comm_Clock_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.Clock_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:200px;">卡鐘編號:</th>
                <td class="Body_TR1">
                    <asp:TextBox ID="txt_CLOCK_NO" runat="server" MaxLength="3" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1">卡鐘說明:</th>
                <td class="Body_TR1">
                    <asp:TextBox ID="txt_CLOCK_DESC" runat="server" MaxLength="60" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_CLOCK_NO" runat="server" GroupName="rblg_CLOCK_NO" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="CLOCK_NO" HeaderText="卡鐘編號" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="CLOCK_DESC" HeaderText="卡鐘說明" ItemStyle-Width="290px" ItemStyle-HorizontalAlign="Left"  />
                            </Columns>
