<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/SalaryGroup_Search.aspx.cs" Inherits="WebContent_comm_SalaryGroup_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.SalaryGroup_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:200px;">群組代號:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_GROUP_ID" runat="server" MaxLength="5" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1" >群組名稱:</th>
                <td class="Body_TR1">
                    <asp:TextBox ID="txt_GROUP_NAME" runat="server" MaxLength="60" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px" >
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_GROUP_ID" runat="server" GroupName="rblg_GROUP_ID" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="GROUP_ID" HeaderText="群組代號" ItemStyle-Width="160px" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="GROUP_NAME" HeaderText="群組名稱" ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Left"/>
                            </Columns>
