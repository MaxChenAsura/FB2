<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/DeptGrid_Search.aspx.cs" Inherits="WebContent_comm_DeptGrid_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.DeptGrid_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:200px;">部門代號:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_DEPT_NO" runat="server" MaxLength="7" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1" >部門名稱:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_DEPT_NAME" runat="server" MaxLength="60" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_DEPT_NO" runat="server" GroupName="rblg_DEPT_NO" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="DEPT_NO" HeaderText="部門代號" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="DEPT_NAME" HeaderText="部門名稱" ItemStyle-Width="310px" ItemStyle-HorizontalAlign="Left"/>
                            </Columns>
