<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/Card_Search.aspx.cs" Inherits="WebContent_comm_Card_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.Card_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            ...
            <tr>
                <th class="Body_TH1" style="width:200px;">完整卡號:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_CARD_NO" runat="server" MaxLength="8" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1">姓名:</th>
                <td class="Body_TR1">
                    <asp:TextBox ID="txt_CARD_NAME" runat="server" MaxLength="30" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_CARD_NO" runat="server" GroupName="rblg_CARD_NO" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="CARD_NO" HeaderText="完整卡號" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left"/>
                                <asp:BoundField DataField="CARD_NAME" HeaderText="姓名" ItemStyle-Width="260px" ItemStyle-HorizontalAlign="Left"/>
                            </Columns>
