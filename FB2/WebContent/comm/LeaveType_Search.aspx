<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/LeaveType_Search.aspx.cs" Inherits="WebContent_comm_LeaveType_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.LeaveType_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:200px;">主假別代碼:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_MAIN_LEAVE_CD" runat="server" MaxLength="2" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1">說明:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_MAIN_LEAVE_DESC" runat="server" MaxLength="30" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_MAIN_LEAVE_CD" runat="server" GroupName="rblg_MAIN_LEAVE_CD" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="MAIN_LEAVE_CD" HeaderText="主假別代碼" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"  />
                                <asp:BoundField DataField="MAIN_LEAVE_DESC" HeaderText="說明" ItemStyle-Width="310px" ItemStyle-HorizontalAlign="Left"  />
                            </Columns>
