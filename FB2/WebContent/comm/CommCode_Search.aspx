<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/CommCode_Search.aspx.cs" Inherits="WebContent_comm_CommCode_Search" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:200px;">代碼:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_SUB_CD" runat="server" MaxLength="50" Width="100px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1" >名稱:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_SUB_DESC" runat="server" MaxLength="150" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_SUB_CD" runat="server" GroupName="rblg_SUB_CD" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="SUB_CD" HeaderText="代碼" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="160px" />
                                <asp:BoundField DataField="SUB_DESC" HeaderText="名稱" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px" />
                            </Columns>
