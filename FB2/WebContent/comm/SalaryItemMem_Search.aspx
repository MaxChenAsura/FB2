<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/SalaryItemMem_Search.aspx.cs" Inherits="WebContent_comm_SalaryItemMem_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.SalaryItemMem_Search(id, name, json);//返回原始呼叫頁面
            }
    ...
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                ...
                <td class="Body_TR1">
                    <asp:TextBox ID="txt_SALARY_ID" runat="server" ClientIDMode="Static" MaxLength="4" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1" >薪資項目名稱:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_SALARY_NAME" runat="server" ClientIDMode="Static" MaxLength="60" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
