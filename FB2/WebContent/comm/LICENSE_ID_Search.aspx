<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/LICENSE_ID_Search.aspx.cs" Inherits="WebContent_comm_LICENSE_ID_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.LICENSE_ID_Search(id, name, json);//返回原始呼叫頁面
            }
    ...
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                ...
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_LICENSE_ID" runat="server" MaxLength="20" Width="150px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="Body_TH1" >姓名:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_EMP_NAME" runat="server" MaxLength="60" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_LICENSE_ID" runat="server" GroupName="rblg_LICENSE_ID" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="IDENTITY_KIND" HeaderText="身分別" ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="LICENSE_ID" HeaderText="身分證字號/居留證號" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="EMP_NAME" HeaderText="姓名" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="REATION_NAME" HeaderText="關係名稱" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="BIRTH_DT" HeaderText="出生日期"/>
                                <asp:BoundField DataField="FAMILY_RELATION" HeaderText="關係代號" />
                                <asp:BoundField DataField="TARGET_TYPE_DESC" HeaderText="對象代號" />
                            </Columns>
