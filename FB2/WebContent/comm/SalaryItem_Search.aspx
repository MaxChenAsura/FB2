<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/SalaryItem_Search.aspx.cs" Inherits="WebContent_comm_SalaryItem_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.SalaryItem_Search(id, name, json);//返回原始呼叫頁面
            }
