<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/Level_Search.aspx.cs" Inherits="WebContent_comm_Level_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.Level_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:15%;">投保金額(月):</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_INS_AMT" runat="server" MaxLength="7" Width="80px"></asp:TextBox>
                </td>
            </tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField >
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_INS_AMT" runat="server" GroupName="rblg_INS_AMT" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="INS_TYPE" HeaderText="保險類別"/>
                                <asp:BoundField DataField="INS_AMT" HeaderText="投保金額(月)" ItemStyle-HorizontalAlign="Right"/>
                                <asp:BoundField DataField="INS_LOW" HeaderText="薪資下限" ItemStyle-HorizontalAlign="Right"/>
                                <asp:BoundField DataField="INS_TOP" HeaderText="薪資上限" ItemStyle-HorizontalAlign="Right"/>
                            </Columns>
