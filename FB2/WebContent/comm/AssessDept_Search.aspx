<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/AssessDept_Search.aspx.cs" Inherits="WebContent_comm_AssessDept_Search" %>
    ...
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                ...
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_DEPT_NO" runat="server" MaxLength="50" Width="100px"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_DEPT_NAME" runat="server" MaxLength="150" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                    ...
                    <div style="width: 100%; height: 250px">
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DEPT_NO" HeaderText="部門代碼" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="160px" />
                                <asp:BoundField DataField="DEPT_NAME" HeaderText="部門名稱" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px" />
                            </Columns>
