<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/EmpLevel_Search.aspx.cs" Inherits="WebContent_comm_EmpLevel_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.EmpLevel_Search(id, name, json);//返回原始呼叫頁面
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                <th class="Body_TH1" style="width:15%;">資格代碼:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_LEVEL_CD" runat="server" MaxLength="3" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr style="display:none;">
                <th class="Body_TH1">說明:</th>
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_LEVEL_DESC" runat="server" MaxLength="60" Width="224px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-Width="40px">
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbl_LEVEL_CD" runat="server" GroupName="rblg_LEVEL_CD" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="LEVEL_CD" HeaderText="資格代碼" ItemStyle-Width="160px" ItemStyle-HorizontalAlign="Left"  />
                                <asp:BoundField DataField="LEVEL_DESC" HeaderText="說明" ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Left"  />
                            </Columns>
