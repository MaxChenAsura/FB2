<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/EmpAndFamily_Search.aspx.cs" Inherits="WebContent_comm_EmpAndFamily_Search" %>
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            if (typeof flag === 'undefined' || flag === '') {
                ...
                parent.EmpAndFamily_Search(id, name, json);//返回原始呼叫頁面
            }
    ...
    <form id="form1" runat="server">
        ...
        <table cellspacing="1" cellpadding="1" width="500px" border="0">
            <tr>
                ...
                <td class="Body_TR1" >
                    <asp:TextBox ID="txt_LICENCE_ID" runat="server" MaxLength="20" Width="72px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td align="center" colspan="2">
                    <div style="width: 100%; height: 250px">
                        <asp:GridView ID="gv_result" runat="server" CssClass="grid-view"
                            AutoGenerateColumns="False" OnRowDataBound="gv_result_RowDataBound" Width="460px">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                    </HeaderTemplate>
                                ...
                                <asp:BoundField DataField="IDENTITY_KIND" HeaderText="身份別" />
                                ...
                                <asp:BoundField DataField="BIRTH_DT" HeaderText="出生日期" ItemStyle-HorizontalAlign="Left"/>
