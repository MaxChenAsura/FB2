<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/comm/Assess_Dept_Search.aspx.cs" Inherits="tw_co_toyota_kuozui_web_comm_Assess_Dept_Search" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ReturnValue(json) {
            ...
            var calledFunctionObject = window.parent.$('#div_iframeID').attr("calledFunctionObject");
