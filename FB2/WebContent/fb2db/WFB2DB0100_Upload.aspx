<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2db/WFB2DB0100_Upload.aspx.cs" Inherits="WebContent_fb2db_WFB2DB0100_Upload" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                    <aces:Btn ID="WFB2DB0100Upload" runat="server" Text="<%$Resources:Resource,wfb2da_lb_Upload%>" OnClick="WFB2DB0100Upload_Click" OnClientClick="return MyCheckValid(this.value);" />
                ...
                <td align="left" class="Body_label" colspan="5">
                    ...
                    <fieldset style="padding: 5px">
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                    <asp:Button ID="WFB2DB0100DownLoadExcel" runat="server" Text="<%$Resources:Resource,lb_DownLoad%>" OnClick="btn_Excel_Down_Click" />
                                </td>
                            </tr>
                        </table>
