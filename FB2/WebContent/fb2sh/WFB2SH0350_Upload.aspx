<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sh/WFB2SH0350_Upload.aspx.cs" Inherits="WebContent_fb2sh_WFB2SH0350_Upload" %>
        ...
        <tbody>
            ...
            <tr>
             ...
             <tr>
                    ...
                    <td align="left" class="Body_label">
                        <asp:DropDownList ID="ddl_AWARD_ROUND" runat="server" Width="100px" CssClass="MandatoryField" ClientIDMode="Static"> </asp:DropDownList>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="年獎回數必選"
                        ControlToValidate="ddl_AWARD_ROUND" ForeColor="Red" ValidationGroup="GroupA" Display="None">
                    </asp:RequiredFieldValidator>
                    </td>
              </tr>
            <tr>
                ...
                <td align="right" class="Body_label">
                    ...
                    <aces:Btn ID="WFB2SH0350Upload" runat="server" Text="<%$Resources:Resource,wfb2da_lb_Upload%>" OnClick="WFB2SH0350Upload_Click" OnClientClick="return MyCheckValid(this.value);" />
                ...
                <td align="left" class="Body_label" colspan="5">
                    ...
                    <fieldset style="padding: 5px">
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                    <asp:Button ID="WFB2SH0350DownLoadExcel" runat="server" Text="<%$Resources:Resource,lb_DownLoad%>" OnClick="btn_Excel_Down_Click" />
                                </td>
                            </tr>
                        </table>
