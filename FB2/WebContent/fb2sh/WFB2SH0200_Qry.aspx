<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sh/WFB2SH0200_Qry.aspx.cs" Inherits="WebContent_WFB2SH0200_Qry" Culture="auto" UICulture="auto" %>
    ...
    <script type="text/javascript">
        ...
        function executeCheck() {
            ...
            if (checkboxsSelected() == 1) {
                ...
                //年獎回數
                if ($("[id=hid_AWARD_ROUND]")[choietr].value == "3") {
                    if ($("#HID_isSalaryADJ").val() == "N") {
                        processed = confirm('無今年度調薪資料，是否要進行對象生成。[將依調薪前薪資當發放base]')
                    }
                }
                if (!processed) {
                    $.unblockUI();
        ...
        function CheckAnnounce() {
            ...
            BlockUI();
            if (checkboxsSelected() == 1) {
                processed = confirm("確定要進行薪資轉出？ [ !!!注意：薪資轉出後資料無法進行修改]");
            }
            else {
                alert("請選取一筆資料!");
                choietr = null;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:DropDownList ID="ddl_AWARD_ROUND" runat="server" ClientIDMode="Static"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <th align="left" class="Body_TableHeader">
                            <%--年獎發放期間--%>
                            <asp:Label ID="Label1" runat="server" Text="<%$Resources:Resource,wfb2sh_lb_award_dt_s_e%>"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_AWARD_DT_S" runat="server" Width="100px" ClientIDMode="Static" CssClass="date"></asp:TextBox>
                            ~ 
                           <asp:TextBox ID="txt_AWARD_DT_E" runat="server" Width="100px" ClientIDMode="Static" CssClass="date"></asp:TextBox>
                            <!--驗證日期格式-->
                              <asp:CustomValidator ID="qrytest" runat="server" ValidateEmptyText="true"
								...
								ControlToValidate="txt_AWARD_DT_S" ValidationGroup="GroupA" Display="None"></asp:CustomValidator>	
                             <asp:CustomValidator ID="qry4" runat="server" ValidateEmptyText="true"
								...
								ControlToValidate="txt_AWARD_DT_E" ValidationGroup="GroupA" Display="None"></asp:CustomValidator>	
                            <asp:CompareValidator ID="qry5" runat="server" ControlToCompare="txt_AWARD_DT_S"
                                ControlToValidate="txt_AWARD_DT_E" ErrorMessage="<%$Resources:Resource,wfb2sh_error_award_dt_s_e%>" Type="Date" Operator="GreaterThanEqual"
                                Display="None" ValidationGroup="GroupA"></asp:CompareValidator>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="5">
                            ...
                            <aces:Btn ID="WFB2SH0200Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2SH0200Search_Click" OnClientClick="CheckSearch();" />
                               <%--
                            <asp:Button ID="WFB2SH0200Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2SH0200Search_Click" OnClientClick="CheckSearch();" />
                            --%> 
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="6">
                            <div id="init_grid">
                                ...
                                <aces:Btn ID="WFB2SH0200Add" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_add%>" Visible="true" OnClick="WFB2SH0200Add_Click" OnClientClick="return CheckSearch();" />
                                <aces:Btn ID="WFB2SH0200Delete" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_delete%>" Visible="false" OnClick="WFB2SH0200Delete_Click" OnClientClick="return doDelete();" />
                                <aces:Btn ID="WFB2SH0200Edit" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_edit%>" Visible="false" OnClick="WFB2SH0200Edit_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2SH0200Execute" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_target_gen%>" Visible="false" OnClick="WFB2SH0200Execute_Click" OnClientClick="return executeCheck(); " />
                                <aces:Btn ID="WFB2SH0200Release" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_release%>" Visible="false" OnClick="WFB2SH0200Release_Click" OnClientClick="return CheckRelease();" />
                                <aces:Btn ID="WFB2SH0200Announce" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_salary_trans%>" Visible="false" OnClick="WFB2SH0200Announce_Click" OnClientClick="return CheckAnnounce();" />
                                <aces:Btn ID="WFB2SH0200OK" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_ok%>" Visible="false" OnClick="WFB2SH0200OK_Click" OnClientClick="return saveCheck()" />
                                  <%-- 
                                <asp:Button ID="WFB2SH0200Add" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_add%>" Visible="true" OnClick="WFB2SH0200Add_Click" OnClientClick="return CheckSearch();" />
                                <asp:Button ID="WFB2SH0200Delete" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_delete%>" Visible="false" OnClick="WFB2SH0200Delete_Click" OnClientClick="return doDelete();" />
                                <asp:Button ID="WFB2SH0200Edit" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_edit%>" Visible="false" OnClick="WFB2SH0200Edit_Click" OnClientClick="BlockUI();" />
                                <asp:Button ID="WFB2SH0200Execute" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_target_gen%>" Visible="false" OnClick="WFB2SH0200Execute_Click" OnClientClick="return executeCheck(); " />
                                <asp:Button ID="WFB2SH0200Release" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_release%>" Visible="false" OnClick="WFB2SH0200Release_Click" OnClientClick="return CheckRelease();" />
                                <asp:Button ID="WFB2SH0200Announce" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_salary_trans%>" Visible="false" OnClick="WFB2SH0200Announce_Click" OnClientClick="return CheckAnnounce();" />
                                <asp:Button ID="WFB2SH0200OK" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_ok%>" Visible="false" OnClick="WFB2SH0200OK_Click" OnClientClick="return saveCheck()" />
                                --%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SH0200DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="hid_qry_AWARD_DT_S"
                        Name="award_dt_s" PropertyName="Value" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="hid_qry_AWARD_DT_E"
                        Name="award_dt_e" PropertyName="Value" Type="String" ConvertEmptyStringToNull="False" />
                    <asp:ControlParameter ControlID="hid_qry_AWARD_ROUND"
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--年獎回數--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sh_lb_award_round%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" SortExpression="AWARD_ROUND">
                        <ItemTemplate>
                            <asp:Label ID="lb_AWARD_ROUND" runat="server" Text='<%#Bind("AWARD_ROUND_DESC")%>' Width="100px"></asp:Label>
                            <!-- 計算生成日 -->
                            <asp:HiddenField ID="hid_AWARD_ROUND" runat="server" Value='<%#Bind("AWARD_ROUND")%>' ClientIDMode="Static" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_AWARD_ROUND" runat="server" Text='<%#Bind("AWARD_ROUND_DESC")%>' Width="100px"></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:DropDownList ID="ddl_NEW_AWARD_ROUND" runat="server" Width="100px" ClientIDMode="Static" CssClass="MandatoryField" OnSelectedIndexChanged="ddl_NEW_AWARD_ROUND_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <%--發放期間起--%>
                    ...
                    <%--對象生成日--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sh_lb_target_gen_dt%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="TARGET_GEN_DT">
                        <ItemTemplate>
                            ...
                            <!-- 計算生成日 -->
                            <asp:HiddenField ID="hid_GEN_DT" runat="server" Value='<%#Bind("GEN_DT","{0:yyyy/MM/dd}")%>' ClientIDMode="Static" />
                        </ItemTemplate>
                        <EditItemTemplate>
                    ...
                    <%--  薪資轉出日--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sh_lb_salary_trans_dt%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="SALARY_TRANS_DT">
                        <ItemTemplate>
                            <asp:Label ID="lb_ENV_SALARY_TRANS_DT" runat="server" Text='<%#Bind("SALARY_TRANS_DT", "{0:yyyy/MM/dd}")%>' Width="100px"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lb_ENV_SALARY_TRANS_DT" runat="server" Text='<%#Bind("SALARY_TRANS_DT", "{0:yyyy/MM/dd}")%>' Width="100px"></asp:Label>
                        </EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="功能" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            ...
                            <aces:Btn ID="WFB2SH0200Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="查詢明細" />
                            <%--
                            <asp:Button ID="WFB2SH0200Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="查詢明細" />
                            --%> 
                ...
                <EmptyDataTemplate>
                    <table class="grid-view" width="1020px">
                        <tr class="header">
                            ...
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="<%$Resources:Resource,wfb2sh_lb_award_round%>" Width="100px"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="<%$Resources:Resource,wfb2sh_lb_award_round%>" Width="100px"></asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label6" runat="server" Text="<%$Resources:Resource,wfb2sh_lb_target_gen_dt%>" Width="100px"></asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label9" runat="server" Text="<%$Resources:Resource,wfb2sh_lb_salary_trans_dt%>" Width="100px"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr class="normal">
                            ...
                            <td>
                                <asp:DropDownList ID="ddl_NEW_AWARD_ROUND" runat="server" Width="100px" ClientIDMode="Static" CssClass="MandatoryField" OnSelectedIndexChanged="ddl_NEW_AWARD_ROUND_SelectedIndexChanged2" AutoPostBack="true"></asp:DropDownList>
                            </td>
                            <td>
                                <asp:TextBox ID="txt_NEW_AWARD_STIME" runat="server" ClientIDMode="Static" Width="100px" CssClass="MandatoryField  date"></asp:TextBox>
                                <!--驗證不可空白 -->
            ...
            <asp:HiddenField ID="hid_qry_AWARD_DT_S" runat="server" ClientIDMode="Static" />	 
             <asp:HiddenField ID="hid_qry_AWARD_DT_E" runat="server" ClientIDMode="Static" /> 
            <asp:HiddenField ID="hid_qry_AWARD_ROUND" runat="server" ClientIDMode="Static" /> 

            <!-- 是否已調薪 -->
            <asp:HiddenField ID="HID_isSalaryADJ" runat="server" ClientIDMode="Static" />
            <!-- 每頁的筆數 -->
