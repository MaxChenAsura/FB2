<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2sh/WFB2SH0400_Qry.aspx.cs" Inherits="WebContent_WFB2SH0400_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                    ...
                    <tr>
                        <th align="left" class="Body_TableHeader">
                            <%--發放回數--%>
                            <asp:Label ID="Label2" runat="server" Text="<%$Resources:Resource,wfb2sh_lb_award_round%>"></asp:Label>:</th>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="5">
                            ...
                            <aces:Btn ID="WFB2SH0400Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2SH0400Search_Click" OnClientClick="CheckSearch();" />
                            <%--
                            <asp:Button ID="WFB2SH0400Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2SH0400Search_Click" OnClientClick="CheckSearch();" />
                                --%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SH0400DAO" EnablePaging="True"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="ddl_AWARD_ROUND"
                        Name="awardRound" PropertyName="SelectedValue" Type="String" ConvertEmptyStringToNull="False" />
                </SelectParameters>
            ...
            <asp:GridView ID="gv_result" runat="server" AllowPaging="True" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    ...
                    <%--發放天數--%>
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sh_lb_award_days%>" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Right" SortExpression="AWARD_DAYS">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sh_lb_function%>" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="center">
                        <ItemTemplate>
                            ...
                            <aces:Btn ID="WFB2SH0400Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="查詢明細" />
                            <%--
                            <asp:Button ID="WFB2SH0400Detail" runat="server"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="查詢明細" />
                            --%>
