<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2hb/WFB2HB0100_LICENSEID.aspx.cs" Inherits="WebContent_WFB2HB0100_LICENSEID" Culture="auto" UICulture="auto" %>
                            ...
                            <tbody>     
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="Body_label" >
                                        <div id="init">
                                            <%-- 
                                            <aces:Btn ID="WFB2HB0100LID_UPLOAD" runat="server" Text="上傳" OnClick="WFBHB0100Upload_Click" OnClientClick="return executeCheck(this.value);"/>                                                                     
                                             --%>
                                            <asp:Button ID="WFB2HB0100LID_UPLOAD" runat="server" Text="上傳" OnClick="WFBHB0100Upload_Click"  OnClientClick="return executeCheck(this.value);" />
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="FileUpload1" ForeColor="Red" ValidationGroup="GroupB"
                                                ErrorMessage="<%$Resources:Resource,wfb2_format_excel%>" ValidationExpression="^([a-zA-Z].*|[1-9].*)\.(xlsx|XLSX)$" Display="None"></asp:RegularExpressionValidator>
                                            <asp:Button ID="WFB2HB0100LID_ExcelDown" runat="server" Text="範例下載" OnClick="btn_Excel_Down_Click" />
