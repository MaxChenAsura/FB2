<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2hb/WFB2HB0300_Upd.aspx.cs" Inherits="WebContent_fb2hb_WFB2HB0300_Upd" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function iniForm() {
            ...
            $("#txt_ORI_DEPT_NO").blur(function () {
                if ($("#txt_ORI_DEPT_NO").val().length == 7) {
                    $.ajax({
                        url: "../commgeo/WFB2GetDeptData.ashx",
                        data: {
                            DEPT_NO: $('#txt_ORI_DEPT_NO').val()
                        },
                        type: "GET",
                        cache: false,
                        dataType: 'json',
                ...
                <tbody>
                      <tr>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="Label1" runat="server" Text="人事異動編號"></asp:Label>:</th>
                    ...
                    <tr>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_START_DEPT_NO" runat="server" Text="原籍部門代號"></asp:Label>:</th>
                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_ORI_DEPT_NO" runat="server" MaxLength="7" Width="64px" ClientIDMode="Static"  CssClass="MandatoryField"></asp:TextBox>
                            <input id="bt_START_DEPT_SEARCH" type="button" value="..." onclick="OpenDeptSearch('txt_ORI_DEPT_NO', 'txt_START_DEPT_NAME', 'N');" />
                            <asp:TextBox ID="txt_START_DEPT_NAME" runat="server" MaxLength="10" BorderWidth="0" ClientIDMode="Static"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="原籍部門代號必輸入"
                             ControlToValidate="txt_ORI_DEPT_NO" ForeColor="Red" ValidationGroup="GroupA" Display="None" ></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                        <tr>
                        <th align="left" class="Body_TableHeader">
                        ...
                        <td align="left" class="Body_label">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="預計結束日期必輸入"
                    ...
                    <tr>
                        <th align="left" class="Body_TableHeader">
                            <asp:Label ID="lb_END_DT" runat="server" Text="實際結束日期"></asp:Label>:</th>
                        <td align="left" class="Body_label">
