<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2hb/WFB2HB0700_Upload.aspx.cs" Inherits="WebContent_fb2hb_WFB2HB0700_Upload"  Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        //function toRedirect() {
        //    window.location.href = "WFB2HB0700_Qry.aspx";
        //}
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right" class="Body_label">
                    <aces:Btn ID="WFB2HB0701Upload" runat="server" Text="<%$Resources:Resource,wfb2hb_WFB2HB0701ExcelImport%>" OnClick="WFB2HB0701Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>
                    <%--<asp:Button ID="WFB2HB0701Upload" runat="server" Text="<%$Resources:Resource,wfb2hb_WFB2HB0701ExcelImport%>" OnClick="WFB2HB0701Upload_Click" OnClientClick="return MyCheckValid(this.value);"/>--%>
                    <asp:Button ID="btn_back" runat="server" Text="<%$Resources:Resource,wfb2hb_btn_back%>" OnClick="btn_back_Click" />
                    ...
                    <fieldset style="padding:5px">
                        ...
                        <table align="right">
                            <tr>
                                ...
                                <td>
                                   <aces:Btn ID="WFB2HB0701ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2hb_WFB2HB0701ExcelDown%>" OnClick="btn_Excel_Down_Click" />

                                   <%--<asp:Button ID="WFB2HB0701ExcelDown" runat="server" Text="<%$Resources:Resource,wfb2hb_WFB2HB0701ExcelDown%>" OnClick="btn_Excel_Down_Click" />--%>
                                </td>
                            </tr>
                        </table>
