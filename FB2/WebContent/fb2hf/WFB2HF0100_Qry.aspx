<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2hf/WFB2HF0100_Qry.aspx.cs" Inherits="WebContent_WFB2HF0100_Qry" Culture="auto" UICulture="auto" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="left" class="Body_label">
                            <asp:TextBox ID="txt_DECLARA_YEAR_S" runat="server" Width="60px" ClientIDMode="Static"></asp:TextBox>
                            ~
                            <asp:TextBox ID="txt_DECLARA_YEAR_E" runat="server" Width="60px" ClientIDMode="Static"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="qry1" runat="server" ErrorMessage="<%$Resources:Resource,wfb2sj_required_assess_year_s%>"
                             ...
                             <asp:CompareValidator ID="qry5" runat="server" ControlToCompare="txt_DECLARA_YEAR_S"
                            ControlToValidate="txt_DECLARA_YEAR_E" ErrorMessage="年度(起)不可大於年度(迄)" Type="Integer" Operator="GreaterThanEqual"
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="6">
                            ...
                            <aces:Btn ID="WFB2HF0100Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2HF0100Search_Click" OnClientClick="return CheckSearch();" />
                            <%--
                            <asp:Button ID="WFB2HF0100Search" runat="server" Text="<%$Resources:Resource,wfb2sh_btn_search%>" OnClick="WFB2HF0100Search_Click" OnClientClick="return CheckSearch();" />
                            --%>
                    ...
                    <tr>
                        <td align="right" class="Body_label" colspan="6">
                            <div id="init_grid">
                                <aces:Btn ID="WFB2HF0100Execute" runat="server" Text="對象生成" Visible="true" OnClick="WFB2HF0100Execute_Click" OnClientClick="return doSomething(this.value);" />
                                <aces:Btn ID="WFB2HF0100Delete" runat="server" Text="刪除" Visible="false" OnClick="WFB2HF0100Delete_Click" OnClientClick="return doDelete();" />
                                <aces:Btn ID="WFB2HF0100Edit" runat="server" Text="申告" Visible="true" OnClick="WFB2HF0100Edit_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2HF0100Withdraw" runat="server" Text="抽單" Visible="false" OnClick="WFB2HF0100Withdraw_Click" OnClientClick="return doSomething(this.value);" />
                                <aces:Btn ID="WFB2HF0100Detail" runat="server" Text="查詢明細" Visible="false" OnClick="WFB2HF0100Detail_Click" OnClientClick="BlockUI();" />
                                <aces:Btn ID="WFB2HF0100Report" runat="server" Text="個人報表" Visible="false" OnClick="WFB2HF0100Report_Click" OnClientClick="BlockUI();" />
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2HF0100DAO" EnablePaging="True"
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="WFB2HF0100Report" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
