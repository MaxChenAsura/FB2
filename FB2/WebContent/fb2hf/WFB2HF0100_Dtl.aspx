<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/tw/co/toyota/kuozui/fb2hf/WFB2HF0100_Dtl.aspx.cs" Inherits="WebContent_fb2hb_WFB2HF0100_Dtl" Culture="auto" UICulture="auto" %>
        ...
        <ContentTemplate>
            <table cellspacing="1" cellpadding="1" width="1020" border="0" class="Body_Label">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="7">IV.其他自我申告事項(健康、家庭或其他事項等) <asp:Label ID="Label31" runat="server" Text="【その他申告事項】" CssClass="jpnText"/>
                        </td>
                    </tr>
                      <tr>
                        <td class="Body_TR1"colspan="7">
                    ...
                    <tr>
                        <td colspan="7">
                            <table cellspacing="1" cellpadding="1" border="0" width="1020px" class="Body_Label">
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:Label ID="Label17_1" runat="server" Text='1' Width="40px"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:Label ID="Label18_1" runat="server" Text='2' Width="40px"></asp:Label>
                                    </td>
                                    <td>
                    ...
                    <tr>
                        <td class="Body_TR1" colspan="7">2.基於職涯規劃與能力發展，個人未來希望之異動/業務調整 <asp:Label ID="Label18" runat="server" Text="【異動・業務調整要望】" CssClass="jpnText"/></td>
                    </tr>
                    <tr>
                        <td colspan="7">
                            <table cellspacing="1" cellpadding="1" border="0" width="100%" class="Body_Label">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddl_P_BIZ_CHG_TYPE2" runat="server" Width="120px" ClientIDMode="Static"
                                            AutoPostBack="true" OnSelectedIndexChanged="ddl_P_BIZ_CHG_TYPE2_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddl_P_BIZ_CHG_TYPE3" runat="server" Width="120px" ClientIDMode="Static"
                                            AutoPostBack="true" OnSelectedIndexChanged="ddl_P_BIZ_CHG_TYPE3_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                    ...
                    <tr>
                        <td class="Body_TR1" colspan="7">4.上述異動/業務調整之理由(無異動計畫者亦須填寫理由) <asp:Label ID="Label30" runat="server" Text="【理由説明】" CssClass="jpnText"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="Body_TR1" colspan="7">
