<%@ WebHandler Language="C#" Class="WFB2GetDeptAllData" %>

using System;
using System.Web;

public class WFB2GetDeptAllData : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        COMMGEOBO commegeoBO = new COMMGEOBO();
        DEPT_DATA json = new DEPT_DATA();
        try
        {
            if (dept_no != "")
            {
                System.Data.DataTable dt = commegeoBO.getDeptAllData(dept_no);
                if (dt.Rows.Count > 0)
                {
