    ...
    <script type="text/javascript">
        ...
        function DOC_NO_Search(obj_cd, obj_desc, value) {
            ...
            if (!(typeof returnValue === 'undefined')) {
                ...
                //alert("PAY_TARGET=" + obj.Val1.substr(0,1));
                $("#" + obj_cd).val(obj.CD);
                $("#" + obj_desc).val(obj.DESC);
                $("#txt_NEW_PAY_TARGET").val((obj.Val1).substr(0,1));
                $("#txt_NEW_CREDITOR").val(obj.Val2);
                return obj;
            }
        }
    </script>
                        ...
                        <asp:GridView ID="gv_result2" runat="server" AllowPaging="True" AllowSorting="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sf_SEQ%>" SortExpression="SEQ" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                                    ...
                                    <FooterTemplate>
                                        <asp:TextBox Width="100%" Style="text-align: center;" ID="txt_NEW_SEQ" runat="server" MaxLength="3" BorderWidth="0" ClientIDMode="Static"  disabled="disabled"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sf_PAY_TARGET%>" SortExpression="PAY_TARGET" HeaderStyle-Width="150px" ItemStyle-Width="150px">
                                    ...
                                    <FooterTemplate>
                                        <asp:TextBox Width="100%" Style="text-align: left;" ID="txt_NEW_PAY_TARGET" runat="server" MaxLength="1" BorderWidth="0" ClientIDMode="Static" ReadOnly="true"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sf_CREDITOR%>" SortExpression="CREDITOR" HeaderStyle-Width="150px" ItemStyle-Width="150px">
                                    ...
                                    <FooterTemplate>
                                        <asp:TextBox Width="100%" Style="text-align: left;" ID="txt_NEW_CREDITOR" runat="server" MaxLength="60" BorderWidth="0" ClientIDMode="Static" ReadOnly="true"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                            ...
                            <EmptyDataTemplate>
                                <table class="grid-view" width="1020px">
                                    ...
                                    <tr class="normal">
                                        ...
                                        <td>
                                            <asp:TextBox Width="120px" Style="text-align: right;" ID="txt_NEW_SEQ" runat="server" MaxLength="3" BorderWidth="0" ClientIDMode="Static" disabled="disabled"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox Width="150px" Style="text-align: left;" ID="txt_NEW_PAY_TARGET" runat="server" MaxLength="1" BorderWidth="0" ClientIDMode="Static" ReadOnly="true"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox Width="150px" Style="text-align: left;" ID="txt_NEW_CREDITOR" runat="server" MaxLength="60" BorderWidth="0" ClientIDMode="Static" ReadOnly="true"></asp:TextBox>
                                        </td>
                                        <td>
