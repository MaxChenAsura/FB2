<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/tw/co/toyota/kuozui/fb2sl/action/WFB2SL4100_Qry.aspx.cs" Inherits="WebContent_fb2sl_WFB2SL4100_Qry" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="Body_label">
                                        <div id="init">
                                            <aces:Btn ID="WFB2SL4100Generate" runat="server" Text="<%$Resources:Resource,wfb2sl_WFB2SL310Generate%>" OnClick="WFB2SL4100Generate_Click" ValidationGroup="GroupA" OnClientClick="CheckValid();" />
                                            <%--<asp:Button ID="WFB2SL4100Generate" runat="server" Text="<%$Resources:Resource,wfb2sl_WFB2SL310Generate%>" OnClick="WFB2SL4100Generate_Click" ValidationGroup="GroupA" OnClientClick="CheckValid();" />--%>
            ...
            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="getData"
                SelectCountMethod="getCount" TypeName="CFB2SL4100DAO" EnablePaging="True"
                ...
                <Columns>
                    ...
                    <%--功能--%>
                     <asp:TemplateField HeaderText="<%$Resources:Resource,wfb2sl_WFB2SL410Function%>" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <aces:Btn ID="WFB2SL4100Detail" runat="server" Width="80px"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="<%$Resources:Resource,wfb2sl_WFB2SL4100Detail%>" />
                           <%--<asp:Button ID="WFB2SL4100Detail" runat="server" Width="80px"
                                CommandName="ToDetail"
                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                Text="<%$Resources:Resource,wfb2sl_WFB2SL4100Detail%>" />--%>
                        </ItemTemplate>
