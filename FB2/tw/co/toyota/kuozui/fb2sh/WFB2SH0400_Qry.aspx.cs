...
public partial class WebContent_WFB2SH0400_Qry : BasePage
{
    //宣告BO 物件
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            Session["SH0400_ddlPerPageRow"] = ViewState["PerPageRow"];
        }
        catch (Exception ex)
        {
	 ...
	 protected void gv_result_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ToDetail")
        {
            ...
            Response.Redirect("WFB2SH0400_Dtl.aspx?"
    ...
    //查詢功能
    protected void WFB2SH0400Search_Click(object sender, EventArgs e)
    {
        try
        {
    ...
    protected void keepConditions(bool clear)
    {
        if (clear)
        {
            Session["SH0400_txt_AWARD_YEAR_S"] = txt_AWARD_YEAR_S.Text;
            Session["SH0400_txt_AWARD_YEAR_E"] = txt_AWARD_YEAR_E.Text;
            Session["SH0400_ddl_AWARD_ROUND"] = ddl_AWARD_ROUND.SelectedValue;
           
        }
        else
        {
            Session["SH0400_Is_Search"] = "N";
        }
    }
    ...
    protected void realeaseConditions()
    {
        try
        {
            if (Session["SH0400_Is_Search"] == "Y")
            {
                txt_AWARD_YEAR_S.Text = Session["SH0400_txt_AWARD_YEAR_S"].ToString();
                txt_AWARD_YEAR_E.Text = Session["SH0400_txt_AWARD_YEAR_E"].ToString();
                ddl_AWARD_ROUND.SelectedValue = Session["SH0400_ddl_AWARD_ROUND"].ToString();
                ViewState["PerPageRow"] = Session["SH0400_ddlPerPageRow"].ToString();
                WFB2SH0400Search_Click(null, null);
