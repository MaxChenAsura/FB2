...
public partial class WebContent_fb2sm_WFB2SM2300_Dtl : BasePage
{
    private enum UIMode
    {
        Init,
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            CFB2SM2300DAO fb2sm = new CFB2SM2300DAO();
            ...
            if (dataCount == 0)
            {
                Session["SM2300_Is_Search"] = "Y";
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "noData", "alert('查無明細資料!');$(location).attr('href','WFB2SM2300_Qry.aspx');", true);
                return;
            }
            else
            {
    ...
    {
        CFB2SM2300DAO dao = new CFB2SM2300DAO();
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        ...
        if (ViewState["SortExpression"] == null)
            getSortDirection("EXCEPTION_STATUS DESC,UPDATED_DT DESC,PJOB_CD ASC,EMP_ID");    //排序方式(BasePage.cs)
        gv_result.Visible = true;
        gv_result.PageIndex = 0;
        gv_result.PageSize = pagesize;

        gv_result.DataSource = ods1;
    ...
    {
        Session["SM2300_Is_Search"] = "Y";
        Response.Redirect("WFB2SM2300_Qry.aspx");
    }
