...
public partial class WebContent_fb2ha_WFB2HA0210_Add : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        up_dept_no = Request.QueryString["up_dept_no"] == null ? "" : Request.QueryString["up_dept_no"].ToString();
        ...
        if (!IsPostBack)
        {
            ...
            if (up_dept_no != "")
            {
                ...
                txt_UP_DEPT_NO.Text = up_dept_no;
                txt_UP_DEPT_NO.Enabled = false;
            }
    ...
    private void getDeptData()
    {
        try
        {
            DataTable dt = service.getUpDeptData(up_dept_no);
            if (dt.Rows.Count > 0)
            {
                txt_UP_DEPT_NAME.Text = dt.Rows[0]["DEPT_NAME"].ToString();
                hid_UP_DEPT_LEVEL.Value = dt.Rows[0]["DEPT_LEVEL"].ToString();
            }
        }
        catch (Exception ex)
        {
    ...
    protected void WFB2HA0211Search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                WFB2HA0211Save.Visible = true;
                WFB2HA0103Save.Visible = true;
                WFB2HA0203Save.Visible = true;
    ...
    protected void WFB2HA0211Save_Click(object sender, EventArgs e)
    {
        try
        {
            //檢查勾選項目
            ...
            for (int i = 0; i < this.gv_result.Rows.Count; i++)
            {
                ...
                {
                    dept_no.Add(gv_result.DataKeys[i].Values["DEPT_NO"].ToString());

                }
            }
            string msg = service.add_DeptOrg(dept_no,txt_UP_DEPT_NO.Text,hid_UP_DEPT_LEVEL.Value,txt_START_DT.Text);
            if (msg != "0")
            {
    ...
    protected void WFB2HA0210Cancel_Click(object sender, EventArgs e)
    {
        ...
        Session["HA0210_Is_Search"] = "Y";
        Response.Redirect("WFB2HA0210_Qry.aspx?parentFuncId=" + HID_parentFuncID.Value);
