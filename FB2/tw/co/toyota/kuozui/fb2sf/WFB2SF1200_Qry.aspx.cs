    ...
    protected void WFB2SF1200OK_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (gv_result2.Rows.Count == 0)
            {
                ...
                fb2sf.SALARY_DT = HID_GV1_SALARY_DT.Value;
            ...
            else
            {
                ...
                if (gv_result2.EditIndex == -1)
                {
                    ...
                    fb2sf.data_key = HID_GV1_SALARY_DT.Value + HID_GV1_SALARY_TYPE.Value + HID_PAY_KIND.Value + HID_EMP_ID.Value + HID_NEW_DOC_NO2.Value + HID_SEQ.Value;
                    fb2sf.SALARY_DT = HID_GV1_SALARY_DT.Value;
                    fb2sf.SALARY_TYPE = HID_GV1_SALARY_TYPE.Value;//2021
                    fb2sf.PAY_KIND_ID = HID_PAY_KIND.Value;
                    fb2sf.EMP_ID = HID_EMP_ID.Value;
