...
public partial class WebContent_fb2hb_WFB2HB0100_SubDtl1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            getGridView("FAMILY_RELATION", 0, 10);
        }
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            if (ViewState["SortExpression"] == null)
                getSortDirection("FAMILY_RELATION");

            //GridView基本設定
            gv_result.PageIndex = 0;
            gv_result.PageSize = pagesize;
            gv_result.DataSourceID = "ods1";
            gv_result.DataKeyNames = new string[] { "EMP_ID", "FAMILY_LICENSE_ID" }; //設定GridView Key
            gv_result.DataBind();
    ...
    protected void gv_result_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //津貼
            HiddenField obj = (HiddenField)e.Row.Cells[9].FindControl("hid_IS_ALLOWANCE");
            CheckBox cb = (CheckBox)e.Row.Cells[9].FindControl("cb_IS_ALLOWANCE");
            if (obj != null)
            {
                if (cb != null)
                {
            ...
            //受益人
            HiddenField obj2 = (HiddenField)e.Row.Cells[9].FindControl("hid_BENEFICIARY");
            CheckBox cb2 = (CheckBox)e.Row.Cells[9].FindControl("cb_BENEFICIARY");
            if (obj2 != null)
            {
                if (cb2 != null)
                {
            ...
            //有效
            HiddenField obj3 = (HiddenField)e.Row.Cells[9].FindControl("hid_IS_VALID");
            CheckBox cb3 = (CheckBox)e.Row.Cells[9].FindControl("cb_IS_VALID");
            if (obj3 != null)
            {
                if (cb3 != null)
                {
