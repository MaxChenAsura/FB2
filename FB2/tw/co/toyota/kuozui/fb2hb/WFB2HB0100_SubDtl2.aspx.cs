...
public partial class WebContent_fb2hb_WFB2HB0100_SubDtl2 : System.Web.UI.Page
{
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            if (ViewState["SortExpression"] == null)
                getSortDirection("EDUCATION_CD");

            //GridView基本設定
            gv_result.PageIndex = 0;
            gv_result.PageSize = pagesize;
            gv_result.DataSourceID = "ods1";
            gv_result.DataKeyNames = new string[] { "EMP_ID", "EDUCATION_CD" }; //設定GridView Key
            gv_result.DataBind();
    ...
    protected void gv_result_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            HiddenField obj = (HiddenField)e.Row.Cells[6].FindControl("hid_IS_SALARY_SCHOOL");
            CheckBox cb = (CheckBox)e.Row.Cells[6].FindControl("cb_IS_SALARY_SCHOOL");
            if (obj != null)
            {
                if (cb != null)
                {
            ...
            HiddenField obj2 = (HiddenField)e.Row.Cells[7].FindControl("hid_IS_VIRTUAL_SCHOOL");
            CheckBox cb2 = (CheckBox)e.Row.Cells[7].FindControl("cb_IS_VIRTUAL_SCHOOL");
            if (obj2 != null)
            {
                if (cb2 != null)
                {
