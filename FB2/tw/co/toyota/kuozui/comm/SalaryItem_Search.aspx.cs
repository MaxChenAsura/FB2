...
public partial class WebContent_comm_SalaryItem_Search : BasePage
{
    string SALARY_ID = "";
    string isPermissions = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        SALARY_ID = Request.QueryString["SALARY_ID"] == null ? "" : Request.QueryString["SALARY_ID"].ToString();
        isPermissions = Request.QueryString["isPermissions"] == null ? "" : Request.QueryString["isPermissions"].ToString();
    ...
    private void getGridView(string SortExpression)
    {
        ...
        {
            //取得職務代碼並繫結至Gridview
            SalaryItem_Search change = new SalaryItem_Search();
            change.SALARY_ID = SALARY_ID;
            change.SALARY_NAME = txt_SALARY_NAME.Text;
            change.isPermissions = isPermissions;
