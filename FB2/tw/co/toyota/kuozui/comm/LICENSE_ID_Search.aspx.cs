...
public partial class WebContent_comm_LICENSE_ID_Search : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (IDENTITY_KIND != "" || EMP_ID != "" || LICENSE_ID != "")
                getGridView("LICENSE_ID");
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        try
        {
            LICENSE_ID = txt_LICENSE_ID.Text;
            getGridView("LICENSE_ID");
        }
        catch (Exception ex)
        {
    ...
    private void getGridView(string SortExpression)
    {
        ...
        {
            //取得職務代碼並繫結至Gridview
            LICENSE_ID_Search change = new LICENSE_ID_Search();
            change.EMP_ID = EMP_ID;
            change.EMP_NAME = txt_EMP_NAME.Text;
            change.IDENTITY_KIND = IDENTITY_KIND;
            change.LICENSE_ID = LICENSE_ID;
            ...
            gv_result.DataKeyNames = new string[] { "LICENSE_ID" };
            gv_result.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void gv_result_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            RadioButton rdo = (RadioButton)e.Row.FindControl("rbl_LICENSE_ID");

            string script = "SelectOne('gv_result.*rblg_LICENSE_ID',this)";
