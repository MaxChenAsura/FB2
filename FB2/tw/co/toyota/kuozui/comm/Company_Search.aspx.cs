...
public partial class WebContent_comm_Company_Search : BasePage
{
    string COMPANY_CD = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (COMPANY_CD != "")
                txt_COMPANY_CD.Text = COMPANY_CD;
                //getGridView("COMPANY_CD");
        }
    }
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        try
        {
            COMPANY_CD = txt_COMPANY_CD.Text;
            getGridView("COMPANY_CD");
        }
        catch (Exception ex)
        {
    ...
    private void getGridView(string SortExpression)
    {
        ...
        {
            //取得職務代碼並繫結至Gridview
            Company_Search change = new Company_Search();
            change.COMPANY_CD = COMPANY_CD;
            change.COMPANY_NAME = txt_COMPANY_NAME.Text;

            DataTable dt = change.getCompanyData(SortExpression + " " + getSortDirection(SortExpression));
    ...
    protected void btn_confirm_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                RadioButton other = (RadioButton)gv_result.Rows[i].Cells[0].FindControl("rbl_COMPANY_CD");
    ...
    protected void gv_result_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            RadioButton rdo = (RadioButton)e.Row.FindControl("rbl_COMPANY_CD");

            string script = "SelectOne('gv_result.*rblg_COMPANY_CD',this)";
