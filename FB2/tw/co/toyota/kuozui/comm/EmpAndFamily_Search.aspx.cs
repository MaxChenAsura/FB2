...
public partial class WebContent_comm_EmpAndFamily_Search : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txt_LICENCE_ID.Text = LICENSE_ID;
        }
    }
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        try
        {
            LICENSE_ID = txt_LICENCE_ID.Text;
            getGridView("LICENSE_ID");
        }
        catch (Exception ex)
        {
