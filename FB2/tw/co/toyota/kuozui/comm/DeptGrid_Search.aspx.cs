...
public partial class WebContent_comm_DeptGrid_Search : BasePage
{
    string DEPT_NO = "";
    string DEPT_LEVEL = "";
    string DEPT_NO_LIST = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DEPT_NO_LIST = Request.QueryString["DEPT_NO_LIST"] == null ? "" : Request.QueryString["DEPT_NO_LIST"].ToString();
    ...
    private void getGridView(string SortExpression)
    {
        ...
        {
            //取得職務代碼並繫結至Gridview
            DeptGrid_Search change = new DeptGrid_Search();
            change.DEPT_NO = DEPT_NO;
            change.DEPT_NAME = txt_DEPT_NAME.Text;
            change.DEPT_LEVEL = DEPT_LEVEL;
            change.DEPT_NO_LIST = DEPT_NO_LIST;

            DataTable dt = change.getDeptData(SortExpression + " " + getSortDirection(SortExpression));
