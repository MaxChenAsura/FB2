...
public partial class WebContent_WFB2990800_Qry : BasePage 
{
    //宣告BO 物件
    private CFB2990800BO fb299080B0 = new CFB2990800BO();
    ...
    //查詢功能
    protected void WFB2990800Search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                gv_result.Visible = false;
                WFB2990800Delete.Visible = false;
                //WFB2990800Edit.Visible = false;
                ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "error", "alert('查無資料!');", true);
                return;
            }
            if (gv_result.Rows.Count > 0)
            {
                WFB2990800Add.Visible = true;
                WFB2990800Delete.Visible = true;
                //WFB2990800Edit.Visible = true;
                HID_Freeze.Value = "Y";
            }
    ...
    //新增
    protected void WFB2990800Add_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //查詢,清除的按鈕disabled
            WFB2990800Search.Enabled = false;
            ...
            WFB2990800OK.Visible = true;
            btn_cancel.Visible = true;

            WFB2990800Add.Visible = false;
            //WFB2990800Edit.Visible = false;
            WFB2990800Delete.Visible = false;
            gv_result.EditIndex = -1;
    ...
    //修改功能
    /*
    protected void WFB2990800Edit_Click(object sender, EventArgs e)
    {
        try
        {
            gv_result.PagerSettings.Visible = false;   //隱藏GRID的頁碼
    ...
    */
    ...
    //刪除
    protected void WFB2990800Delete_Click(object sender, EventArgs e)
    {
        try
        {
            //檢查勾選項目
            ...
            string msg = fb299080B0.deleteData(keysList);
    ...
    //確認
    protected void WFB2990800OK_Click(object sender, EventArgs e)
    {
       
        try
        {
            CFB2990800DAO ha080DAO ;
            ...
            if (gv_result.Rows.Count == 0)
            {
                ...
                string msg = fb299080B0.insertData(ha080DAO);
                if (msg != "0")
                {
                    gv_result.PagerSettings.Visible = false;   //隱藏GRID的頁碼
            ...
            else
            {
                ...
                else
                {
                    ...
                    string msg = fb299080B0.updateData(ha080DAO);
                    if (msg != "0")
                    {
                        gv_result.PagerSettings.Visible = false;   //隱藏GRID的頁碼
            ...
            //enable查詢清除按鈕
            WFB2990800Search.Enabled = true;
            btn_clear.Disabled = false;

            WFB2990800OK.Visible = false;
