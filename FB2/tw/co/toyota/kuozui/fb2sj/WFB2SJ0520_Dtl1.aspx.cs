...
public partial class WebContent_WFB2SJ0520_Dtl1 : BasePage 
{
    //Service 物件
    ...
    private void initialValue()
    {
        try
        {
            txt_ASSESS_YEAR.Text = hashtable_get("SJ0520_DTL1_ASSESS_YEAR").ToString();
            hid_ASSESS_YEAR.Value = hashtable_get("SJ0520_DTL1_ASSESS_YEAR").ToString();
            txt_ASSESS_TYPE.Text = hashtable_get("SJ0520_DTL1_ASSESS_TYPE").ToString()+"."+hashtable_get("SJ0520_DTL1_ASSESS_TYPE_DESC").ToString();
            hid_ASSESS_TYPE.Value = hashtable_get("SJ0520_DTL1_ASSESS_TYPE").ToString();
            hid_DEPT_LEVEL.Value = hashtable_get("SJ0520_DTL1_DEPT_LEVEL").ToString();
            hid_MA_EMP_ID.Value = hashtable_get("SJ0520_DTL1_MA_EMP_ID").ToString();
           

            this.WFB2SJ0520SituationSearch_Click(null, null);
    ...
    //查詢按鈕事件
    protected void WFB2SJ0520SituationSearch_Click(object sender, EventArgs e)
    {
    ...
    protected void gv_result_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            tcMergeProduct.Text = "部門複核";//雙層Header的名稱
            tcMergeProduct.ColumnSpan = 3;//要跨幾個欄位
            gvHeaderRowCopy.Cells.AddAt(3, tcMergeProduct);//第個欄位開始
