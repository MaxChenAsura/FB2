...
public partial class WebContent_WFB2SJ3700_Dtl3 : BasePage 
{
    //Service 物件
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            gv_result.DataKeyNames = new string[] { "ASSESS_YEAR", "ASSESS_TYPE", "DEPT_NO", "HEAD_EMP_ID" }; //設定GridView Key
    ...
    protected void WFB2SJ3700Back_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int i = 0; i < this.gv_result.Rows.Count; i++)
            {
                ...
                {
                    editindex.Add(i);
                    deptIndex += gv_result.DataKeys[i].Values["DEPT_NO"].ToString();
                }
                //if (deptIndex != "") deptIndex += ";";
            ...
            else
            {
                ...
                sj0510DAO.DEPT_NO = deptIndex;
                sj0510DAO.EMP_ID = SessionHandle.Current.emp_id;
                sj0510DAO.SIGN_YN = "N";
                msg = sj0510BO.backDept(sj0510DAO);
                if (msg != "0")
                {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "alert", "alert('退回完成')", true);
                    this.WFB2SJ3700SituationSearch_Click(null, null);
    ...
    protected void gv_result_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        gv_result.DataSourceID = "ods1";
        gv_result.DataKeyNames = new string[] { "ASSESS_YEAR", "ASSESS_TYPE", "DEPT_NO","HEAD_EMP_ID" };
    }
