...
public partial class WebContent_WFB2SJ3700_Dtl4 : BasePage 
{
    //Service 物件
    ...
    private void initialValue()
    {
        try
        {
            txt_ASSESS_YEAR.Text = hashtable_get("SJ3700_DTL2_ASSESS_YEAR").ToString();
            hid_ASSESS_YEAR.Value = hashtable_get("SJ3700_DTL2_ASSESS_YEAR").ToString();
            txt_ASSESS_TYPE.Text = hashtable_get("SJ3700_DTL2_ASSESS_TYPE").ToString()+"."+hashtable_get("SJ3700_DTL2_ASSESS_TYPE_DESC").ToString();
            hid_ASSESS_TYPE.Value = hashtable_get("SJ3700_DTL2_ASSESS_TYPE").ToString();
            hid_DEPT_NO.Value = hashtable_get("SJ3700_DTL2_DEPT_NO_20").ToString();
    ...
    protected void btn_Approve_Click(object sender, EventArgs e)
    {
        ...
        hashtable_set("SJ3700_DTL2_WS_CD_DESC","");
        hashtable_set("SJ3700_DTL2_WS_CD", "-1");
        hashtable_set("SJ3700_DTL2_SCORE_LEVEL_GROUP_DESC", argStr);

        hashtable_set("SJ3700_DTL2_SCORE_LEVEL_GROUP", argStr);
        if (argStr.Trim() == "") hashtable_set("SJ3700_DTL2_SCORE_LEVEL_GROUP", "-1");
