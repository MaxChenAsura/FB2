...
public partial class WebContent_WFB2SJ0510_Dtl2 : BasePage 
{
    //Service 物件
    ...
    private void initialValue()
    {
        try
        {
            ...
            hid_ASSESS_YEAR.Value = hashtable_get("SJ0510_DTL2_ASSESS_YEAR").ToString();
            hid_ASSESS_TYPE.Value = hashtable_get("SJ0510_DTL2_ASSESS_TYPE").ToString();
            hid_WS_CD.Value = hashtable_get("SJ0510_DTL2_WS_CD").ToString();
            txt_WS_CD.Text = hashtable_get("SJ0510_DTL2_WS_CD").ToString();
            if (hashtable_get("SJ0510_DTL2_SCORE_LEVEL_GROUP").ToString() != "-1")
            {

                txt_SCORE_LEVEL_GROUP.Text = hashtable_get("SJ0510_DTL2_SCORE_LEVEL_GROUP").ToString() + "(不含外數)";
            }
            hid_SCORE_LEVEL_GROUP.Value = hashtable_get("SJ0510_DTL2_SCORE_LEVEL_GROUP").ToString();
            hid_DEPT_NO.Value = hashtable_get("SJ0510_DTL2_DEPT_NO").ToString();
            hid_DEPT_LEVEL.Value = hashtable_get("SJ0510_DTL2_DEPT_LEVEL").ToString();
            hid_DEPT_NO_20.Value = hashtable_get("SJ0510_DTL2_DEPT_NO_20").ToString();
            hid_SIGN_YN.Value = hashtable_get("SJ0510_DTL2_SIGN_YN").ToString();
            hid_SIGN_YN_DEPT.Value = hashtable_get("SJ0510_DTL2_SIGN_YN_DEPT").ToString();
            hid_EMP_ID.Value = hashtable_get("SJ0510_DTL2_EMP_ID").ToString();
            ...
            if (hid_DEPT_LEVEL.Value == "20")
            {
                ...
                if (hid_SUB_DIRC_SIGN_YN.Value == "N" ||hid_SIGN_YN.Value == "Y" || hid_SUB_SIGN_YN.Value=="N") WFB2SJ0510AproveSave.Enabled = false;
            }
            else
            {
                if (hid_SUB_DIRC_SIGN_YN.Value == "N" ||hid_SIGN_YN_DEPT.Value == "Y" || hid_SUB_SIGN_YN.Value == "N") WFB2SJ0510AproveSave.Enabled = false;
            }
            //測試用程式--將確認修改強制開啟
            //WFB2SJ0510AproveSave.Enabled = true;
		   ...
		   //ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "error", "alert('" + hid_DEPT_LEVEL.Value + "');", true);
            ...
            if (hid_DEPT_LEVEL.Value == "20")
            {
                ...
                CFB2SJ0510DAO sj051DAO = new CFB2SJ0510DAO();
           ...
           // if (hid_DEPT_LEVEL.Value != "20" && hid_WS_CD.Value != "G") TABLE_RATE_01.Visible = false;
            ...
            this.WFB2SJ0510ApproveSearch_Click(null, null);
        }
        catch (Exception ex)
        {
    ...
    //查詢按鈕事件
    protected void WFB2SJ0510ApproveSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                WFB2SJ0510AproveSave.Visible = false;
    ...
    //修改確定按鈕事件
    protected void WFB2SJ0510AproveSave_Click(object sender, EventArgs e)
    {
        try
        {
            String errMsg = "";
            ...
            List<CFB2SJ0510DAO> liData = new List<CFB2SJ0510DAO>();
    ...
    private void cleanUpdate()
    {
        ...
        txt_MEMO.Text = "";
        this.setAllocatedData();
        WFB2SJ0510ApproveSearch_Click(null, null);
    }
    ...
    {
        if (hashtable_get("SJ0510_DTL2_EMP_ID") == "")
        {
        ...
        else
        {
            ...
            Response.Redirect("WFB2SJ0510_Qry.aspx");
        }
