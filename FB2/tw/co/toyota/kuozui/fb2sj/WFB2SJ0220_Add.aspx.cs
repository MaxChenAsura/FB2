...
public partial class WebContent_WFB2SJ0220_Add : BasePage
{
    ...
    protected void WFB2SJ0220Save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sj0220DAO.WS_CD = ddl_WS_CD.SelectedValue;
            sj0220DAO.LEVEL_CD = "";
            if(ddl_LEVEL_CD.SelectedValue != "-1")sj0220DAO.LEVEL_CD = ddl_LEVEL_CD.SelectedValue;            
