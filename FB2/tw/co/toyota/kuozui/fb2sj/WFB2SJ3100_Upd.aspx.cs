...
public partial class WebContent_WFB2SJ3100_Upd : BasePage
{
    ...
    private void initialValue()
    {
        try
        {
            ...
            sj3100DAO.DISTING_CD = hashtable_get("SJ3100_UPD_DISTING_CD").ToString();
            logger.Debug(sj3100DAO.DISTING_CD);
            ...
            //基本資料
            dt = sj3100BO.getUpdData(sj3100DAO);
    ...
    protected void WFB2SJ3100Save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            CFB2SJ3100DAO sj3100DAO = new CFB2SJ3100DAO();
            sj3100DAO.DISTING_CD = hid_DISTING_CD.Value.ToUpper();
            sj3100DAO.DISTING_DESC = txt_DISTING_DESC.Text.Replace(",", "");
            ...
            sj3100DAO.USER_UP_YN = hid_USER_UP_YN.Value;
            ...
            msg = sj3100BO.updateITEM(sj3100DAO);
            if (msg != "0")
            {
