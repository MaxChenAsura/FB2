...
public partial class WebContent_WFB2SJ0510_Dtl1 : BasePage 
{
    //Service 物件
    ...
    private void initialValue()
    {
        try
        {
            txt_ASSESS_YEAR.Text = hashtable_get("SJ0510_DTL1_ASSESS_YEAR").ToString();
            hid_ASSESS_YEAR.Value = hashtable_get("SJ0510_DTL1_ASSESS_YEAR").ToString();
            txt_ASSESS_TYPE.Text = hashtable_get("SJ0510_DTL1_ASSESS_TYPE").ToString()+"."+hashtable_get("SJ0510_DTL1_ASSESS_TYPE_DESC").ToString();
            hid_ASSESS_TYPE.Value = hashtable_get("SJ0510_DTL1_ASSESS_TYPE").ToString();
            hid_DEPT_NO.Value = hashtable_get("SJ0510_DTL1_DEPT_NO").ToString();
            hid_DEPT_LEVEL.Value = hashtable_get("SJ0510_DTL1_DEPT_LEVEL").ToString();
            hid_DEPT_NO_20.Value = hashtable_get("SJ0510_DTL1_DEPT_NO_20").ToString();
            hid_DEPT_EMP_ID.Value = hashtable_get("SJ0510_DTL1_DEPT_EMP_ID").ToString();
    ...
    //查詢按鈕事件
    protected void WFB2SJ0510SituationSearch_Click(object sender, EventArgs e)
    {
    ...
    protected void WFB2SJ0510EmpScore_Click(object sender, EventArgs e)
    {
        try
        {
            String empIdIndex = "";
            ...
            else
            {
                ...
                // 儲存 換頁條件
                hashtable_set("SJ0510_SCORE_ASSESS_YEAR", gv_result.DataKeys[editindex[0]].Values["ASSESS_YEAR"].ToString());
                hashtable_set("SJ0510_SCORE_ASSESS_TYPE", gv_result.DataKeys[editindex[0]].Values["ASSESS_TYPE"].ToString());
                hashtable_set("SJ0510_SCORE_EMP_ID", gv_result.DataKeys[editindex[0]].Values["EMP_ID"].ToString());
                hashtable_set("SJ0510_SCORE_EMP_INDEX", editindex[0].ToString());
                hashtable_set("SJ0510_SCORE_EMPS", empIdIndex);
                Response.Redirect("WFB2SJ0510_SCORE.aspx?");
            }
        }
        catch (Exception ex)
        {
