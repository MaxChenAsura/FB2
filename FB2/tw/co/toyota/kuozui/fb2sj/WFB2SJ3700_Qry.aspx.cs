...
public partial class WebContent_WFB2SJ3700_Qry : BasePage
{
    //宣告BO 物件
    ...
    private void initialValue()
    {
        try
        {
            ...
            {
                WFB2SJ3700Search.Enabled = false;
                WFB2SJ3700Situation.Enabled = false;
                WFB2SJ3700Approved.Enabled = false;
                WFB2SJ3700Refer.Enabled = false;
                WFB2SJ3700Statistics.Enabled = false;
                WFB2SJ3700Sign.Enabled = false;
                WFB2SJ3700DeptSign.Enabled = false;
            }
            //取得預設登入者部門資訊
            ...
            {
                WFB2SJ3700Statistics.Visible = false;
                 WFB2SJ3700DeptSign.Visible = true;
                 WFB2SJ3700DeptSign.Enabled = true;
            ...
            {
                WFB2SJ3700Sign.Visible = true;
                WFB2SJ3700Sign.Enabled = true;
                btn_back.Visible = true;
                btn_back.Enabled = true;
            ...
            //測試狀況-自訂義按鈕狀況
            //WFB2SJ3700Approved.Enabled = true;
            //WFB2SJ3700Sign.Enabled = true;
            //GET WSCD Data
    ...
    #region button 事件
    //查詢功能
    protected void WFB2SJ3700Search_Click(object sender, EventArgs e)
    {
        try
        {
            //保留查詢條件
    ...
    protected void WFB2SJ3700Situation_Click(object sender, EventArgs e)
    {
        // 儲存 換頁條件
        hashtable_set("SJ3700_DTL1_ASSESS_YEAR", hid_ASSESS_YEAR.Value);
        hashtable_set("SJ3700_DTL1_ASSESS_TYPE", hid_ASSESS_TYPE.Value);
        hashtable_set("SJ3700_DTL1_ASSESS_TYPE_DESC", txt_ASSESS_TYPE.Text);
        hashtable_set("SJ3700_DTL1_DEPT_NO", hid_DEPT_NO.Value);
        hashtable_set("SJ3700_DTL1_DEPT_EMP_ID", SessionHandle.Current.emp_id);
        hashtable_set("SJ3700_DTL1_DEPT_LEVEL", hid_DEPT_LEVEL.Value);
        hashtable_set("SJ3700_DTL1_DEPT_NO_20", hid_DEPT_NO_20.Value);
        //ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "error", "alert('enter2');", true);
        Response.Redirect("WFB2SJ3700_Dtl1.aspx?");
    }
    protected void WFB2SJ3700Approved_Click(object sender, EventArgs e)
    {
        int iCount = 0;
       ...
       /**
        ...
        setQryField(true);
        // 儲存 換頁條件
        hashtable_set("SJ3700_DTL2_ASSESS_YEAR", hid_ASSESS_YEAR.Value);
        hashtable_set("SJ3700_DTL2_ASSESS_TYPE", hid_ASSESS_TYPE.Value);
        hashtable_set("SJ3700_DTL2_ASSESS_TYPE_DESC", txt_ASSESS_TYPE.Text);
        hashtable_set("SJ3700_DTL2_DEPT_NO", hid_DEPT_NO.Value);
        hashtable_set("SJ3700_DTL2_DEPT_LEVEL", hid_DEPT_LEVEL.Value);
        hashtable_set("SJ3700_DTL2_DEPT_NO_20", hid_DEPT_NO_20.Value);
        hashtable_set("SJ3700_DTL2_WS_CD_DESC", ddl_WS_CD.SelectedItem.Text);
        hashtable_set("SJ3700_DTL2_WS_CD", ddl_WS_CD.SelectedValue);
        hashtable_set("SJ3700_DTL2_SCORE_LEVEL_GROUP_DESC", ddl_SCORE_LEVEL_GROUP.SelectedItem.Text);
        hashtable_set("SJ3700_DTL2_SCORE_LEVEL_GROUP", ddl_SCORE_LEVEL_GROUP.SelectedValue);
        hashtable_set("SJ3700_DTL2_SIGN_YN_DEPT", hid_SIGN_YN_DEPT.Value);
        hashtable_set("SJ3700_DTL2_SIGN_YN", hid_SIGN_YN.Value);
        hashtable_set("SJ3700_DTL2_EMP_ID", txt_EMP_ID.Text);
        ...
        {
            Response.Redirect("WFB2SJ3700_Dtl2.aspx?");
        }
        
    }
    protected void WFB2SJ3700Refer_Click(object sender, EventArgs e)
    {
        string err = "";
        CFB2SJ3700DAO dao = new CFB2SJ3700DAO();
        ...
        Session["workbook_SJ370_R"] = workbook;
        dwnframe.Attributes["src"] = "WFB2SJ3700_Qry.aspx?FileType_SJ370_R = excel";
        Session["FileType_SJ370_R"] = "excel";

      
    }
    protected void WFB2SJ3700Statistics_Click(object sender, EventArgs e)
    {
        string err = "";
        CFB2SJ3700DAO dao = new CFB2SJ3700DAO();
        dao.ASSESS_YEAR = hid_ASSESS_YEAR.Value;
        ...
        Session["workbook_SJ370_S"] = workbook;
        dwnframe.Attributes["src"] = "WFB2SJ3700_Qry.aspx?FileType_SJ370_S = excel";
        Session["FileType_SJ370_S"] = "excel";

      
    }
    protected void WFB2SJ3700Sign_Click(object sender, EventArgs e)
    {
        try
        {
            String msg = "";
    ...
    //修改
    protected void WFB2SJ3700EmpDtl_Click(object sender, EventArgs e)
    {
        try
        {
            //檢查勾選項目
            ...
            else
            {
                ...
                // 儲存 換頁條件
                hashtable_set("SJ3700_EMPDTL_ASSESS_YEAR", gv_result.DataKeys[editindex[0]].Values["ASSESS_YEAR"].ToString());
                hashtable_set("SJ3700_EMPDTL_ASSESS_TYPE", gv_result.DataKeys[editindex[0]].Values["ASSESS_TYPE"].ToString());
                hashtable_set("SJ3700_EMPDTL_DEPT_NO", gv_result.DataKeys[editindex[0]].Values["DEPT_NO"].ToString());
                ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "error", "alert('enter2');", true);
                Response.Redirect("WFB2SJ3700_Dtl.aspx?");
            }
        }
        catch (Exception ex)
        {
    ...
    protected void WFB2SJ3700Back_Click(object sender, EventArgs e)
    {
        // 儲存 換頁條件
        hashtable_set("SJ3700_DTL1_ASSESS_YEAR", hid_ASSESS_YEAR.Value);
        hashtable_set("SJ3700_DTL1_ASSESS_TYPE", hid_ASSESS_TYPE.Value);
        ...
        hashtable_set("SJ3700_DTL1_DEPT_NO_20", hid_DEPT_NO_20.Value);
        //ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "error", "alert('enter2');", true);
        Response.Redirect("WFB2SJ3700_Dtl3.aspx?");
    }
    ...
    public void exportExcel()
    {
        try
        {
            if (Session["FileType_SJ370_R"] != null && Session["FileType_SJ370_R"].ToString() != "")
            {
                string fileType = Session["FileType_SJ370_R"].ToString();

                if (fileType == "excel")
                {
                    IWorkbook workBook = (IWorkbook)Session["workbook_SJ370_R"];
                    Session["FileType_SJ370_R"] = "";
                    Session["workbook_SJ370_R"] = null;

                    ExcelHandle.exportExcel(workBook, "FB2SJ370_REFER_1.xlsx");

                }

            }
            if (Session["FileType_SJ370_S"] != null && Session["FileType_SJ370_S"].ToString() != "")
            {
                string fileType = Session["FileType_SJ370_S"].ToString();

                if (fileType == "excel")
                {
                    IWorkbook workBook = (IWorkbook)Session["workbook_SJ370_S"];
                    Session["FileType_SJ370_S"] = "";
                    Session["workbook_SJ370_S"] = null;

                    ExcelHandle.exportExcel(workBook, "FB2SJ370_Statistics_1.xlsx");
    ...
    private void getQryField()
    {
        try
        {
            if (hashtable_get("SJ3700_Is_Search").ToString() == "Y")
            {
                txt_ASSESS_YEAR.Text = hashtable_get("SJ3700_txt_ASSESS_YEAR").ToString();
                hid_ASSESS_YEAR.Value = hashtable_get("SJ3700_txt_ASSESS_YEAR").ToString();
                txt_ASSESS_TYPE.Text = hashtable_get("SJ3700_txt_ASSESS_TYPE").ToString();
                hid_ASSESS_TYPE.Value = hashtable_get("SJ3700_txt_ASSESS_TYPE").ToString();
                txt_EMP_ID.Text = hashtable_get("SJ3700_txt_EMP_ID").ToString();
                txt_EMP_NAME.Text = hashtable_get("SJ3700_txt_EMP_NAME").ToString();
                ddl_SCORE_FINAL.SelectedValue = hashtable_get("SJ3700_ddl_SCORE_FINAL").ToString();
                ddl_WS_CD.SelectedValue = hashtable_get("SJ3700_ddl_WS_CD").ToString();
                ddl_SCORE_LEVEL_GROUP.SelectedValue = hashtable_get("SJ3700_ddl_SCORE_LEVEL_GROUP").ToString();
                ddl_RECOMM_DESC.SelectedValue = hashtable_get("SJ3700_ddl_RECOMM_DESC").ToString();
    ...
    private void setQryField(bool clear)
    {
        if (clear)
        {
            ...
            hashtable_set("SJ3700_txt_ASSESS_YEAR", hid_ASSESS_YEAR.Value);
            hashtable_set("SJ3700_txt_ASSESS_TYPE", txt_ASSESS_TYPE.Text);
            hashtable_set("SJ3700_txt_ASSESS_TYPE", hid_ASSESS_TYPE.Value);
            hashtable_set("SJ3700_txt_EMP_ID", txt_EMP_ID.Text);
            hashtable_set("SJ3700_txt_EMP_NAME", txt_EMP_NAME.Text);
            hashtable_set("SJ3700_ddl_SCORE_FINAL", ddl_SCORE_FINAL.SelectedValue);
            hashtable_set("SJ3700_ddl_WS_CD", ddl_WS_CD.SelectedValue);
            hashtable_set("SJ3700_ddl_SCORE_LEVEL_GROUP", ddl_SCORE_LEVEL_GROUP.SelectedValue);
            hashtable_set("SJ3700_ddl_RECOMM_DESC", ddl_RECOMM_DESC.SelectedValue);
        }
        else
        {
