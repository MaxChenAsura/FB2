...
public partial class WebContent_WFB2SJ0410_Upd : BasePage
{
    ...
    private void initialValue()
    {
        try
        {
            ...
            txt_ASSESS_YEAR.Text = hashtable_get("SJ0410_UPD_ASSESS_YEAR").ToString();
            hid_ASSESS_YEAR.Value = hashtable_get("SJ0410_UPD_ASSESS_YEAR").ToString();
            txt_ASSESS_TYPE.Text = hashtable_get("SJ0410_UPD_ASSESS_TYPE_DESC").ToString();
            hid_ASSESS_TYPE.Value = hashtable_get("SJ0410_UPD_ASSESS_TYPE").ToString();
            txt_EMP_ID.Text = hashtable_get("SJ0410_UPD_EMP_ID").ToString();
            ...
            CFB2SJ0410DAO daoObj = new CFB2SJ0410DAO();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                ddl_SUGGEST_SCORE.SelectedValue = dt.Rows[0]["SUGGEST_SCORE"].ToString();
                ...
                WFB2SJ0410FileDown.Text = dt.Rows[0]["SUGGEST_FILE_NAME"].ToString();
                ...
                hid_SUGGEST_FILE_NAME.Value = dt.Rows[0]["SUGGEST_FILE_NAME"].ToString();
                WFB2SJ0410FileDown.Text = dt.Rows[0]["SUGGEST_FILE_NAME"].ToString();
                if (dt.Rows[0]["SUGGEST_FILE_NAME"].ToString() != "") WFB2SJ0410FileDown.Visible = true;
                if (dt.Rows[0]["AUDRESULT1_YN"].ToString() == "Y" || dt.Rows[0]["AUDRESULT1_YN"].ToString() == "N")
                {
                    WFB2SJ0410Save_A.Visible = false;
                    ddl_SUGGEST_SCORE.Enabled = false;
                    FileUpload1.Visible = false;
                    WFB2SJ0410FileUpload.Visible = false;
                    txt_SUGGEST_REMARK.Enabled = false;
                }
            }
    ...
    protected void WFB2SJ0410Save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sj0410DAO.FUNC_ID = "FB2SJ0410";
             ...
             msg = sj0410BO.updateEMP_SUGGEST(sj0410DAO);
            if (msg != "0")
            {
