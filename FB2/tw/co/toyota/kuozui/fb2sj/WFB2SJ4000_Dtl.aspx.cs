...
public partial class WebContent_WFB2SJ4000_Dtl : BasePage
{
    //宣告BO 物件
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CFB2SJ4000DAO sj030DAO = new CFB2SJ4000DAO();
        ...
        if (!IsPostBack)
        {
            ...
            WFB2SJ4001Search_Click(sender, e);
        ...
        if (sj030DAO.APPROVE_STATUS == "Y" || sj030DAO.RELEASE_DT == "")
        {
            ...
            //WFB2SJ4000Approve.Enabled = false;
            //WFB2SJ4000Reject.Enabled = false;
            //WFB2SJ4000Mark.Enabled = false;
    ...
    //取得表頭資料
    private void showTitle(CFB2SJ4000DAO sj030DAO)
    {
    ...
    private void hideFreezeButton(bool isEnabled)
    {
        if (isEnabled)
        {
            WFB2SJ4000Mark.Enabled = true;
            WFB2SJ4000Approve.Enabled = true;
            WFB2SJ4000Reject.Enabled = true;
            WFB2SJ4000Mark.Enabled = true;
    ...
    //回上一頁
    protected void WFB2SJ4000Back_Click(object sender, EventArgs e)
    {
        Session["SJ4000_Is_Search"] = "Y";
        Response.Redirect("WFB2SJ4000_Qry.aspx");

    }
    //查詢
    protected void WFB2SJ4001Search_Click(object sender, EventArgs e)
    {
        try
        {
    ...
    //核可
    protected void WFB2SJ4000Approve_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                Session["SJ4000_Is_Search"] = "Y";
                ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "Message", "alert('" + Resources.Resource.wfb2sh_alert_approvesuccess + "');$(location).attr('href','WFB2SJ4000_Qry.aspx');", true);

            }
            //getGridView(ViewState["SortExpression"].ToString(), (int)ViewState["NewPageIndex"], 10000);
            //WFB2SJ4000Back_Click(sender, e);
            //WFB2SJ4001Search_Click(sender, e);
        }
        catch (Exception ex)
        {
    ...
    //駁回
    protected void WFB2SJ4000Reject_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                Session["SJ4000_Is_Search"] = "Y";
                ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "Message", "alert('" + Resources.Resource.wfb2sh_alert_rejectsuccess + "');$(location).attr('href','WFB2SJ4000_Qry.aspx');", true);
    ...
    //一括異常註記
    protected void WFB2SJ4000Mark_Click(object sender, EventArgs e)
    {
        try
        {
            //多個PK值使用
    ...
    //考核結果下載
    protected void WFB2SJ4000ExcelDown_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //先刪除原始的檔案
            File.Delete(Server.MapPath("~/ExcelTemplate/DownloadFile/FB2SJ400_1_" + SessionHandle.Current.emp_id + ".xlsx"));
            ...
            FileStream file = new FileStream(@toPath + "/FB2SJ400_1_" + SessionHandle.Current.emp_id + ".xlsx", FileMode.Create);//產生檔案
            workbook.Write(file);
            file.Close();
            workbook.Clear();
            
            //Session["workbook_SJ4000"] = workbook;
            dwnframe.Attributes["src"] = "WFB2SJ4000_Dtl.aspx?FileType_SJ4000=excelResult";
            Session["FileType_SJ4000"] = "excelResult";
            if (workbook != null)
            {
    ...
    public void exportExcel()
    {
        try
        {
            if (Session["FileType_SJ4000"] != null && Session["FileType_SJ4000"].ToString() != "")
            {
                string FileType_SJ4000 = Session["FileType_SJ4000"].ToString();
                if (FileType_SJ4000 == "excelResult")
                {
                    //IWorkbook workBook = (IWorkbook)Session["workbook_SJ4000"];
                    //Session["workbook_SJ4000"] = null;
                    //ExcelHandle.exportExcel(workBook, "FB2SJ400_1.xlsx");
                    Session["FileType_SJ4000"] = "";
                    ExcelHandle.excel_Down(Server.MapPath("~/ExcelTemplate/DownloadFile/FB2SJ400_1_" + SessionHandle.Current.emp_id + ".xlsx"), "FB2SJ400_1.xlsx");
                }
            }
        }
        catch (Exception ex)
