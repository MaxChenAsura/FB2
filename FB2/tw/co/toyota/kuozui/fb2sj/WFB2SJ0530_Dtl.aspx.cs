...
public partial class WebContent_WFB2SJ0530_Dtl : BasePage 
{
    //Service 物件
    ...
    private void initialValue()
    {
        try
        {
            ...
            sj0500DAO.ASSESS_YEAR = hashtable_get("SJ0530_DTL_ASSESS_YEAR").ToString();
            sj0500DAO.ASSESS_TYPE = hashtable_get("SJ0530_DTL_ASSESS_TYPE").ToString();
            sj0500DAO.EMP_ID = hashtable_get("SJ0530_DTL_EMP_ID").ToString();
            assess_year = hashtable_get("SJ0530_DTL_ASSESS_YEAR").ToString();
            assess_type = hashtable_get("SJ0530_DTL_ASSESS_TYPE").ToString();
            ...
            this.WFB2SJ0530EmpDtlSearch_Click(null, null);
            getGridViewlog("ASSESS_YEAR", hashtable_get("SJ0530_DTL_ASSESS_YEAR").ToString(), hashtable_get("SJ0530_DTL_ASSESS_TYPE").ToString(), hashtable_get("SJ0530_DTL_EMP_ID").ToString());
            //setDefaultScore();
        }
        catch (Exception ex)
        {
    ...
    //查詢按鈕事件
    protected void WFB2SJ0530EmpDtlSearch_Click(object sender, EventArgs e)
    {
    ...
    protected void WFB2SJ0530Export_Click(object sender, EventArgs e)
    {
        string err = "";
    
        //有block
        IWorkbook workbook = sj0530BO.createstatisticsExcel(hashtable_get("SJ0530_DTL_ASSESS_YEAR").ToString(), hashtable_get("SJ0530_DTL_ASSESS_TYPE").ToString(), hashtable_get("SJ0530_DTL_EMP_ID").ToString(), "xlsx");
        if (workbook != null)
        {
        ...
        Session["workbook_SJ053"] = workbook;
        dwnframe.Attributes["src"] = "WFB2SJ0530_Dtl.aspx?FileType_SJ053 = excel";
        Session["FileType_SJ053"] = "excel";
    ...
    private void getGridViewlog(string SortExpression, string assess_year, string assess_type, string emp_id)
    {
        ...
        {
            //取得職務代碼並繫結至Gridview
            CFB2SJ0530DAO dao = new CFB2SJ0530DAO();
    ...
    {
        hashtable_set("SJ0530_Is_Search", "Y");
        Response.Redirect("WFB2SJ0530_Qry.aspx");
    }
    //將Session 的workbook 匯出Excel
    public void exportExcel()
    {
        try
        {
            if (Session["FileType_SJ053"] != null && Session["FileType_SJ053"].ToString() != "")
            {
                string fileType = Session["FileType_SJ053"].ToString();

                if (fileType == "excel")
                {
                    IWorkbook workBook = (IWorkbook)Session["workbook_SJ053"];
                    Session["FileType_SJ053"] = "";
                    Session["workbook_SJ053"] = null;

                    ExcelHandle.exportExcel(workBook, "FB2SJ053_SCORE_1.xlsx");
