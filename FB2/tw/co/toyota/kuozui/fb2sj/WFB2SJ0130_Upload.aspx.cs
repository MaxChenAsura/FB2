...
public partial class WebContent_fb2hb_WFB2SJ0130_Upload : BasePage
{
    //Service 物件
    private CFB2SJ0130BO sj013BO = new CFB2SJ0130BO();
    ...
    public void exportExcel()
    {
        try
        {
            ...
            if (Session["FileType_SJ0130"] != null && Session["FileType_SJ0130"].ToString() != "")
            {
                string FileType_SJ0130 = Session["FileType_SJ0130"].ToString();
                if (FileType_SJ0130 == "excel")
                {
                    ...
                    IWorkbook workBook = (IWorkbook)Session["workbook_SJ0130"];
                    Session["FileType_SJ0130"] = "";
                    Session["workbook_SJ0130"] = null;
    ...
    //上傳
    protected void WFB2SJ0130Upload_Click(object sender, EventArgs e)
    {
        try
        {
            if (FileUpload1.HasFile)
            {
                ...
                else
                {
                    ...
                    workbook.Clear();
                    #endregion
                    Session["workbook_SJ0130"] = workbook;
                    dwnframe.Attributes["src"] = "WFB2SJ0130_Upload.aspx?FileType_SJ0130=excel";
                    Session["FileType_SJ0130"] = "excel";
    ...
    {
        Session["SJ0130_Is_Search"] = "Y";
        Response.Redirect("WFB2SJ0130_Qry.aspx");
    }
}