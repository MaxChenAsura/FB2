...
public partial class WebContent_WFB2SJ0510_Dtl4 : BasePage 
{
    //Service 物件
    ...
    private void initialValue()
    {
        try
        {
            txt_ASSESS_YEAR.Text = hashtable_get("SJ0510_DTL2_ASSESS_YEAR").ToString();
            hid_ASSESS_YEAR.Value = hashtable_get("SJ0510_DTL2_ASSESS_YEAR").ToString();
            txt_ASSESS_TYPE.Text = hashtable_get("SJ0510_DTL2_ASSESS_TYPE").ToString()+"."+hashtable_get("SJ0510_DTL2_ASSESS_TYPE_DESC").ToString();
            hid_ASSESS_TYPE.Value = hashtable_get("SJ0510_DTL2_ASSESS_TYPE").ToString();
            hid_DEPT_NO.Value = hashtable_get("SJ0510_DTL2_DEPT_NO_20").ToString();
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            if (ViewState["SortExpression"] == null)
                getSortDirection("SCORE_LEVEL_GROUP ", "ASC");
            //GridView基本設定
            gv_result.PageIndex = 0;
            gv_result.PageSize = pagesize;
            gv_result.DataSourceID = "ods1";
            gv_result.DataKeyNames = new string[] {  "SCORE_LEVEL_GROUP" }; //設定GridView Key
    ...
    protected void getData()
    {
        try
        {
            ...
            {
                getGridView("SCORE_LEVEL_GROUP ", 0, 1000);
    ...
    protected void btn_Approve_Click(object sender, EventArgs e)
    {
        ...
        hashtable_set("SJ0510_DTL2_WS_CD_DESC","");
        hashtable_set("SJ0510_DTL2_WS_CD", "-1");
        hashtable_set("SJ0510_DTL2_SCORE_LEVEL_GROUP_DESC", argStr);

        hashtable_set("SJ0510_DTL2_SCORE_LEVEL_GROUP", argStr);
        if (argStr.Trim() == "") hashtable_set("SJ0510_DTL2_SCORE_LEVEL_GROUP", "-1");
