...
public partial class WebContent_WFB2SJ3900_Qry : BasePage
{
    //宣告BO 物件
    private CFB2SJ3900BO sj020BO = new CFB2SJ3900BO();
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            Session["SJ3900_ddlPerPageRow"] = ViewState["PerPageRow"];
        }
        catch (Exception ex)
        {
    ...
    protected void gv_result_DataBound(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < gv_result.Rows.Count; i++)
        {
            ...
            Button btn_detail = (Button)gv_result.Rows[i].FindControl("WFB2SJ3900Detail");
            //新增,修改時
	 ...
	 protected void gv_result_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ToDetail")
        {
            ...
            Response.Redirect("WFB2SJ3900_Dtl.aspx?"
    ...
    //查詢功能
    protected void WFB2SJ3900Search_Click(object sender, EventArgs e)
    {
        try
        {
            //保留查詢條件
            ...
            {
                WFB2SJ3900Add.Visible = true;
                WFB2SJ3900Delete.Visible = true;
                WFB2SJ3900Execute.Visible = true;
                WFB2SJ3900Release.Visible = true;
                WFB2SJ3900Announce.Visible = true;
                HID_Freeze.Value = "Y";
            }
            else {
                WFB2SJ3900Add.Visible = true;
                WFB2SJ3900Delete.Visible = false;
                WFB2SJ3900Execute.Visible = false;
                WFB2SJ3900Release.Visible = false;
                WFB2SJ3900Announce.Visible = false;
            ...
            deleteFile(topath);
            CFB2SJ3900DAO sj020DAO = new CFB2SJ3900DAO();
    ...
    //新增
    protected void WFB2SJ3900Add_Click(object sender, EventArgs e)
    {
        try
        {
            //查詢,清除的按鈕disabled
            WFB2SJ3900Search.Enabled = false;
            ...
            WFB2SJ3900OK.Visible = true;
            btn_cancel.Visible = true;

            WFB2SJ3900Add.Visible = false;
            WFB2SJ3900Delete.Visible = false;
            WFB2SJ3900Execute.Visible = false;
            WFB2SJ3900Release.Visible = false;
            WFB2SJ3900Announce.Visible = false;
    ...
    //刪除
    protected void WFB2SJ3900Delete_Click(object sender, EventArgs e)
    {
        try
        {
            //存放PK值,(適用於PK值只有一個的情形)
    ...
    //確認
    protected void WFB2SJ3900OK_Click(object sender, EventArgs e)
    {
       
        try
        {
            CFB2SJ3900DAO sj020DAO =null;
            ...
            //enable查詢清除按鈕
            WFB2SJ3900Search.Enabled = true;
            btn_clear.Disabled = false;

            WFB2SJ3900OK.Visible = false;
    ...
    //對象生成
    protected void WFB2SJ3900Execute_Click(object sender, EventArgs e)
    {
        try
        {
            //檢查勾選項目
    ...
    //提出核可
    protected void WFB2SJ3900Release_Click(object sender, EventArgs e)
    {
        try
        {
            //檢查勾選項目
    ...
    //考核發佈
    protected void WFB2SJ3900Announce_Click(object sender, EventArgs e)
    {
        try
        {
            //檢查勾選項目
    ...
    protected void keepConditions(bool clear) {
        if (clear)
        {
            Session["SJ3900_txt_ASSESS_YEAR_S"] = txt_ASSESS_YEAR_S.Text;
            Session["sJ0200_txt_ASSESS_YEAR_E"] = txt_ASSESS_YEAR_E.Text;
            Session["SJ3900_ddl_ASSESS_TYPE"] = ddl_ASSESS_TYPE.SelectedValue;
        }
        else {
            Session["SJ3900_Is_Search"] = "N";
        }
    }
    ...
    protected void realeaseConditions()
    {
        try
        {
            if (Session["SJ3900_Is_Search"] == "Y")
            {
                txt_ASSESS_YEAR_S.Text = Session["SJ3900_txt_ASSESS_YEAR_S"].ToString();
                txt_ASSESS_YEAR_E.Text = Session["sJ0200_txt_ASSESS_YEAR_E"].ToString();
                ddl_ASSESS_TYPE.SelectedValue = Session["SJ3900_ddl_ASSESS_TYPE"].ToString();
                ViewState["PerPageRow"] = Session["SJ3900_ddlPerPageRow"].ToString();
                WFB2SJ3900Search_Click(null, null);
