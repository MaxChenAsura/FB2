...
public partial class WebContent_WFB2SS0500_Dtl : BasePage
{
    //宣告BO 物件
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txt_SALARY_DT.Text = hashtable_get("SS0500_DTL_SALARY_DT").ToString();
            txt_INCENTIVE_DESC.Text = hashtable_get("SS0500_DTL_INCENTIVE_DESC").ToString();
            hid_INCENTIVE_TYPE.Value = hashtable_get("SS0500_DTL_INCENTIVE_TYPE").ToString();
            txt_PRE_STATUS.Text = hashtable_get("SS0500_DTL_STATUS_DESC").ToString();
        ...
        //自動查詢
        WFB2SS0500Search_Click(sender,e);
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            gv_result.DataKeyNames = new string[] { "SALARY_DT", "INCENTIVE_TYPE" }; //設定GridView Key
            gv_result.DataBind();
    ...
    protected void btn_back_Click(object sender, EventArgs e)
    {
        try
        {
            hashtable_set("SS0500_Is_Search", "Y");
            Response.Redirect("WFB2SS0500_Qry.aspx");
        }
        catch (Exception ex)
        {
            logger.Error(ex.Message);
