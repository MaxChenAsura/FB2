...
public partial class WebContent_fb2di_WFB2DI0800_Dtl : BasePage
{
    //Service 物件
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            gv_result.DataKeyNames = new string[] { "APPLY_OVERTIME_DT", "OVERTIME_DT_TYPE" }; //設定GridView Key
            //gv_result.DataBind();
    ...
    protected void btn_back_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("WFB2DI0800_Qry.aspx");
    }
}