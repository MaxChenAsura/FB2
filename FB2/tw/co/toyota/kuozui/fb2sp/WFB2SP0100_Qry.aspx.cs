...
public partial class WebContent_WFB2SP0100_Qry : BasePage
{
    CFB2SP0100BO sp010BO = new CFB2SP0100BO();
    ...
    //執行
    protected void WFB2SP0100Execute_Click(object sender, EventArgs e)
    {
        try
        {
            //資料檢核
            ...
            CFB2SP0100DAO sp010DAO = new CFB2SP0100DAO();
            sp010DAO.COMPUTER_TYPE = ddl_COMPUTER_TYPE.SelectedValue;
            sp010DAO.EMP_ID=txt_EMP_ID.Text;
            sp010DAO.RETIRE_DT=txt_RETIRE_DT.Text;
            sp010DAO.DELEGATE_YN=ddl_DELEGATE_YN.SelectedValue;
            sp010DAO.DELEGATE_DT=txt_DELEGATE_DT.Text;
            sp010DAO.CREATED_BY = SessionHandle.Current.emp_id;
            string msg = sp010BO.execute(sp010DAO);
