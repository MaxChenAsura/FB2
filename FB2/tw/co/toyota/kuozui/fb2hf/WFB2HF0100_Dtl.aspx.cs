...
public partial class WebContent_fb2hb_WFB2HF0100_Dtl : BasePage
{
    //Service 物件
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["HF0100_DTL_EMP_ID"] == null)
            {
                emp_id = SessionHandle.Current.emp_id;
            }
            else {
                emp_id = Session["HF0100_DTL_EMP_ID"].ToString();
            }
