...
public partial class WebContent_fb2dh_WFB2DH0900_Qry : BasePage
{
    string fn = "";
    ...
    //Service 物件
    private CFB2DH0900BO dh090BO = new CFB2DH0900BO();
    ...
    protected void WFB2DH0900Search_Click(object sender, EventArgs e)
    {
        try
        {
            /*
            ...
            */
            ...
            //GridView有分頁此段必加 begin
            if (ViewState["PerPageRow"] != null && ViewState["PerPageRow"].ToString() != "")
                getGridView("EMP_ID,APPLY_OVERTIME_DT", 0, Convert.ToInt32(ViewState["PerPageRow"]));
            else
                getGridView("EMP_ID,APPLY_OVERTIME_DT", 0, 10);
            //end
