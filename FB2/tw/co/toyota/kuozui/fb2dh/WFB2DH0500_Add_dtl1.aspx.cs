...
public partial class WebContent_fb2dh_WFB2DH0500_Add_dtl1 : BasePage
{
    string emp_id = "";
    string emp_name = "";
    string dept_name = "";
    string iflow_approve_dt = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            iflow_approve_dt = Request.QueryString["iflow_approve_dt"].ToString();
            if (!IsPostBack)
            {
                txt_EMP_ID.Text = emp_id;
                txt_EMP_NAME.Text = emp_name;
                txt_DEPT_NAME.Text = dept_name;
                txt_IFLOW_APPROVE_DT1.Text = iflow_approve_dt;
                WFB2DH0500Search_Click(sender, e);
            }
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            if (ViewState["SortExpression"] == null)
                getSortDirection("EMP_ID,MAIN_LEAVE_CD,SUB_LEAVE_CD");
    ...
    protected void WFB2DH0500Search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //GridView有分頁此段必加 begin
            if (ViewState["PerPageRow"] != null && ViewState["PerPageRow"].ToString() != "")
                getGridView("EMP_ID,MAIN_LEAVE_CD,SUB_LEAVE_CD", 0, Convert.ToInt32(ViewState["PerPageRow"]));
            else
                getGridView("EMP_ID,MAIN_LEAVE_CD,SUB_LEAVE_CD", 0, 10);
            //end
