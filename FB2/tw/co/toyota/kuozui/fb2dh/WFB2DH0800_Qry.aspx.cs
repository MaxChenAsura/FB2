...
public partial class WebContent_fb2dh_WFB2DH0800_Qry : BasePage
{
    string fn = "";
    ...
    //Service 物件
    private CFB2DH0800BO service = new CFB2DH0800BO();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            txt_BASE_YEAR.Text = DateTime.Now.ToString("yyyy");
    ...
    private void getGridView(string SortExpression, int pageindex, Int32 pagesize)
    {
        try
        {
            ...
            if (ViewState["SortExpression"] == null)
                getSortDirection("BASE_YEAR desc,MAIN_LEAVE_CD,SUB_LEAVE_CD");
    ...
    protected void WFB2DH0800Search_Click(object sender, EventArgs e)
    {
        try
        {
            //判斷是否有權限查詢此人
