...
public partial class WebContent_fb2dh_WFB2DH0400_Qry_Leave1 : BasePage
{
    ...
    //private void getL1Date()
    //{
    //    try
    //    {
    //        DataTable dt = service.getL1Data(emp_id, iflow_no);
    //        if (dt.Rows.Count > 0)
    //        {
    //            //txt_APPLY_LEAVE_SDT.Text = dt.Rows[0]["NOWDATE"].ToString();
