...
public partial class WebContent_fb2se_WFB2SE2100_Dtl : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txt_APPROVE_STATUS_NAME.Text = Request.QueryString["APPROVE_STATUS_NAME"];
            txt_MEM_CREATE_BY.Text = Request.QueryString["MEM_CREATE_BY"];
            txt_MEM_CREATE_DT.Text = Request.QueryString["MEM_CREATE_DT"];
    ...
    protected void WFB2SE2101Search_Click(object sender, EventArgs e)
    {
        try
        {
    ...
    protected void btn_backpage_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("WFB2SE2100_Qry.aspx");
    }
    protected void txt_EMP_ID_TextChanged(object sender, EventArgs e)
    {
        CFB2SE2100DAO dao = new CFB2SE2100DAO();
