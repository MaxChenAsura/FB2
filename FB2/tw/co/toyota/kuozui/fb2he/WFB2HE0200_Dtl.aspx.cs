...
public partial class WebContent_WFB2HE_WFB2HE0200_Dtl : BasePage
{
    //Service 物件
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        parentFuncId = Request.QueryString["parentFuncId"].ToString();
        ...
        {            
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {                    
                    ...
                    txt_ADOPT_BY.Text = dt.Rows[i]["ADOPT_NAME"].ToString();
    ...
    {
        if (parentFuncId == "FB2HE020")
        {
            Session["HE0200_Is_Search"] = "Y";
            Response.Redirect("WFB2HE0200_Qry.aspx?parentFuncId=FB2HE020&fn=FB2HE020");
        }

        if (parentFuncId == "FB2HE030")
        {
            Session["HE0300_Is_Search"] = "Y";
            Response.Redirect("WFB2HE0300_Qry.aspx?parentFuncId=FB2HE030&fn=FB2HE030");
        }
    }
