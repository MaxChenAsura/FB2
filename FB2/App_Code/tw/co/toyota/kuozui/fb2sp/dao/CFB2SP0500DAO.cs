...
/// CFB2SP0500DAO 的摘要描述
/// </summary>
public class CFB2SP0500DAO : BaseDAO
{
    //dj030基本欄位
    ...
    public void updateCLOSE_YN()
    {
        try
        {
            ...
            sb.Append(" update TB_S_M_OLD_PENSION_H ");
    ...
    public DataTable geExceltData()
    {
        try
        {
            ...
            sb.Append(" from TB_S_M_OLD_PENSION_D a ");
            sb.Append(" left join TB_H_M_EMP b on a.EMP_ID=b.EMP_ID ");
            sb.Append(" left join  TB_S_M_OLD_PENSION_H H on a.EMP_ID=H.EMP_ID and a.COMPUTER_TYPE=H.COMPUTER_TYPE ");
            sb.Append(" where 1=1 ");
    ...
    public DataTable geExceltDataH()
    {
        try
        {
            ...
            sb.Append(" Select ");
            sb.Append(@" SPECIAL_PAY,OTHER_PAY,AVG_PAY,WORK_YEARS,OLDRETIRE_YEARS,OLDRETIRE_YEARS_YMD,STOP_YEARS_YMD,APR_OLDRETIRE_YEARS,
                                        STOP_YY,STOP_MM,STOP_DD,APR_OLDRETIRE_YEARS_YMD,convert(varchar(10), NEW_YEARS_DT,111) NEW_YEARS_DT,NEWE_YEARS_YMD,RETIRE_BASE_MONTH,RETIRE_PAY,REWARD_PAY
                                ");
                           ...
                           )
    {
        try
        {
            ...
            sb.Append(" a.*  ,iif(a.CLOSE_YN='Y', 'Y-是','N-否') as CLOSE_YN_DESC ");
            sb.Append(" ,b.EMP_NAME  ");
            sb.Append(" from TB_S_M_OLD_PENSION_H a ");
            sb.Append(" left join TB_H_M_EMP b on a.EMP_ID=b.EMP_ID ");
            sb.Append(" where 1=1 ");
                           ...
                           )
    {
        try
        {
            ...
            sb.Append(" Select * From");
            sb.Append(" (Select ROW_NUMBER() OVER(ORDER BY " + sortExpression + ") As RowNumber,");
            sb.Append(" a.*,H.CALENDAR_SUMDAY,H.TOTAL_PAY,H.SPECIAL_PAY,H.OTHER_PAY   ");
            sb.Append(" from TB_S_M_OLD_PENSION_D a ");
            sb.Append(" left join  TB_S_M_OLD_PENSION_H H on a.EMP_ID=H.EMP_ID and a.COMPUTER_TYPE=H.COMPUTER_TYPE ");
            sb.Append(" where 1=1 ");
