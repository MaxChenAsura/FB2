...
/// CFB2SD130BO 的摘要描述
/// </summary>
public class CFB2SD1300DAO : BaseDAO
{
    public CFB2SD1300DAO()
    {
        //
        // TODO: 在這裡新增建構函式邏輯
        //
    ...
    public DataTable searchResult2_1(string REMIT_DT2, string SALARY_TYPE2, string SALARY_ID2)
    {
        try
        {
            ...
            sb.Append("  left join TB_S_R_FESTIVAL_D c on b.FESTIVAL_TYPE=c.FESTIVAL_TYPE and b.FESTIVAL_DT=c.FESTIVAL_DT and a.SALARY_DT=b.FESTIVAL_PAY_DT and a.EMP_ID=c.EMP_ID			");
            sb.Append("  left join TB_9_M_COMM_D e on e.SYS_CD='SG' and e.MAIN_CD='FESTIVAL_TYPE' and e.SUB_CD=c.FESTIVAL_TYPE			");
            sb.Append("  where c.COMPANY_CD='T' AND a.SALARY_DT = '" + REMIT_DT2 + "' and a.SALARY_TYPE=@SALARY_TYPE");
            sb.Append("  and a.PAY_KIND= @SALARY_ID2 and SALARY_ID<>'4001' ");
            sb.Append("  group by a.EMP_ID,c.EMP_NAME,c.DEPT_NO,c.PLANT_CD,c.PJOB_CD,c.JOIN_DT,c.EMP_CD,c.WS_CD,c.WORK_YEARS,e.SUB_DESC ");
           
            ht.Add("@SALARY_TYPE", SALARY_TYPE2);
            ht.Add("@SALARY_ID2", SALARY_ID2);
    ...
    public DataTable tabAA(string REMIT_DT2)//, string SALARY_TYPE2
    {
        try
        {
            ...
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("  select a.SALARY_DT,a.SALARY_YM from TB_S_M_SALARY_PAY_H a ");
            sb.Append("  where  a.SALARY_TYPE='C' and a.REMIT_DT = @REMIT_DT2 ");

            ht.Add("@REMIT_DT2", REMIT_DT2);
    ...
    public DataTable Btab(string REMIT_DT2)//, string SALARY_TYPE2
    {
        try
        {
            ...
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("  select a.SALARY_DT,a.SALARY_ID		");
            sb.Append("  from TB_S_M_SALARY_CAL_D a ");

            sb.Append("  where a.SALARY_ID = '1038' and a.SALARY_DT = @REMIT_DT2 and a.SALARY_TYPE='C'");
    ...
    public DataTable searchResult2_3(string REMIT_DT2)//, string SALARY_TYPE2)
    {
        try
        {
            ...
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("  	 select b.SALARY_DT,c.HR_CHG_DESC,a.ORI_DEPT_NO,a.ORI_DIV_DEPT_FULL_NAME,a.EMP_ID,d.EMP_NAME,b.BASIC_SALARY,Convert(varchar(10),a.START_DT,111) as START_DT,Convert(varchar(10),isnull(a.PLAN_END_DT,a.END_DT) ,111) as ad,Convert(varchar(10), a.END_DT ,111) as END_DT,			");
            ...
            sb.Append("       where b.SALARY_DT = @REMIT_DT2 and  a.COMPANY_CD='T' and b.BONUS_TYPE in ('2','3') ");
    ...
    //public DataTable searchResult2_2(string REMIT_DT2, string SALARY_TYPE2)
    //{
    //    try
    //    {
    ...
    //        sb.Append("  where  a.SALARY_ID='1038'  AND a.SALARY_DT = '" + REMIT_DT2 + "' and a.SALARY_TYPE=@SALARY_TYPE and b.COMPANY_CD='T'");
    //        ht.Add("@SALARY_TYPE", SALARY_TYPE2);
    ...
    //    }
    //}
    //public DataTable searchResult2(string REMIT_DT2,  string SALARY_TYPE2)
    //{
    //    try
    //    {
    ...
    //        StringBuilder sb = new StringBuilder();
    //        Hashtable ht = new Hashtable();
    //        sb.Append(" select DISTINCT c.EMP_ID,c.EMP_NAME,c.WORK_DAYS_MONTH,d.SUB_DESC as 在職區分");
    ...
    //        sb.Append("    where a.REMIT_DT = '" + REMIT_DT2 + "' AND a.SALARY_TYPE=@SALARY_TYPE and c.COMPANY_CD='T'  ");
    ...
    //    }
    //}
    //public DataTable searchResult1_2(string REMIT_DT2, string SALARY_TYPE2)
    //{
    //    try
    //    {
    ...
    //        sb.Append("  from TB_S_S_SALARY_PAY a	");
    //        sb.Append("  left join TB_H_M_EMP b on a.EMP_ID=b.EMP_ID	");
    //        sb.Append("  where a.SALARY_DT = '" + REMIT_DT2 + "' and a.SALARY_TYPE = @SALARY_TYPE and b.COMPANY_CD='T'");
    ...
    //    }
    //}
    //public DataTable searchResult3(string REMIT_DT2, string SALARY_TYPE2)
    //{
    //    try
    //    {
    ...
    //        StringBuilder sb = new StringBuilder();
    //        Hashtable ht = new Hashtable();
    //        sb.Append("  select b.EMP_ID,convert(varchar,b.SALARY_ID) as 'SALARY_ID',sum(b.AMOUNT) as AMOUNT,d.SALARY_NAME");
    //        sb.Append("              from TB_S_M_SALARY_PAY_H a	");
    //        sb.Append("              left join TB_S_S_SALARY_PAY b on a.SALARY_TYPE=b.SALARY_TYPE and a.PAY_ID=b.PAY_ID	");
    ...
    //        sb.Append("              where  a.REMIT_DT = '" + REMIT_DT2 + "' and a.SALARY_TYPE='A' and c.COMPANY_CD='T'and d.IS_TAX='Y' and d.IS_PLUS=1  and d.SALARY_CD<>'5'");
    //        sb.Append("          GROUP BY b.EMP_ID,b.SALARY_ID,d.SALARY_NAME");
    //        sb.Append("              union all");
    //        sb.Append("              select b.EMP_ID,convert(varchar,b.SALARY_ID) as 'SALARY_ID',sum(b.AMOUNT) as AMOUNT,d.SALARY_NAME");
    //        sb.Append("              from TB_S_M_SALARY_PAY_H a	");
    //        sb.Append("              left join TB_S_S_SALARY_PAY b on a.SALARY_TYPE=b.SALARY_TYPE and a.PAY_ID=b.PAY_ID	");
    ...
    //        sb.Append("              left join TB_S_M_EMP_RESULT c on a.SALARY_YM=c.SALARY_YM and a.SALARY_DT=c.SALARY_DT and b.EMP_ID=c.EMP_ID	");
    //        sb.Append("              left join TB_S_M_SALARY_ITEM d on b.SALARY_ID=d.SALARY_ID 	");
    //        sb.Append("              where a.REMIT_DT = '" + REMIT_DT2 + "' and a.SALARY_TYPE='A' and c.COMPANY_CD='T'and d.IS_TAX='N' and d.IS_PLUS=1  and d.SALARY_CD<>'5'");
    //        sb.Append("          GROUP BY b.EMP_ID,b.SALARY_ID,d.SALARY_NAME");
    //        sb.Append("               union all");
    //        sb.Append("              select b.EMP_ID,convert(varchar,b.SALARY_ID) as 'SALARY_ID',sum(b.AMOUNT) as AMOUNT,d.SALARY_NAME");
    //        sb.Append("              from TB_S_M_SALARY_PAY_H a	");
    ...
    //        sb.Append("          GROUP BY b.EMP_ID,b.SALARY_ID,d.SALARY_NAME");
    //        sb.Append("              union all");
    //        sb.Append("              select b.EMP_ID,convert(varchar,b.OVERTIME_PAY_TYPE) as 'SALARY_ID',sum(b.TOTAL_HOURS) as 'AMOUNT',t.SUB_DESC as 'SALARY_NAME'");
    //        sb.Append("              from TB_S_M_SALARY_PAY_H a");
    ...
    //        sb.Append("              where a.REMIT_DT = '" + REMIT_DT2 + "' and a.SALARY_TYPE='A' and c.COMPANY_CD='T' ");
    //        sb.Append("         GROUP BY b.EMP_ID,b.OVERTIME_PAY_TYPE,t.SUB_DESC");
    //        sb.Append("              union all		   ");
    ...
    //        sb.Append("              where a.SALARY_DT = '" + REMIT_DT2 + "' and a.ENV_CHECK_STATUS='Y' and b.COMPANY_CD='T'");
    //        sb.Append("              GROUP BY a.EMP_ID,a.ENV_ALLOWANCE_VALUE,c.ENV_ALLOWANCE_VALUE");
          
    //        sb.Append("              union all");
    //        sb.Append("              select b.EMP_ID,convert(varchar,b.LEAVE_ALLOWANCE_TYPE) as 'SALARY_ID',sum(b.TOTAL_HOURS) as 'AMOUNT',d.SUB_DESC+'時數' as 'SALARY_NAME'");
    //        sb.Append("              from TB_S_M_SALARY_PAY_H a");
    ...
    //        sb.Append("              where a.REMIT_DT = '" + REMIT_DT2 + "' and a.SALARY_TYPE='A' and c.COMPANY_CD='T'  ");
    //        sb.Append(" 			GROUP BY b.EMP_ID,b.LEAVE_ALLOWANCE_TYPE,d.SUB_DESC");
    //        sb.Append("              union all");
    //        sb.Append("              select a.EMP_ID,convert(varchar,a.SUB_LEAVE_CD) as 'SALARY_ID',sum(a.TOTAL_HOURS) as 'AMOUNT',c.SUB_LEAVE_DESC+'時數' as 'SALARY_NAME'");
    //        sb.Append("              from TB_S_M_LEAVE_RESULT_D a");
    //        sb.Append("              left join TB_S_M_EMP_RESULT b on b.SALARY_DT=a.SALARY_DT and  a.EMP_ID=b.EMP_ID");
    //        sb.Append("              left join TB_D_M_LEAVE_TYPE_D c on c.SUB_LEAVE_CD=a.SUB_LEAVE_CD");
    //        sb.Append("              where a.SALARY_DT = '" + REMIT_DT2 + "' and b.COMPANY_CD='T'");
          
    //        sb.Append(" 			GROUP BY a.EMP_ID,a.SUB_LEAVE_CD,c.SUB_LEAVE_DESC");
