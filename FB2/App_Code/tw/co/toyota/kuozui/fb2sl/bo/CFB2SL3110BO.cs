...
/// CFB2SL311BO 的摘要描述
/// </summary>
public class CFB2SL311BO : BaseService
{
    public CFB2SL311BO()
	{
		//
    ...
    public DataTable getNoData(CFB2SL3110DAO dao)
    {

        try
        {
            return dao.getNoData();
        }
        catch (Exception)
        {
    ...
    {
        CFB2SL3110DAO wfb2se = new CFB2SL3110DAO();
        try
        {
            return wfb2se.getTemp2();
        }
        catch (Exception)
        {
    ...
    public DataTable getTempCHK1(CFB2SL3110DAO dao)
    {
        try
        {
            return dao.getTempCHK1();
        }
        catch (Exception)
        {
    ...
    public string excute(CFB2SL3110DAO dao)
    {
    ...
    //}
    //public string addData(CFB2SL3110DAO wfb2se, string EMP_ID, string EFFECT_YM, string MAIL_DT)
    //{
    //    try
    //    {
