...
/// CFB2DE0800BO 的摘要描述
/// </summary>
public class CFB2DE0800BO : BaseService
{
    public CFB2DE0800BO()
	{
		//
    ...
    public DataTable checkSalaryClose(CFB2DE0800DAO dao)
    {
...
*/
    ...
    public string getSalaryCode(string GIVE_SALARY_DT,CFB2DE0800DAO dao)
    {
        string errormessage = "";

        try
        {
            DataTable dt = dao.getSalaryCode(GIVE_SALARY_DT);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                dao.DUTY_SDT = dt.Rows[0]["DUTY_SDT"].ToString();
                dao.DUTY_EDT = dt.Rows[0]["DUTY_EDT"].ToString();
            }
            else
            {
    ...
    public DataTable getSalaryCTL(CFB2DE0800DAO dao)
    {
    ...
    public void update_Month(CFB2DE0800DAO dao)
    {
    ...
    public string updateSALARY_MONTH_CTRL(CFB2DE0800DAO dao)
    {
    ...
    public string insertSALARY_MONTH_CTRL(CFB2DE0800DAO dao)
    {
