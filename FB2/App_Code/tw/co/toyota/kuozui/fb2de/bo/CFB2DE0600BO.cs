...
/// CFB2DD0100BO 的摘要描述
/// </summary>
public class CFB2DE0600BO : BaseService
{
    public CFB2DE0600BO()
	{
		//
    ...
    public DataTable getCLOCKData(string CLOCK_NO)
    {
        try
        {
            CFB2DE0600DAO dao = new CFB2DE0600DAO();
            return dao.getCLOCKData(CLOCK_NO);
        }
        catch (Exception)
        {
    ...
    public DataTable getCLOCK(string CLOCK_NO)
    {
        try
        {
            CFB2DE0600DAO dao = new CFB2DE0600DAO();
            return dao.getCLOCK(CLOCK_NO);
        }
        catch (Exception)
        {
