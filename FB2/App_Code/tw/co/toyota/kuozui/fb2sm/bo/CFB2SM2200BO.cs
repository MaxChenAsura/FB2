...
/// CFB2990100BO 的摘要描述
/// </summary>
public class CFB2SM2200BO : BaseService
{
    public CFB2SM2200BO()
    {
        //
    ...
    public string updateConfirmData(List<string> confirmList, string qdatakey, string remark)
    {
        try
        {
            ...
            {
                dao.updateConfirmData(confirmListItem, qdatakey, remark);   //核可更新明細檔
            }
            Commit();
            return "0";
        }
    ...
    public string updateRemain(List<string> remainList,List<string> rejectList, string qdatakey, string remark)
    {
        try
        {
            CFB2SM2200DAO dao = new CFB2SM2200DAO();
