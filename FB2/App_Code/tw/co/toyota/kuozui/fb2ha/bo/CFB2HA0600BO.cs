...
/// CFB2HA0600BO 的摘要描述
/// </summary>
public class CFB2HA0600BO : BaseService
{
	public CFB2HA0600BO()
	{
		//
    ...
    public DataTable getData(string HR_CHG_CD_ID)
    {
        CFB2HA0600DAO dao = new CFB2HA0600DAO();
        try
        {
            return dao.getDefaultData(HR_CHG_CD_ID);
        }
        catch (Exception)
        {
    ...
    public System.Data.DataTable getEMP_CHG_STATUS()
    {
        CFB2HA0600DAO wfb2ha = new CFB2HA0600DAO();
        try
        {
            return wfb2ha.getEMP_CHG_STATUS();
        }
        catch (Exception)
        {
    ...
    public string updateData(CFB2HA0600DAO fb2ha)
    {
        try
        {
            BeginTransaction();
    ...
    public string addData(CFB2HA0600DAO fb2ha)
    {
        try
        {
            //取得現有資料
