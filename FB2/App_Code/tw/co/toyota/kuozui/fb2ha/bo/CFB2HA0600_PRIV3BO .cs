...
/// CFB2HA0600BO 的摘要描述
/// </summary>
public class CFB2HA0600_PRIV3BO : BaseService
{
    public CFB2HA0600_PRIV3BO()
	{
		//
		// TODO: 在這裡新增建構函式邏輯
		//
    ...
    {
        CFB2HA0600_PRIV3DAO wfb2ha = new CFB2HA0600_PRIV3DAO();
        try
        {
    ...
    public string updateData(CFB2HA0600_PRIV3DAO fb2ha)
    {
        try
        {
            BeginTransaction();
    ...
    public string addData(CFB2HA0600_PRIV3DAO fb2ha)
    {
        try
        {
            //取得現有資料
