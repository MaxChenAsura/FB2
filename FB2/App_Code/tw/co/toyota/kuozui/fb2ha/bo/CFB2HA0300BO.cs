...
/// CFB2HA0300BO 的摘要描述
/// </summary>
public class CFB2HA0300BO : BaseService
{
	public CFB2HA0300BO()
	{
		//
    ...
    //    try
    //    {
    //        CFB2HA0300DAO wfb2ha = new CFB2HA0300DAO();
    ...
    public string updateData(CFB2HA0300DAO fb2ha)
    {
        try
        {
            BeginTransaction();
    ...
    public string addData(CFB2HA0300DAO fb2ha)
    {
        try
        {
            //取得現有資料
