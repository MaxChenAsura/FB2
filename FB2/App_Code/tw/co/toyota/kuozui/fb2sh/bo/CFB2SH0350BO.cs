...
/// CFB2SH0350BO 的摘要描述
/// </summary>
public class CFB2SH0350BO : BaseService
{
    public CFB2SH0350BO()
    {
        //
    ...
    public IWorkbook uploadExcel1(Stream fs, string type, WFB2SH0350DAO sh035dao)
    {
        //取得登入者
        ...
        try
        {
            ...
            if (sheet != null)
            {
                try
                {
                    ...
                    excel_data.Columns.Add("AWARD_AMT", System.Type.GetType("System.String"));
                    ...
                    for (int i = 1; i <= sheet.LastRowNum; i++)
                    {
                        ...
                        error = "";
                        sh035dao.CREATED_BY = SessionHandle.Current.emp_id;
                        sh035dao.UPDATED_BY = SessionHandle.Current.emp_id;
                        ...
                        if (sheet.GetRow(i) != null)
                        {
                            ...
                            if (cell_empId == "")
                            {
                                ...
                                //檢核是否在年獎對象內
                                if(sh035dao.chkEMP_ID(cell_empId)==0)
                                    error += "工號不在年獎對象內,\n";
                            }
                           ...
                           //姓名不可空白
                            ...
                            excel_row["AWARD_AMT"] = cell_awardAMT;
                    ...
                    if (valid)
                    {
                        try
                        {
                            ...
                            {
                                sh035dao.EMP_ID = excel_data.Rows[j]["EMP_ID"].ToString();
                                sh035dao.AWARD_AMT = excel_data.Rows[j]["AWARD_AMT"].ToString();
                                sh035dao.CREATED_BY = userid;
                                sh035dao.UPDATED_BY = userid;
                                sh035dao.FUNC_ID = "FB2SH035";
                                sh035dao.updateAward_DM();
                            }

                            sh035dao.updateAward_H();
