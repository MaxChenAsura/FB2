...
/// CFB2SJ3900DAO 的摘要描述
/// </summary>
public class CFB2SJ3900DAO : BaseDAO
{
    //考核資料維護檔 欄位
    ...
    internal DataTable getAssessEmpData()
    {
        try
        {
            ...
            Hashtable ht = new Hashtable();
            sb.Append(" Select a.* ");
            sb.Append(" from TB_S_M_FOREIGN_TARGET a ");
    ...
    internal DataTable getPKData()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("select count(0) resultCount from TB_S_M_FOREIGN_DATA");
            sb.Append(" where ASSESS_YEAR=@ASSESS_YEAR");
            sb.Append(" and ASSESS_TYPE = @ASSESS_TYPE");
            ht.Add("@ASSESS_YEAR", ASSESS_YEAR);
            ht.Add("@ASSESS_TYPE", ASSESS_TYPE);
    ...
    public void getTitleData()
    {
        try
        {
            ...
            sb.Append(" from TB_S_M_FOREIGN_DATA a ");
                           ...
                           )
    {
        try
        {
            ...
            sb.Append(" from TB_S_M_FOREIGN_DATA a with (nolock) ");
                       ...
                       )
    {
        try
        {
            ...
            sb.Append(" from TB_S_M_FOREIGN_DATA ");
            sb.Append(" where 1=1 ");
                           ...
                           )
    {
        try
        {
            ...
            if (head_emp_id != "")
            {
                sb.Append(" and a.EMP_ID in ( select MNG_EMP_ID from TB_S_M_FOREIGN_HEAD_EMP where EMP_ID=@HEAD_EMP_ID and ASSESS_YEAR=@ASSESS_YEAR and ASSESS_TYPE=@ASSESS_TYPE ) ");
    ...
    public void deleteData_H(string assess_year, string assess_type)
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("delete from TB_S_M_FOREIGN_DATA ");
    ...
    internal void insertData()
    {
        try
        {
            ...
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append(" INSERT INTO TB_S_M_FOREIGN_DATA ");
            sb.Append(" ( ");
    ...
    public void updateRelease()
    {
        try
        {
            ...
            DateTime now = DateTime.Parse(DateTime.Now.ToString());
            sb.Append(" update TB_S_M_FOREIGN_DATA ");
    ...
    public void delete_M_ASSESS()
    {
        ...
        sb.Append(" delete from TB_S_M_FOREIGN ");
        sb.Append(" where ASSESS_YEAR = @ASSESS_YEAR ");
        ht.Add("@ASSESS_YEAR", ASSESS_YEAR);
        dbConn.ExecuteT(sb, ht, true);
    }
    ...
    public void insert_M_Assess1()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append(" INSERT INTO TB_S_M_FOREIGN ");
            sb.Append(" VALUES ");
    ...
    public void update_M_Assess()
    {
        try
        {
            ...
            sb.Append(" update TB_S_M_FOREIGN ");
    ...
    internal void execSP_S_ASSESS_DATA()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("SP_S_FASSESS_DATA");
            ht.Add("@ASSESS_YEAR", ASSESS_YEAR);
            ht.Add("@ASSESS_TYPE", ASSESS_TYPE);
            ht.Add("@USERID", CREATED_BY);//CREATED_BY
            ht.Add("@FUNCID", "FB2SJ390");
    ...
    internal void execSP_S_ASSESS_L2_DATA()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("SP_S_FASSESS_GEN_L2_DATA");
            ht.Add("@ASSESS_YEAR", ASSESS_YEAR);
            ht.Add("@ASSESS_TYPE", ASSESS_TYPE);
            ht.Add("@USERID", CREATED_BY);//CREATED_BY
            ht.Add("@FUNCID", "FB2SJ390");
    ...
    internal void execSP_S_ASSESS_DEP20_MAIL_CHKDT_MAIL()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("SP_S_FASSESS_DEP20_MAIL_CHKDT_MAIL");
            dbConn.ExecuteSPT(sb, ht, true);
    ...
    internal void execSP_S_ASSESS_UPDATE_SCORE()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("SP_S_FASSESS_UPDATE_SCORE");
            ht.Add("@ASSESS_YEAR", ASSESS_YEAR);
            ht.Add("@ASSESS_TYPE", ASSESS_TYPE);
            ht.Add("@USERID", CREATED_BY);//CREATED_BY
            ht.Add("@FUNCID", "FB2SJ390");
    ...
    public DataTable getExcelResultData()
    {
        try
        {
            ...
            sb.Append(" from TB_S_M_FOREIGN_TARGET a  with (nolock) ");
    ...
    public DataTable getDeptNO_NEW(string deptNO20 = "")
    {
        try
        {
            ...
            sb.Append(" from TB_S_M_FOREIGN_TARGET   ");
            sb.Append(" where 1=1 ");
            sb.Append(" and ASSESS_YEAR = @ASSESS_YEAR ");
            sb.Append(" and ASSESS_TYPE = @ASSESS_TYPE ");
            if (deptNO20 != "")
    ...
    public DataTable getExport_Data(string mng_ws_cd)
    {
        try
        {
            ...
            sb.Append(@" select isnull(R.REMARK,'') as REMARK , T.* 
                        ...
                        from TB_S_M_FOREIGN_TARGET T
                        left join  TB_S_M_FOREIGN_REMARK R on T.ASSESS_YEAR=R.ASSESS_YEAR  and T.ASSESS_TYPE=R.ASSESS_TYPE and T.EMP_ID = R.EMP_ID 
                        where 1=1 
                        and T.ASSESS_YEAR = @ASSESS_YEAR 
                        and T.ASSESS_TYPE = @ASSESS_TYPE
                        and T.EMP_ID in ( select MNG_EMP_ID from  TB_S_M_FOREIGN_HEAD_EMP where EMP_ID = @HEAD_EMP_ID and ASSESS_YEAR = @ASSESS_YEAR and  ASSESS_TYPE=@ASSESS_TYPE)
    ...
    public DataTable getExcelDataSJ390()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
