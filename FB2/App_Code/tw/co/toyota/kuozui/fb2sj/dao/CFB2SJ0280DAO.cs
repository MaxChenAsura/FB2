...
/// WFB2SJ0280 的摘要描述
/// </summary>
public class CFB2SJ0280DAO : BaseDAO
{
        ...
        string ma_emp_id, string grp_cd, string ma_type)
    {
        try
        {
            ...
            if (sortExpression.Contains("WS_CD"))
                sortExpression = sortExpression.Replace("WS_CD", "C.WS_CD");

            if (sortExpression.Contains("MA_EMP_NAME"))
                sortExpression = sortExpression.Replace("MA_EMP_NAME", "B.EMP_NAME");
            ...
            sb.Append(@" A.ASSESS_YEAR, A.ASSESS_TYPE ,  A.ASSESS_TYPE+'-'+D.SUB_DESC as ASSESS_TYPE_DESC, A.MA_TYPE,
                         ...
                         left join TB_9_M_COMM_D D  with (nolock)  on D.SYS_CD='HB' and D.MAIN_CD='WS_CD' and D.SUB_CD= C.WS_CD and D.IS_VALID='Y'
                          ");
            sb.Append(" where 1=1 ");
            
                sb.Append(" and A.MA_TYPE = 'A' ");
    ...
    public DataTable getUpdData()
    {
        try
        {
            ...
            Hashtable ht = new Hashtable();
            sb.Append(@" Select 
                         A.ASSESS_YEAR, A.ASSESS_TYPE ,  A.ASSESS_TYPE+'-'+E.SUB_DESC as ASSESS_TYPE_DESC, A.MA_TYPE,
	                     A.MA_EMP_ID ,B.EMP_NAME MA_EMP_NAME,A.GRP_CD , C.GRP_NAME, C.WS_CD,  C.WS_CD+'-'+D.SUB_DESC as WS_CD_DESC,
                         A.BASE_A, A.BASE_B, A.BASE_C, A.BASE_D, A.BASE_E, A.BASE_TOT ,
                         ...
                         left join TB_9_M_COMM_D E  with (nolock)  on E.SYS_CD='SJ' and E.MAIN_CD='ASSESS_TYPE' and E.SUB_CD= A.ASSESS_TYPE and E.IS_VALID='Y' 
    ...
    public void updateData()
    {
        try
        {
            ...
            sb.Append(" where  ASSESS_YEAR = @ASSESS_YEAR  and  ASSESS_TYPE = @ASSESS_TYPE  and MA_EMP_ID=@MA_EMP_ID and GRP_CD=@GRP_CD and MA_TYPE='A'  ");
