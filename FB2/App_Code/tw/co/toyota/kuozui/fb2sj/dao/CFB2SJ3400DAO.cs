...
/// WFB2SJ3400 的摘要描述
/// </summary>
public class CFB2SJ3400DAO : BaseDAO
{
        ...
        string dept_no_20, string ws_cd, string score_level_group, string is_merger)
    {
        try
        {
            ...
            sb.Append(@" A.ASSESS_YEAR, A.ASSESS_TYPE ,  A.ASSESS_TYPE+'-'+D.SUB_DESC as ASSESS_TYPE_DESC, 
                         A.DEPT_NO_20, A.DEPT_NAME_20, A.WS_CD, 
                         B.SUB_DESC as IS_MERGER_DESC ,
                         ...
                         from TB_S_M_FOREIGN_DEP20_PEO A with (nolock)
                         left join TB_9_M_COMM_D D  with (nolock)  on D.SYS_CD='FJ' and D.MAIN_CD='FASSESS_TYPE' and D.SUB_CD= A.ASSESS_TYPE and D.IS_VALID='Y' ");
            sb.Append(" where 1=1 ");
        ...
        string dept_no_20, string ws_cd, string score_level_group, string is_merger)
    {
        try
        {
            ...
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("select COUNT(*) total_record from TB_S_M_FOREIGN_DEP20_PEO A ");
            sb.Append(" where 1=1 ");
    ...
    public DataTable getUpdData()
    {
        try
        {
            ...
            sb.Append(@" 
                where 1=1
                and A.ASSESS_YEAR = @ASSESS_YEAR  and  A.ASSESS_TYPE = @ASSESS_TYPE  and A.DEPT_NO_20=@DEPT_NO_20  
            ");
    ...
    public void updateData()
    {
        try
        {
            ...
            sb.Append(" where ASSESS_YEAR = @ASSESS_YEAR  and  ASSESS_TYPE = @ASSESS_TYPE and DEPT_NO_20=@DEPT_NO_20  ");
    ...
    public DataTable getPEODeptNo()
    {
        try
        {
            ...
            StringBuilder sb = new StringBuilder();
            Hashtable ht = new Hashtable();
            sb.Append("select distinct A.DEPT_NO_20 from TB_S_M_FOREIGN_DEP20_PEO A where 1=1 ");
