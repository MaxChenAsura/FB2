...
/// <summary>
/// WFB2SJ3600Service 的摘要描述
/// </summary>
public class CFB2SJ3600BO : BaseService
{
    public CFB2SJ3600BO()
    {
        //
    ...
    public DataTable getAssessBaseData()
    {
        try
        {
            CFB2SJ3600DAO wfb2sj = new CFB2SJ3600DAO();
    ...
    //取得員工明細資料
    public DataTable getEmpDtlData(CFB2SJ3600DAO dao)
    {
        try
        {
    ...
    //取得員工明細資料
    public DataTable getEmpTargetData(CFB2SJ3600DAO dao)
    {
        try
        {
    ...
    //取得員工評分範圍資料
    public DataTable getEmpAssessRateData(CFB2SJ3600DAO dao)
    {
        try
        {
    ...
    public DataTable getEmpAssessScoreData(CFB2SJ3600DAO dao)
    {
        try
        {
    ...
    public string updateSCORE(CFB2SJ3600DAO wfb2sj)
    {
        try
        {
    ...
    public string updateTARGET(CFB2SJ3600DAO wfb2sj)
    {
        try
        {
            BeginTransaction();
    ...
    //處理提出簽核
    public string approve(CFB2SJ3600DAO wfb2sj)
    {
        try
        {
    ...
    public IWorkbook createExcel(CFB2SJ3600DAO dao, string type)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                return styleBO.createReferExcel(dt, "SJ360");
