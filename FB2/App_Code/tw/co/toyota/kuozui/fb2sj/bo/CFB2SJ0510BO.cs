...
/// <summary>
/// WFB2SJ0510Service 的摘要描述
/// </summary>
public class CFB2SJ0510BO : BaseService
{
    public CFB2SJ0510BO()
    {
        //
    ...
    //取得部門資料By EMPID
    public DataTable getDeptDataByEmpId(CFB2SJ0510DAO dao)
    {
        try
        {
    ...
    public DataTable getApproveData(String assess_year, String assess_type, String dept_no, String ws_cd, String score_level_group)
    {
        try
        {
            CFB2SJ0510DAO wfb2sj = new CFB2SJ0510DAO();
    ...
    //取得員工明細資料
    public DataTable getEmpDtlData(CFB2SJ0510DAO dao)
    {
        try
        {
    ...
    //取得員工明細資料
    public DataTable getEmpTargetData(CFB2SJ0510DAO dao)
    {
        try
        {
    ...
    //取得員工評分範圍資料
    public DataTable getEmpAssessRateData(CFB2SJ0510DAO dao)
    {
        try
        {
    ...
    public string updateSCORE(CFB2SJ0510DAO wfb2sj)
    {
        try
        {
    ...
    public string updateTARGET(CFB2SJ0510DAO wfb2sj)
    {
        try
        {
    ...
    //處理提出簽核
    public string sign(CFB2SJ0510DAO wfb2sj)
    {
        try
        {
            //有子部門尚未覆核
    ...
    //處理提出簽核
    public string signDept(CFB2SJ0510DAO wfb2sj)
    {
        try
        {
            //有子部門尚未覆核
    ...
    //處理提出Back
    public string backDept(CFB2SJ0510DAO wfb2sj)
    {
        try
        {
    ...
    //考核核定
    public string approve(List<CFB2SJ0510DAO> liData)
    {
        try
        {
    ...
    public int getEmpSuggestCount(String assess_year, String assess_type, String dept_no, String apprve_flag1, String apprve_flag2, String apprve_flag3)
    {
        try
        {
            ...
            return sj0510dao.getEmpSuggestCount(assess_year, assess_type, dept_no, apprve_flag1, apprve_flag2, apprve_flag3);
        }
            catch (Exception ex)
        {
    ...
    //取得員工簽核記錄
    public DataTable getAssessLog(CFB2SJ0510DAO dao)
    {
        try
        {
    ...
    public DataTable getWSLevelData(CFB2SJ0510DAO dao)
    {
        try
        {
    ...
    public DataTable getWSLevelPointData(CFB2SJ0510DAO dao)
    {
        try
        {
    ...
    public IWorkbook createstatisticsExcel(CFB2SJ0510DAO dao, string type)
    {
        try
        {
            IWorkbook workbook;
    ...
    public IWorkbook createReferExcel(CFB2SJ0510DAO dao, string type)
    {
        try
        {
