...
/// </summary>
public class CFB2SJ3200BO : BaseService
{
    public CFB2SJ3200BO()
    {
        //
    ...
    {
        CFB2SJ3200DAO sj013DAO = new CFB2SJ3200DAO();
                ...
                for (int i = 1; i <= sheet.LastRowNum; i++)
                {
                    ...
                    if (sheet.GetRow(i) != null)
                    {
                        //讀取cell資料，第一欄為檢核結果欄位跳過
                         ...
                         cell_except_e = sheet.GetRow(i).GetCell(6, MissingCellPolicy.CREATE_NULL_AS_BLANK).ToString().Trim();
                        ...
                        else
                        {
                            if (mData.ContainsKey(sheet.GetRow(i).GetCell(1, MissingCellPolicy.CREATE_NULL_AS_BLANK).ToString().Trim() + "-" + sheet.GetRow(i).GetCell(3, MissingCellPolicy.CREATE_NULL_AS_BLANK).ToString().Trim()))
                            {
                                ...
                                if (sData["remark"] == "") sData["remark"] = sheet.GetRow(i).GetCell(4, MissingCellPolicy.CREATE_NULL_AS_BLANK).ToString().Trim();
                                 ...
                                 if (sData["except_e"] == "") sData["except_e"] = sheet.GetRow(i).GetCell(6, MissingCellPolicy.CREATE_NULL_AS_BLANK).ToString().Trim();
                            ...
                            else
                            {
                                ...
                                sData.Add("except_e", sheet.GetRow(i).GetCell(6, MissingCellPolicy.CREATE_NULL_AS_BLANK).ToString().Trim());
