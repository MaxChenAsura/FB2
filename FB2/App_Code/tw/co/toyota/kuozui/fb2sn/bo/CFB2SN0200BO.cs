...
/// CFB2SN0200BO 的摘要描述
/// </summary>
public class CFB2SN0200BO : BaseService
{
    ...
    public DataTable afa_for_Data(CFB2SN0200DAO dao)
    {
        try
        {
    ...
    public DataTable getTitle_Data(CFB2SN0200DAO dao)
    {
        try
        {
            return dao.getTitle_Data();
        }
        catch (Exception)
        {
    ...
    public DataTable check_Approve_Data(CFB2SN0200DAO dao)
    {
        try
        {
            return dao.check_Approve_Data();
        }
        catch (Exception)
        {
    ...
    public DataTable check_Status(CFB2SN0200DAO dao)
    {
        try
        {
            return dao.check_Status();
        }
        catch (Exception)
        {
    ...
    public string approve_update(CFB2SN0200DAO dao)
    {
        string msg = "";
        try
        {
    ...
    public string reject_update(CFB2SN0200DAO dao, List<Tuple<string>> keysListMark, List<Tuple<string>> keysList)
    {
        string msg = "";
        try
        {
